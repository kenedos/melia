...
//
//--- Description -----------------------------------------------------------
// Sets up mobs for '(Closed) Seir Rainforest' map.
//---------------------------------------------------------------------------
...
public class FOrchard324MobScript : GeneralScript
{
	public override void Load()
	{
		...
		AddSpawner("f_orchard_32_4.Id1", MonsterId.Rootcrystal_01, min: 15, max: 20, respawn: Seconds(60));
		AddSpawner("f_orchard_32_4.Id2", MonsterId.Ferret_Archer, min: 23, max: 30);
		AddSpawner("f_orchard_32_4.Id3", MonsterId.Beeterineas, min: 30, max: 40);
		...
		AddSpawner("f_orchard_32_4.Id6", MonsterId.Sec_Wolf_Statue_Mage, min: 30, max: 40);
		...
		// 'Beeterineas' GenType 11 Spawn Points
		...
		// 'Sec_Wolf_Statue_Mage' GenType 42 Spawn Points
