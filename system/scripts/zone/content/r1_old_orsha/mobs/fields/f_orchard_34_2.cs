...
//
//--- Description -----------------------------------------------------------
// Sets up mobs for '(Closed) Zeraha' map.
//---------------------------------------------------------------------------
...
public class FOrchard342MobScript : GeneralScript
{
	public override void Load()
	{
		...
		AddSpawner("f_orchard_34_2.Id1", MonsterId.Rootcrystal_01, min: 12, max: 15, respawn: Seconds(60));
		AddSpawner("f_orchard_34_2.Id2", MonsterId.Conuts, min: 15, max: 20);
		AddSpawner("f_orchard_34_2.Id3", MonsterId.Beeto, min: 15, max: 20);
		AddSpawner("f_orchard_34_2.Id4", MonsterId.Ferret_Folk, min: 19, max: 25);
		AddSpawner("f_orchard_34_2.Id5", MonsterId.Conuts, min: 12, max: 15);
		AddSpawner("f_orchard_34_2.Id6", MonsterId.Beeto, min: 15, max: 20);
		AddSpawner("f_orchard_34_2.Id7", MonsterId.Ferret_Folk, min: 5, max: 6);
		AddSpawner("f_orchard_34_2.Id8", MonsterId.Ferret_Loader, min: 5, max: 6);
		AddSpawner("f_orchard_34_2.Id9", MonsterId.Ferret_Loader, min: 30, max: 40);
		AddSpawner("f_orchard_34_2.Id10", MonsterId.Ferret_Folk, min: 9, max: 12);
		...
		// 'Conuts' GenType 11 Spawn Points
		...
		// 'Conuts' GenType 14 Spawn Points
		...
		AddSpawnPoint("f_orchard_34_2.Id7", "f_orchard_34_2", Rectangle(-632, 1666, 100));

		// 'Ferret_Loader' GenType 27 Spawn Points
		AddSpawnPoint("f_orchard_34_2.Id8", "f_orchard_34_2", Rectangle(-622, 1682, 150));

		// 'Ferret_Loader' GenType 33 Spawn Points
		AddSpawnPoint("f_orchard_34_2.Id9", "f_orchard_34_2", Rectangle(1262, 1202, 9999));

		// 'Ferret_Folk' GenType 34 Spawn Points
		AddSpawnPoint("f_orchard_34_2.Id10", "f_orchard_34_2", Rectangle(887, -733, 200));
		AddSpawnPoint("f_orchard_34_2.Id10", "f_orchard_34_2", Rectangle(225, -595, 200));
	}
}
