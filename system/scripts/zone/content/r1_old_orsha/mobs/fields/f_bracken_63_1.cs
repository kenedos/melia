...
//
//--- Description -----------------------------------------------------------
// Sets up mobs for '(Closed) Koru Jungle' map.
//---------------------------------------------------------------------------
...
public class FBracken631MobScript : GeneralScript
{
	public override void Load()
	{
		...
		AddSpawner("f_bracken_63_1.Id1", MonsterId.Ferrot, min: 30, max: 40);
		AddSpawner("f_bracken_63_1.Id2", MonsterId.Folibu, min: 30, max: 40);
		AddSpawner("f_bracken_63_1.Id3", MonsterId.Leafnut, min: 30, max: 40);
		AddSpawner("f_bracken_63_1.Id4", MonsterId.Rootcrystal_01, min: 22, max: 29, respawn: Seconds(20));
		AddSpawner("f_bracken_63_1.Id5", MonsterId.Sec_Bubbe_Chaser, min: 30, max: 40);
		AddSpawner("f_bracken_63_1.Id6", MonsterId.Ferrot, min: 19, max: 25);
		AddSpawner("f_bracken_63_1.Id7", MonsterId.Leafnut, min: 19, max: 25);
		AddSpawner("f_bracken_63_1.Id8", MonsterId.Sec_Bubbe_Chaser, min: 30, max: 40);
