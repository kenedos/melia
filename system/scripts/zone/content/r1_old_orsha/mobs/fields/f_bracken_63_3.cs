...
//
//--- Description -----------------------------------------------------------
// Sets up mobs for '(Closed) Dadan Jungle' map.
//---------------------------------------------------------------------------
...
public class FBracken633MobScript : GeneralScript
{
	public override void Load()
	{
		...
		AddSpawner("f_bracken_63_3.Id1", MonsterId.Gosaru, min: 30, max: 40, respawn: Seconds(60));
		AddSpawner("f_bracken_63_3.Id2", MonsterId.Ellogua, min: 9, max: 11, respawn: Seconds(60));
		AddSpawner("f_bracken_63_3.Id3", MonsterId.Raffly, min: 30, max: 40, respawn: Seconds(60));
		AddSpawner("f_bracken_63_3.Id4", MonsterId.Rootcrystal_01, min: 17, max: 22, respawn: Seconds(20));
		AddSpawner("f_bracken_63_3.Id5", MonsterId.Sec_Grummer, min: 34, max: 45);
		AddSpawner("f_bracken_63_3.Id6", MonsterId.Sec_Bubbe_Fighter, min: 29, max: 38);
		AddSpawner("f_bracken_63_3.Id7", MonsterId.Sec_Bubbe_Fighter, min: 5, max: 6);
