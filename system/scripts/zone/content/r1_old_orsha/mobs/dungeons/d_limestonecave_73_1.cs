...
//
//--- Description -----------------------------------------------------------
// Sets up mobs for '(Closed) Tavorh Cave' map.
//---------------------------------------------------------------------------
...
public class DLimestonecave731MobScript : GeneralScript
{
	public override void Load()
	{
		...
		AddSpawner("d_limestonecave_73_1.Id1", MonsterId.ERD_Loftlem, min: 15, max: 20);
		AddSpawner("d_limestonecave_73_1.Id2", MonsterId.ERD_Tanu, min: 15, max: 20);
		AddSpawner("d_limestonecave_73_1.Id3", MonsterId.ERD_Vesper, min: 30, max: 40);
		AddSpawner("d_limestonecave_73_1.Id4", MonsterId.ERD_Lizardman, min: 15, max: 20);
		AddSpawner("d_limestonecave_73_1.Id5", MonsterId.ERD_Groll, min: 15, max: 20);
		AddSpawner("d_limestonecave_73_1.Id6", MonsterId.ERD_Corylus, min: 15, max: 20);
		AddSpawner("d_limestonecave_73_1.Id7", MonsterId.ERD_Chafperor, min: 15, max: 20);
		AddSpawner("d_limestonecave_73_1.Id8", MonsterId.Rootcrystal_03, min: 15, max: 20, respawn: Seconds(30));
		AddSpawner("d_limestonecave_73_1.Id9", MonsterId.ERD_StonOrca, min: 27, max: 35);
