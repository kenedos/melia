...
//
//--- Description -----------------------------------------------------------
// Sets up mobs for '(Closed) Nevellet Quarry 1F' map.
//---------------------------------------------------------------------------
...
public class DCmine661MobScript : GeneralScript
{
	public override void Load()
	{
		...
		AddSpawner("d_cmine_66_1.Id1", MonsterId.Rootcrystal_03, min: 14, max: 18, respawn: Seconds(5));
		AddSpawner("d_cmine_66_1.Id2", MonsterId.FD_Corylus, min: 25, max: 33);
		AddSpawner("d_cmine_66_1.Id3", MonsterId.FD_Yognome_Sec, min: 29, max: 38);
		AddSpawner("d_cmine_66_1.Id4", MonsterId.FD_Pawnd, min: 42, max: 55);
		AddSpawner("d_cmine_66_1.Id5", MonsterId.FD_Glizardon, min: 9, max: 12);
		AddSpawner("d_cmine_66_1.Id6", MonsterId.FD_Pawnd, min: 25, max: 33);
		AddSpawner("d_cmine_66_1.Id7", MonsterId.FD_Pawnd, min: 25, max: 33);
