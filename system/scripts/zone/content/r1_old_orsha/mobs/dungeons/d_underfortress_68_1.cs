//--- Melia Script -----------------------------------------------------------
// d_underfortress_68_1
//
//--- Description -----------------------------------------------------------
// Sets up mobs for '(Closed) Sicarius 1F' map.
//---------------------------------------------------------------------------
...
public class DUnderfortress681MobScript : GeneralScript
{
	public override void Load()
	{
		...
		AddSpawner("d_underfortress_68_1.Id1", MonsterId.FD_InfroRocktor_Red, min: 38, max: 50);
		AddSpawner("d_underfortress_68_1.Id2", MonsterId.FD_Pyran, min: 23, max: 30);
		AddSpawner("d_underfortress_68_1.Id3", MonsterId.FD_Fire_Dragon, min: 30, max: 40);
		AddSpawner("d_underfortress_68_1.Id4", MonsterId.FD_Tower_Of_Firepuppet, min: 15, max: 20);
		AddSpawner("d_underfortress_68_1.Id5", MonsterId.FD_Tower_Of_Firepuppet, min: 15, max: 20);
		AddSpawner("d_underfortress_68_1.Id6", MonsterId.Rootcrystal_03, min: 11, max: 14, respawn: Seconds(60));
