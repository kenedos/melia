...
//
//--- Description -----------------------------------------------------------
// Sets up mobs for '(Closed) Novaha Institute' map.
//---------------------------------------------------------------------------
...
public class DAbbey643MobScript : GeneralScript
{
	public override void Load()
	{
		...
		AddSpawner("d_abbey_64_3.Id1", MonsterId.Lapemiter, min: 19, max: 25);
		AddSpawner("d_abbey_64_3.Id2", MonsterId.Lapflammer, min: 19, max: 25);
		AddSpawner("d_abbey_64_3.Id3", MonsterId.Lapeman, min: 19, max: 25);
		AddSpawner("d_abbey_64_3.Id4", MonsterId.Rootcrystal_03, min: 18, max: 24, respawn: Seconds(20));
		AddSpawner("d_abbey_64_3.Id5", MonsterId.Humming_Bud_Purple, min: 38, max: 50);
		AddSpawner("d_abbey_64_3.Id6", MonsterId.Humming_Bud_Purple, min: 8, max: 10);
		AddSpawner("d_abbey_64_3.Id7", MonsterId.Sec_Deadbornscab, min: 20, max: 26);
		AddSpawner("d_abbey_64_3.Id8", MonsterId.Sec_Deadbornscab, min: 5, max: 6);
		...
		AddSpawnPoint("d_abbey_64_3.Id6", "d_abbey_64_3", Rectangle(666, -635, 300));

		// 'Sec_Deadbornscab' GenType 47 Spawn Points
		...
		// 'Sec_Deadbornscab' GenType 48 Spawn Points
