...
//
//--- Description -----------------------------------------------------------
// Sets up mobs for '(Closed) Novaha Assembly Hall' map.
//---------------------------------------------------------------------------
...
public class DAbbey641MobScript : GeneralScript
{
	public override void Load()
	{
		...
		AddSpawner("d_abbey_64_1.Id1", MonsterId.Velwriggler_Mage_Red, min: 30, max: 40);
		AddSpawner("d_abbey_64_1.Id2", MonsterId.Beeteroxia, min: 38, max: 50);
		AddSpawner("d_abbey_64_1.Id3", MonsterId.Rootcrystal_01, min: 23, max: 30, respawn: Seconds(20));
		AddSpawner("d_abbey_64_1.Id4", MonsterId.LapeArcher, min: 23, max: 30);
		AddSpawner("d_abbey_64_1.Id5", MonsterId.Shtayim_Mage, min: 23, max: 30);
		AddSpawner("d_abbey_64_1.Id6", MonsterId.Sec_Spector_Gh, min: 19, max: 25);
		AddSpawner("d_abbey_64_1.Id7", MonsterId.Sec_Spector_Gh, min: 6, max: 7);
		...
		AddSpawnPoint("d_abbey_64_1.Id7", "d_abbey_64_1", Rectangle(120, -1657, 300));
	}
}
