...
//
//--- Description -----------------------------------------------------------
// Sets up mobs for '(Closed) Netanmalek Mausoleum' map.
//---------------------------------------------------------------------------
...
public class DZachariel792MobScript : GeneralScript
{
	public override void Load()
	{
		...
		AddSpawner("d_zachariel_79_2.Id1", MonsterId.ERD_Wolf_Statue_Mage, min: 15, max: 20);
		AddSpawner("d_zachariel_79_2.Id2", MonsterId.ERD_Tiny_Blue, min: 15, max: 20);
		AddSpawner("d_zachariel_79_2.Id3", MonsterId.ERD_Echad_Bow, min: 12, max: 16);
		AddSpawner("d_zachariel_79_2.Id4", MonsterId.ERD_Colimen_Brown, min: 27, max: 35);
		AddSpawner("d_zachariel_79_2.Id5", MonsterId.ERD_Rubblem, min: 14, max: 18);
		AddSpawner("d_zachariel_79_2.Id6", MonsterId.ERD_Blindlem, min: 14, max: 18);
		AddSpawner("d_zachariel_79_2.Id7", MonsterId.ERD_Tiny_Mage_Brown, min: 19, max: 25);
		AddSpawner("d_zachariel_79_2.Id8", MonsterId.ERD_Dog_Of_King, min: 19, max: 25);
		AddSpawner("d_zachariel_79_2.Id9", MonsterId.ERD_Schlesien_Darkmage, min: 19, max: 25);
		AddSpawner("d_zachariel_79_2.Id10", MonsterId.ERD_Schlesien_Claw, min: 23, max: 30);
		AddSpawner("d_zachariel_79_2.Id11", MonsterId.ERD_Glyquare, min: 30, max: 40);
		AddSpawner("d_zachariel_79_2.Id12", MonsterId.ERD_Schlesien_Heavycavarly, min: 4, max: 5, respawn: Seconds(1800));
		AddSpawner("d_zachariel_79_2.Id13", MonsterId.Rootcrystal_05, min: 15, max: 20, respawn: Seconds(30));
