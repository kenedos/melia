...
//
//--- Description -----------------------------------------------------------
// Sets up mobs for '(Closed) Ashaq Underground Prison 1F' map.
//---------------------------------------------------------------------------
...
public class DPrison621MobScript : GeneralScript
{
	public override void Load()
	{
		...
		AddSpawner("d_prison_62_1.Id1", MonsterId.Wendigo_Blue, min: 45, max: 60);
		AddSpawner("d_prison_62_1.Id2", MonsterId.Rootcrystal_01, min: 19, max: 25, respawn: Seconds(25));
		AddSpawner("d_prison_62_1.Id3", MonsterId.Dumaro_Blue, min: 45, max: 60);
		AddSpawner("d_prison_62_1.Id4", MonsterId.Wendigo_Blue, min: 34, max: 45);
		AddSpawner("d_prison_62_1.Id5", MonsterId.Sec_Yekubite, min: 27, max: 35);
		AddSpawner("d_prison_62_1.Id6", MonsterId.Goblin_Miners_Blue, min: 45, max: 60);
