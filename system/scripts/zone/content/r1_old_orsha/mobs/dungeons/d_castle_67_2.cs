...
//
//--- Description -----------------------------------------------------------
// Sets up mobs for '(Closed) Topes Fortress 2F' map.
//---------------------------------------------------------------------------
...
public class DCastle672MobScript : GeneralScript
{
	public override void Load()
	{
		...
		AddSpawner("d_castle_67_2.Id1", MonsterId.Rootcrystal_03, min: 12, max: 15, respawn: Seconds(60));
		AddSpawner("d_castle_67_2.Id2", MonsterId.FD_Flamil, min: 19, max: 25);
		AddSpawner("d_castle_67_2.Id3", MonsterId.FD_Flamil, min: 23, max: 30);
		AddSpawner("d_castle_67_2.Id4", MonsterId.FD_Flamme_Mage, min: 15, max: 20);
		AddSpawner("d_castle_67_2.Id5", MonsterId.FD_Flamag, min: 23, max: 30);
		AddSpawner("d_castle_67_2.Id6", MonsterId.FD_Stoulet_Mage_Green, min: 15, max: 20);
