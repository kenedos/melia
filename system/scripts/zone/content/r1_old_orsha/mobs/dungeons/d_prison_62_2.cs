...
//
//--- Description -----------------------------------------------------------
// Sets up mobs for '(Closed) Ashaq Underground Prison 2F' map.
//---------------------------------------------------------------------------
...
public class DPrison622MobScript : GeneralScript
{
	public override void Load()
	{
		...
		AddSpawner("d_prison_62_2.Id1", MonsterId.Goblin_Spear_Blue, min: 45, max: 60);
		AddSpawner("d_prison_62_2.Id2", MonsterId.Sec_Goblin_Archer_Blue, min: 30, max: 40);
		AddSpawner("d_prison_62_2.Id3", MonsterId.Sec_Escape_Wendigo, min: 19, max: 25);
		AddSpawner("d_prison_62_2.Id4", MonsterId.Rootcrystal_01, min: 19, max: 25, respawn: Seconds(25));
		AddSpawner("d_prison_62_2.Id5", MonsterId.Goblin_Spear_Blue, min: 30, max: 40);
		AddSpawner("d_prison_62_2.Id6", MonsterId.Sec_Escape_Wendigo, min: 30, max: 40);
		AddSpawner("d_prison_62_2.Id7", MonsterId.Sec_Goblin_Archer_Blue, min: 23, max: 30);
		AddSpawner("d_prison_62_2.Id8", MonsterId.Sec_Bat, min: 53, max: 70);
