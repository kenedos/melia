...
//
//--- Description -----------------------------------------------------------
// Sets up mobs for '(Closed) Nevellet Quarry 2F' map.
//---------------------------------------------------------------------------
...
public class DCmine662MobScript : GeneralScript
{
	public override void Load()
	{
		...
		AddSpawner("d_cmine_66_2.Id1", MonsterId.Rootcrystal_03, min: 14, max: 18, respawn: Seconds(5));
		AddSpawner("d_cmine_66_2.Id2", MonsterId.FD_Blok_Archer, min: 18, max: 23);
		AddSpawner("d_cmine_66_2.Id3", MonsterId.FD_Blok_Wizard, min: 18, max: 23);
		AddSpawner("d_cmine_66_2.Id4", MonsterId.FD_Kenol, min: 25, max: 33);
		AddSpawner("d_cmine_66_2.Id5", MonsterId.FD_Pawndel, min: 42, max: 55);
		AddSpawner("d_cmine_66_2.Id6", MonsterId.FD_Kenol, min: 50, max: 66);
		AddSpawner("d_cmine_66_2.Id7", MonsterId.FD_Blok_Archer, min: 18, max: 23);
		AddSpawner("d_cmine_66_2.Id8", MonsterId.FD_Pawndel, min: 8, max: 10);
		AddSpawner("d_cmine_66_2.Id9", MonsterId.FD_Blok_Wizard, min: 18, max: 23);
		AddSpawner("d_cmine_66_2.Id10", MonsterId.FD_Pawndel, min: 8, max: 10);
