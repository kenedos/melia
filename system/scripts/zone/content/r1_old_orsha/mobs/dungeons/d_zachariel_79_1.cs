...
//
//--- Description -----------------------------------------------------------
// Sets up mobs for '(Closed) Sjarejo Chamber' map.
//---------------------------------------------------------------------------
...
public class DZachariel791MobScript : GeneralScript
{
	public override void Load()
	{
		...
		AddSpawner("d_zachariel_79_1.Id1", MonsterId.ERD_Sauga_S, min: 27, max: 35);
		AddSpawner("d_zachariel_79_1.Id2", MonsterId.ERD_Beetle, min: 17, max: 22);
		AddSpawner("d_zachariel_79_1.Id3", MonsterId.ERD_NightMaiden_Mage_Red, min: 12, max: 16);
		AddSpawner("d_zachariel_79_1.Id4", MonsterId.ERD_Moving_Trap, min: 12, max: 15);
		AddSpawner("d_zachariel_79_1.Id5", MonsterId.ERD_Wolf_Statue, min: 19, max: 25);
		AddSpawner("d_zachariel_79_1.Id6", MonsterId.ERD_Varv, min: 30, max: 40);
		AddSpawner("d_zachariel_79_1.Id7", MonsterId.ERD_Echad, min: 14, max: 18);
		AddSpawner("d_zachariel_79_1.Id8", MonsterId.ERD_Lemur, min: 15, max: 20);
		AddSpawner("d_zachariel_79_1.Id9", MonsterId.ERD_Chupacabra_Desert, min: 9, max: 12);
		AddSpawner("d_zachariel_79_1.Id10", MonsterId.ERD_Upent, min: 4, max: 5, respawn: Seconds(1800));
		AddSpawner("d_zachariel_79_1.Id11", MonsterId.Rootcrystal_05, min: 12, max: 15, respawn: Seconds(30));
