...
//
//--- Description -----------------------------------------------------------
// Sets up mobs for '(Closed) Topes Fortress 1F' map.
//---------------------------------------------------------------------------
...
public class DCastle671MobScript : GeneralScript
{
	public override void Load()
	{
		...
		AddSpawner("d_castle_67_1.Id1", MonsterId.Rootcrystal_03, min: 12, max: 15, respawn: Seconds(60));
		AddSpawner("d_castle_67_1.Id2", MonsterId.FD_Flamme_Priest, min: 12, max: 15);
		AddSpawner("d_castle_67_1.Id3", MonsterId.FD_Flamme_Archer, min: 12, max: 15);
		AddSpawner("d_castle_67_1.Id4", MonsterId.FD_Flak, min: 19, max: 25);
		AddSpawner("d_castle_67_1.Id5", MonsterId.FD_Flamme_Priest, min: 23, max: 30);
		AddSpawner("d_castle_67_1.Id6", MonsterId.FD_Flamme_Archer, min: 15, max: 20);
		AddSpawner("d_castle_67_1.Id7", MonsterId.FD_Flak, min: 23, max: 30);
		AddSpawner("d_castle_67_1.Id8", MonsterId.FD_Stoulet_Mage_Blue, min: 15, max: 20);
