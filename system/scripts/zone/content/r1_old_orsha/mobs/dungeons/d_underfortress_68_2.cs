//--- Melia Script -----------------------------------------------------------
// d_underfortress_68_2
//
//--- Description -----------------------------------------------------------
// Sets up mobs for '(Closed) Sicarius 2F' map.
//---------------------------------------------------------------------------
...
public class DUnderfortress682MobScript : GeneralScript
{
	public override void Load()
	{
		...
		AddSpawner("d_underfortress_68_2.Id1", MonsterId.FD_Blindlem, min: 23, max: 30);
		AddSpawner("d_underfortress_68_2.Id2", MonsterId.FD_Tower_Of_Firepuppet_Black, min: 15, max: 20);
		AddSpawner("d_underfortress_68_2.Id3", MonsterId.FD_Chromadog, min: 23, max: 30);
		AddSpawner("d_underfortress_68_2.Id4", MonsterId.FD_Fire_Dragon_Purple, min: 30, max: 40);
		AddSpawner("d_underfortress_68_2.Id5", MonsterId.Rootcrystal_03, min: 10, max: 13, respawn: Seconds(60));
