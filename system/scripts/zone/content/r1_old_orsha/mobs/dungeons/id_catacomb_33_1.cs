...
//
//--- Description -----------------------------------------------------------
// Sets up mobs for '(Closed) Sienakal Graveyard' map.
//---------------------------------------------------------------------------
...
public class IdCatacomb331MobScript : GeneralScript
{
	public override void Load()
	{
		...
		AddSpawner("id_catacomb_33_1.Id1", MonsterId.Rootcrystal_05, min: 12, max: 15, respawn: Seconds(60));
		AddSpawner("id_catacomb_33_1.Id2", MonsterId.Sec_Maggot_Green, min: 23, max: 30);
		AddSpawner("id_catacomb_33_1.Id3", MonsterId.Sec_Leaf_Diving_Purple, min: 23, max: 30);
		AddSpawner("id_catacomb_33_1.Id4", MonsterId.Fisherman_Green, min: 15, max: 20);
		AddSpawner("id_catacomb_33_1.Id5", MonsterId.Sec_Maggot_Green, min: 30, max: 40);
		AddSpawner("id_catacomb_33_1.Id6", MonsterId.Sec_Leaf_Diving_Purple, min: 30, max: 40);
		AddSpawner("id_catacomb_33_1.Id7", MonsterId.Drapel, min: 30, max: 40);
