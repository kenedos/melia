...
//
//--- Description -----------------------------------------------------------
// Sets up mobs for '(Closed) Ashaq Underground Prison 3F' map.
//---------------------------------------------------------------------------
...
public class DPrison623MobScript : GeneralScript
{
	public override void Load()
	{
		...
		AddSpawner("d_prison_62_3.Id1", MonsterId.Sec_Banshee_Purple, min: 42, max: 55);
		AddSpawner("d_prison_62_3.Id2", MonsterId.GoblinWarrior_Blue, min: 8, max: 10);
		AddSpawner("d_prison_62_3.Id3", MonsterId.Sec_Bubbe_Mage_Priest, min: 38, max: 50);
		AddSpawner("d_prison_62_3.Id4", MonsterId.Rootcrystal_01, min: 19, max: 25, respawn: Seconds(25));
		AddSpawner("d_prison_62_3.Id5", MonsterId.Sec_Varv, min: 57, max: 75);
		AddSpawner("d_prison_62_3.Id6", MonsterId.Sec_Varv, min: 12, max: 15);
