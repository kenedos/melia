...
//
//--- Description -----------------------------------------------------------
// Sets up mobs for '(Closed) Carlyle's Mausoleum' map.
//---------------------------------------------------------------------------
...
public class IdCatacomb332MobScript : GeneralScript
{
	public override void Load()
	{
		...
		AddSpawner("id_catacomb_33_2.Id1", MonsterId.Rootcrystal_05, min: 12, max: 15, respawn: Seconds(60));
		AddSpawner("id_catacomb_33_2.Id2", MonsterId.Sec_Spector_Gh_Purple, min: 9, max: 12);
		AddSpawner("id_catacomb_33_2.Id3", MonsterId.Slime_Dark_Green, min: 27, max: 35);
		AddSpawner("id_catacomb_33_2.Id4", MonsterId.Sec_Spector_Gh_Purple, min: 27, max: 35);
		AddSpawner("id_catacomb_33_2.Id5", MonsterId.Sec_Stoulet_Green, min: 27, max: 35);
		AddSpawner("id_catacomb_33_2.Id6", MonsterId.Sec_Colitile, min: 45, max: 60);
