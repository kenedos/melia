...
namespace Melia.Zone.World
{
	public class Party : Group
	{
		...
		/// <summary>
		/// Return the Leader Character reference or null
		/// if somehow couldn't find it.
		/// </summary>
		/// <returns></returns>
		public Character GetLeader()
		{
			foreach (var memberCharacter in this.GetPartyMembers())
			{
				if (memberCharacter != null)
				{
					if (this.IsLeader(memberCharacter.ObjectId))
