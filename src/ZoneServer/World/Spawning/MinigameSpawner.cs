...
namespace Melia.Zone.World.Spawning
{
	...
	/// </summary>
	public class MinigameSpawner : IUpdateable
	{
		...
		public void Spawn(int amount)
		{
			...
			for (var i = 0; i < amount && this.Amount < _maxPopulation; i++)
			{
				...
				// Log.Debug("Minigame spawned: {0} at {1} {2:F1}, {3:F1}, {4:F1}", minigameScript.GetType().Name, mapClassName, position.X, position.Y, position.Z);
			}
		}
