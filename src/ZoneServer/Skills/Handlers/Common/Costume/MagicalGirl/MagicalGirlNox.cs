...
{
	/// <summary>
	/// Handler for the MagicalGirl skill Magical Girl Nox.
	/// </summary>
	[SkillHandler(SkillId.MagicalGirl_MagicalGirlNox)]
	public class MagicalGirl_MagicalGirlNox : IGroundSkillHandler
	{
