...
{
	[SkillHandler(SkillId.Mon_bumble_green_Skill_1)]
	public class Mon_bumble_green_Skill_1 : ITargetSkillHandler
	{
	...
	[SkillHandler(SkillId.Mon_bumble_green_Skill_2)]
	public class Mon_bumble_green_Skill_2 : ITargetSkillHandler
	{
