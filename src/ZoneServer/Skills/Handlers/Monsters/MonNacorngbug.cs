...
{
	[SkillHandler(SkillId.Mon_nacorngbug_Skill_1)]
	public class Mon_nacorngbug_Skill_1 : ITargetSkillHandler
	{
	...
	public class Mon_nacorngbug_Skill_2 : ITargetSkillHandler
	{
