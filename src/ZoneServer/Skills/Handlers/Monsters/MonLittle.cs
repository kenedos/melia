...
{
	[SkillHandler(SkillId.Mon_Little_rubeta_Skill_1)]
	public class Mon_Little_rubeta_Skill_1 : ITargetSkillHandler
	{
	...
	public class Mon_Little_rubeta_Skill_2 : ITargetSkillHandler
	{
