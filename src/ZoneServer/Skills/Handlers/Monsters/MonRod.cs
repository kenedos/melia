...
{
	[SkillHandler(SkillId.Mon_ROD_master_Skill_1)]
	public class Mon_ROD_master_Skill_1 : ITargetSkillHandler
	{
	...
	public class Mon_ROD_master_Skill_2 : ITargetSkillHandler
	{
