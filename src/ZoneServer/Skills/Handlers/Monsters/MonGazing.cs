...
namespace Melia.Zone.Skills.Handlers.Mon
{
	...
	public class Mon_Gazing_Golem_yellow_Skill_1 : ITargetSkillHandler
	{
	...
	[SkillHandler(SkillId.Mon_Gazing_Golem_yellow_Skill_2)]
	public class Mon_Gazing_Golem_yellow_Skill_2 : ITargetSkillHandler
	{
		...
		private async Task HandleSkill(ICombatEntity caster, ICombatEntity target, Skill skill, Position originPos, Position farPos, int hitDelay, int aniTime)
		{
			...
			splashArea = new SplashAreas.Circle(originPos.GetRelative(farPos, distance: 30f), 15f);
			hitDelay = 100;
			aniTime = 100;
			var hits = new List<SkillHitInfo>();
			await SkillAttack(caster, skill, splashArea, hitDelay, aniTime, hits);
