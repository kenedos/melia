...
{
	[SkillHandler(SkillId.Mon_nacorngfly_Skill_1)]
	public class Mon_nacorngfly_Skill_1 : ITargetSkillHandler
	{
	...
	[SkillHandler(SkillId.Mon_nacorngfly_Skill_2)]
	public class Mon_nacorngfly_Skill_2 : ITargetSkillHandler
	{
