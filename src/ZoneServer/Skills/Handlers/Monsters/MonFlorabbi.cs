...
namespace Melia.Zone.Skills.Handlers.Mon
{
	...
	public class Mon_florabbi_Skill_1 : ITargetSkillHandler
	{
		...
		{
			ISplashArea splashArea = new SplashAreas.Circle(originPos.GetRelative(farPos, distance: 10f), 15f);
			await SkillAttack(caster, skill, splashArea, hitDelay, aniTime);
		}
	}

	[SkillHandler(SkillId.Mon_florabbi_Skill_2)]
	public class Mon_florabbi_Skill_2 : ITargetSkillHandler
	{
