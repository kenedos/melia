...
{
	[SkillHandler(SkillId.Mon_blok_archer_Skill_1)]
	public class Mon_blok_archer_Skill_1 : ITargetSkillHandler
	{
		...
		public void Handle(Skill skill, ICombatEntity caster, ICombatEntity target)
		{
			...
			var hitDelay = 400 + (int)(caster.Position.Get2DDistance(target.Position) * 2.4);
	...
	[SkillHandler(SkillId.Mon_blok_wizard_Skill_1)]
	public class Mon_blok_wizard_Skill_1 : ITargetSkillHandler
	{
		...
		public void Handle(Skill skill, ICombatEntity caster, ICombatEntity target)
		{
			...
			var originPos = caster.Position;
			var hitDelay = 500 + (int)(caster.Position.Get2DDistance(target.Position) * 2.2);
			var leadPos = GetLeadPosition(target, hitDelay);
			caster.TurnTowards(leadPos);
			var farPos = originPos.GetNearestPositionWithinDistance(leadPos, skill.Properties[PropertyName.MaxR]);
