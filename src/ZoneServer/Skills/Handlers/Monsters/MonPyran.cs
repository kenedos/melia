...
{
	[SkillHandler(SkillId.Mon_pyran_green_Skill_1)]
	public class Mon_pyran_green_Skill_1 : ITargetSkillHandler
	{
	...
	[SkillHandler(SkillId.Mon_pyran_Skill_1)]
	public class Mon_pyran_Skill_1 : ITargetSkillHandler
	{
