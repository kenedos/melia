...
namespace Melia.Zone.Skills.Handlers.Mon
{
	...
	public class Mon_Yishontorcher_Skill_1 : ITargetSkillHandler
	{
		...
		{
			var splashParam = skill.GetSplashParameters(caster, originPos, farPos, length: 50, width: 35, angle: 30f);
	...
	public class Mon_Yishontorcher_Skill_2 : ITargetSkillHandler
	{
	...
	[SkillHandler(SkillId.Mon_Yishontorcher_Skill_3)]
	public class Mon_Yishontorcher_Skill_3 : ITargetSkillHandler
	{
		public void Handle(Skill skill, ICombatEntity caster, ICombatEntity target)
		{
			if (!caster.TrySpendSp(skill))
		...
		private async Task HandleSkill(ICombatEntity caster, ICombatEntity target, Skill skill, Position originPos, Position farPos)
		{
			...
			{
				Effect = new EffectConfig("I_force015_yellow", 1f),
				EndEffect = new EffectConfig("F_rize015_1_yellow_drop", 1f),
				Range = 45f,
				FlyTime = 1f,
				DelayTime = 0f,
				Gravity = 600f,
