...
{
	[SkillHandler(SkillId.Mon_Lichenclops_mage_Skill_1)]
	public class Mon_Lichenclops_mage_Skill_1 : ITargetSkillHandler
	{
	...
	[SkillHandler(SkillId.Mon_Lichenclops_Skill_1)]
	public class Mon_Lichenclops_Skill_1 : ITargetSkillHandler
	{
