...
{
	[SkillHandler(SkillId.Mon_piang_Skill_1)]
	public class Mon_piang_Skill_1 : ITargetSkillHandler
	{
	...
	[SkillHandler(SkillId.Mon_piang_Skill_2)]
	public class Mon_piang_Skill_2 : ITargetSkillHandler
	{
		public void Handle(Skill skill, ICombatEntity caster, ICombatEntity target)
		{
			if (!caster.TrySpendSp(skill))
		...
		private async Task HandleSkill(ICombatEntity caster, ICombatEntity target, Skill skill, Position originPos, Position farPos)
		{
			...
			{
				GroundEffect = new EffectConfig("F_sys_target_monster##0.5", 0.7f),
				PositionDelay = 600,
				Effect = new EffectConfig("F_rize004_blue", 1.3f),
				Range = 20f,
				KnockdownPower = 100f,
				Delay = 0f,
				HitCount = 1,
