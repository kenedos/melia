...
{
	[SkillHandler(SkillId.Mon_Horong_walker_Skill_1)]
	public class Mon_Horong_walker_Skill_1 : ITargetSkillHandler
	{
	...
	[SkillHandler(SkillId.Mon_Horong_walker_Skill_2)]
	public class Mon_Horong_walker_Skill_2 : ITargetSkillHandler
	{
		public void Handle(Skill skill, ICombatEntity caster, ICombatEntity target)
		{
			if (!caster.TrySpendSp(skill))
		...
		private async Task HandleSkill(ICombatEntity caster, ICombatEntity target, Skill skill, Position originPos, Position farPos)
		{
			...
			{
				Effect = new EffectConfig("I_force018_trail_fire_blue#Bone_mouth", 0.5f),
				EndEffect = new EffectConfig("F_explosion120_blue", 1f),
				Range = 10f,
				FlyTime = 1f,
				DelayTime = 0f,
				Gravity = 600f,
