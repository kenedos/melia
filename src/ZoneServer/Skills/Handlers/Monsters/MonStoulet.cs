...
{
	[SkillHandler(SkillId.Mon_Stoulet_bow_Skill_1)]
	public class Mon_Stoulet_bow_Skill_1 : ITargetSkillHandler
	{
	...
	[SkillHandler(SkillId.Mon_Stoulet_mage_Skill_1)]
	public class Mon_Stoulet_mage_Skill_1 : ITargetSkillHandler
	{
	...
	[SkillHandler(SkillId.Mon_Stoulet_Skill_1)]
	public class Mon_Stoulet_Skill_1 : ITargetSkillHandler
	{
		protected TimeSpan AniTime { get; } = TimeSpan.FromMilliseconds(800);
		public void Handle(Skill skill, ICombatEntity caster, ICombatEntity target)
		{
