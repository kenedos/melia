...
namespace Melia.Zone.Skills.Handlers.Mon
{
	...
	public class Mon_hook_red_Skill_1 : ITargetSkillHandler
	{
	...
	public class Mon_hook_red_Skill_2 : ITargetSkillHandler
	{
	...
	public class Mon_hook_red_Skill_3 : ITargetSkillHandler
	{
		protected TimeSpan AniTime { get; } = TimeSpan.FromMilliseconds(800);
		public void Handle(Skill skill, ICombatEntity caster, ICombatEntity target)
		{
		...
		private async Task HandleSkill(ICombatEntity caster, ICombatEntity target, Skill skill, Position originPos, Position farPos, int hitDelay, int aniTime)
		{
			var splashParam = skill.GetSplashParameters(caster, originPos, farPos, length: 10, width: 30, angle: 30f);
			var splashArea = skill.GetSplashArea(SplashType.Circle, splashParam);
			var hits = new List<SkillHitInfo>();
			await SkillAttack(caster, skill, splashArea, hitDelay, aniTime, hits);
			SkillResultKnockTarget(caster, skill, KnockType.Motion, KnockDirection.TowardsTarget, 150, 60, 20, 1, 5, hits: hits);
		}
	}

	[SkillHandler(SkillId.Mon_hook_Skill_1)]
	public class Mon_hook_Skill_1 : ITargetSkillHandler
	{
	...
	public class Mon_hook_Skill_2 : ITargetSkillHandler
	{
		protected TimeSpan AniTime { get; } = TimeSpan.FromMilliseconds(700);
		public void Handle(Skill skill, ICombatEntity caster, ICombatEntity target)
		{
	...
	public class Mon_hook_Skill_3 : ITargetSkillHandler
	{
