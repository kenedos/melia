...
{
	[SkillHandler(SkillId.Mon_rabbee_Skill_1)]
	public class Mon_rabbee_Skill_1 : ITargetSkillHandler
	{
	...
	[SkillHandler(SkillId.Mon_rabbee_Skill_2)]
	public class Mon_rabbee_Skill_2 : ITargetSkillHandler
	{
