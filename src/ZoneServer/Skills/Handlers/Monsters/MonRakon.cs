...
{
	[SkillHandler(SkillId.Mon_Rakon_Skill_1)]
	public class Mon_Rakon_Skill_1 : ITargetSkillHandler
	{
	...
	public class Mon_Rakon_Skill_2 : ITargetSkillHandler
	{
		...
		private async Task HandleSkill(ICombatEntity caster, ICombatEntity target, Skill skill, Position originPos, Position farPos)
		{
			...
			SkillResultTargetBuff(caster, skill, BuffId.UC_deprotect, 1, 0f, 4000f, 1, 10, -1, hits);
		}
	}
