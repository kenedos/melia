...
{
	[SkillHandler(SkillId.Mon_luna_angel_Skill_1)]
	public class Mon_luna_angel_Skill_1 : ITargetSkillHandler
	{
	...
	[SkillHandler(SkillId.Mon_luna_angel_Skill_2)]
	public class Mon_luna_angel_Skill_2 : ITargetSkillHandler
	{
