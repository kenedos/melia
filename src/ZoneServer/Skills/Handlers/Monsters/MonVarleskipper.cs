...
namespace Melia.Zone.Skills.Handlers.Mon
{
	...
	public class Mon_VarleSkipper_Skill_1 : ITargetSkillHandler
	{
	...
	[SkillHandler(SkillId.Mon_VarleSkipper_Skill_2)]
	public class Mon_VarleSkipper_Skill_2 : ITargetSkillHandler
	{
