...
{
	[SkillHandler(SkillId.Mon_Triffid_Skill_1)]
	public class Mon_Triffid_Skill_1 : ITargetSkillHandler
	{
		...
		private async Task HandleSkill(ICombatEntity caster, ICombatEntity target, Skill skill, Position originPos, Position farPos)
		{
			...
			SkillResultTargetBuff(caster, skill, BuffId.UC_sleep, 1, 0f, 3000f, 1, 40, -1, hits);

		}
	}

	[SkillHandler(SkillId.Mon_Triffid_Skill_2)]
	public class Mon_Triffid_Skill_2 : ITargetSkillHandler
	{
		protected TimeSpan DamageDelay { get; } = TimeSpan.FromMilliseconds(1000);
		public void Handle(Skill skill, ICombatEntity caster, ICombatEntity target)
		{
