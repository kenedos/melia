...
{
	[SkillHandler(SkillId.Mon_Salamion_Skill_1)]
	public class Mon_Salamion_Skill_1 : ITargetSkillHandler
	{
	...
	public class Mon_Salamion_Skill_2 : ITargetSkillHandler
	{
	...
	public class Mon_Salamion_Skill_3 : ITargetSkillHandler
	{
	...
	[SkillHandler(SkillId.Mon_Salamion_Skill_4)]
	public class Mon_Salamion_Skill_4 : ITargetSkillHandler
	{
		protected TimeSpan DamageDelay { get; } = TimeSpan.FromMilliseconds(300);
		public void Handle(Skill skill, ICombatEntity caster, ICombatEntity target)
		{
