...
namespace Melia.Zone.Skills.Handlers.Mon
{
	...
	public class Mon_pierrol_Skill_1 : ITargetSkillHandler
	{
	...
	[SkillHandler(SkillId.Mon_pierrol_Skill_2)]
	public class Mon_pierrol_Skill_2 : ITargetSkillHandler
	{
		public void Handle(Skill skill, ICombatEntity caster, ICombatEntity target)
		{
			if (!caster.TrySpendSp(skill))
			...
			caster.StartBuff(BuffId.Mon_Golden_Bell_Shield_Buff, 1f, 0f, TimeSpan.FromMilliseconds(6000f), caster);
		}
	}
}
