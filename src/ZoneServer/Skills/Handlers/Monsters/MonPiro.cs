...
{
	[SkillHandler(SkillId.Mon_piro_Skill_1)]
	public class Mon_piro_Skill_1 : ITargetSkillHandler
	{
		...
		private async Task HandleSkill(ICombatEntity caster, ICombatEntity target, Skill skill, Position originPos, Position farPos)
		{
			...
			await EffectAndHit(skill, caster, position, new EffectHitConfig
			{
				...
				PositionDelay = 0,
				Effect = new EffectConfig("F_hit001_light_red", 0.3f),
				Range = 15f,
				KnockdownPower = 100f,
				Delay = 0f,
				HitCount = 1,
	...
	[SkillHandler(SkillId.Mon_piro_Skill_2)]
	public class Mon_piro_Skill_2 : ITargetSkillHandler
	{
