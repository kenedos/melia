...
{
	[SkillHandler(SkillId.Mon_lapindal_Skill_1)]
	public class Mon_lapindal_Skill_1 : ITargetSkillHandler
	{
	...
	[SkillHandler(SkillId.Mon_lapindal_Skill_2)]
	public class Mon_lapindal_Skill_2 : ITargetSkillHandler
	{
