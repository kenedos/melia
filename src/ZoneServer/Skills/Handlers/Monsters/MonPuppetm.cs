...
{
	[SkillHandler(SkillId.Mon_PuppetM_Skill_1)]
	public class Mon_PuppetM_Skill_1 : ITargetSkillHandler
	{
	...
	[SkillHandler(SkillId.Mon_PuppetM_Skill_2)]
	public class Mon_PuppetM_Skill_2 : ITargetSkillHandler
	{
