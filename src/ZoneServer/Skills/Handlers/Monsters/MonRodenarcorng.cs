...
{
	[SkillHandler(SkillId.Mon_rodenarcorng_Skill_1)]
	public class Mon_rodenarcorng_Skill_1 : ITargetSkillHandler
	{
	...
	[SkillHandler(SkillId.Mon_rodenarcorng_Skill_2)]
	public class Mon_rodenarcorng_Skill_2 : ITargetSkillHandler
	{
		protected TimeSpan AniTime { get; } = TimeSpan.FromMilliseconds(1000);
		public void Handle(Skill skill, ICombatEntity caster, ICombatEntity target)
		{
