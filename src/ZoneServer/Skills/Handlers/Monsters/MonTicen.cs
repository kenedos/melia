...
{
	[SkillHandler(SkillId.Mon_ticen_bow_Skill_1)]
	public class Mon_ticen_bow_Skill_1 : ITargetSkillHandler
	{
		...
		public void Handle(Skill skill, ICombatEntity caster, ICombatEntity target)
		{
			...
			var hitDelay = 300 + (int)(caster.Position.Get2DDistance(target.Position) * 2.7);
	...
	public class Mon_ticen_mage_Skill_1 : ITargetSkillHandler
	{
		...
		private async Task HandleSkill(ICombatEntity caster, ICombatEntity target, Skill skill, Position originPos, Position farPos, int hitDelay)
		{
			...
			SkillResultTargetBuff(caster, skill, BuffId.UC_immobilize, 1, 0f, 3000f, 1, 10, -1, hits);

		}
	}

	[SkillHandler(SkillId.Mon_ticen_Skill_1)]
	public class Mon_ticen_Skill_1 : ITargetSkillHandler
	{
