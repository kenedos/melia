...
{
	[SkillHandler(SkillId.Mon_umblet_Skill_1)]
	public class Mon_umblet_Skill_1 : ITargetSkillHandler
	{
	...
	[SkillHandler(SkillId.Mon_umblet_Skill_2)]
	public class Mon_umblet_Skill_2 : ITargetSkillHandler
	{
		public void Handle(Skill skill, ICombatEntity caster, ICombatEntity target)
		{
			if (!caster.TrySpendSp(skill))
