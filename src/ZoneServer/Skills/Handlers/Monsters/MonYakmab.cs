...
namespace Melia.Zone.Skills.Handlers.Mon
{
	...
	public class Mon_yakmab_Skill_1 : ITargetSkillHandler
	{
		...
		{
			var splashParam = skill.GetSplashParameters(caster, originPos, farPos, length: 30, width: 15, angle: 45f);
	...
	public class Mon_yakmab_Skill_2 : ITargetSkillHandler
	{
