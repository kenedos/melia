...
namespace Melia.Zone.Skills.Handlers.Mon
{
	...
	public class Mon_Corpse_Flower_Skill_1 : ITargetSkillHandler
	{
	...
	public class Mon_Corpse_Flower_Skill_2 : ITargetSkillHandler
	{
		protected TimeSpan AniTime { get; } = TimeSpan.FromMilliseconds(1000);
		public void Handle(Skill skill, ICombatEntity caster, ICombatEntity target)
		{
	...
	public class Mon_Corpse_Flower_Skill_3 : ITargetSkillHandler
	{
