...
namespace Melia.Zone.Skills.Handlers.Mon
{
	...
	public class Mon_Siaulogre_Skill_1 : ITargetSkillHandler
	{
	...
	[SkillHandler(SkillId.Mon_Siaulogre_Skill_2)]
	public class Mon_Siaulogre_Skill_2 : ITargetSkillHandler
	{
