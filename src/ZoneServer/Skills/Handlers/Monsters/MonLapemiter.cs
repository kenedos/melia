...
{
	[SkillHandler(SkillId.Mon_Lapemiter_Skill_1)]
	public class Mon_Lapemiter_Skill_1 : ITargetSkillHandler
	{
		...
		public void Handle(Skill skill, ICombatEntity caster, ICombatEntity target)
		{
			...
			var hitDelay = 600 + (int)(caster.Position.Get2DDistance(target.Position) * 2.1);
	...
	[SkillHandler(SkillId.Mon_Lapemiter_Skill_2)]
	public class Mon_Lapemiter_Skill_2 : ITargetSkillHandler
	{
		public void Handle(Skill skill, ICombatEntity caster, ICombatEntity target)
		{
			if (!caster.TrySpendSp(skill))
		...
		private async Task HandleSkill(ICombatEntity caster, ICombatEntity target, Skill skill, Position originPos, Position farPos)
		{
			...
			{
				Effect = new EffectConfig("I_Lapemiter_bomb_mash#Dummy_weapon001", 0.8f),
				EndEffect = new EffectConfig("F_explosion015", 1f),
				Range = 10f,
				FlyTime = 0.8f,
				DelayTime = 0f,
				Gravity = 300f,
