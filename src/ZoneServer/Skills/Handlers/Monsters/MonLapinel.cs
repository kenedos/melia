...
{
	[SkillHandler(SkillId.Mon_lapinel_Skill_1)]
	public class Mon_lapinel_Skill_1 : ITargetSkillHandler
	{
	...
	[SkillHandler(SkillId.Mon_lapinel_Skill_2)]
	public class Mon_lapinel_Skill_2 : ITargetSkillHandler
	{
		...
		{
			var splashParam = skill.GetSplashParameters(caster, originPos, farPos, length: 100, width: 10, angle: 45f);
			var splashArea = skill.GetSplashArea(SplashType.Circle, splashParam);
			var hitDelay = 1100;
			var aniTime = 1300;
			await SkillAttack(caster, skill, splashArea, hitDelay, aniTime);
	...
	[SkillHandler(SkillId.Mon_lapinel_Skill_3)]
	public class Mon_lapinel_Skill_3 : ITargetSkillHandler
	{
		public void Handle(Skill skill, ICombatEntity caster, ICombatEntity target)
		{
			if (!caster.TrySpendSp(skill))
