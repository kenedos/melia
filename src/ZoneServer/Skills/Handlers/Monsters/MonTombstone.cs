...
namespace Melia.Zone.Skills.Handlers.Mon
{
	...
	public class Mon_Tombstone_golem_Skill_1 : ITargetSkillHandler
	{
	...
	[SkillHandler(SkillId.Mon_Tombstone_golem_Skill_2)]
	public class Mon_Tombstone_golem_Skill_2 : ITargetSkillHandler
	{
	...
	public class Mon_Tombstone_golem_Skill_3 : ITargetSkillHandler
	{
		...
		private async Task HandleSkill(ICombatEntity caster, ICombatEntity target, Skill skill, Position originPos, Position farPos, int hitDelay, int aniTime)
		{
			ISplashArea splashArea = new SplashAreas.Circle(originPos.GetRelative(farPos, distance: 57f, angle: 8f), 30f);
			await SkillAttack(caster, skill, splashArea, hitDelay, aniTime);
		}
	}

	[SkillHandler(SkillId.Mon_tombstone_turtle_Skill_1)]
	public class Mon_tombstone_turtle_Skill_1 : ITargetSkillHandler
	{
		protected TimeSpan AniTime { get; } = TimeSpan.FromMilliseconds(1000);
		public void Handle(Skill skill, ICombatEntity caster, ICombatEntity target)
		{
