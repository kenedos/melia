...
{
	[SkillHandler(SkillId.Mon_chupaluka_Skill_1)]
	public class Mon_chupaluka_Skill_1 : ITargetSkillHandler
	{
	...
	public class Mon_chupaluka_Skill_2 : ITargetSkillHandler
	{
