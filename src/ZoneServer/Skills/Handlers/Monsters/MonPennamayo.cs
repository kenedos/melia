...
{
	[SkillHandler(SkillId.Mon_pennamayo_Skill_1)]
	public class Mon_pennamayo_Skill_1 : ITargetSkillHandler
	{
	...
	[SkillHandler(SkillId.Mon_pennamayo_Skill_2)]
	public class Mon_pennamayo_Skill_2 : ITargetSkillHandler
	{
		...
		private async Task HandleSkill(ICombatEntity caster, ICombatEntity target, Skill skill, Position originPos, Position farPos)
		{
			...
			var damageDelay = 500;
			await SkillAttack(caster, skill, splashArea, hitDelay, damageDelay);
			splashParam = skill.GetSplashParameters(caster, originPos, farPos, length: 40, width: 20, angle: 20f);
