...
namespace Melia.Zone.Skills.Handlers.Mon
{
	...
	public class Mon_Maskexecutor_Skill_1 : ITargetSkillHandler
	{
		...
		{
			var splashParam = skill.GetSplashParameters(caster, originPos, farPos, length: 45, width: 30, angle: 35f);
	...
	public class Mon_Maskexecutor_Skill_2 : ITargetSkillHandler
	{
