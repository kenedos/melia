...
{
	[SkillHandler(SkillId.Mon_spector_F_Skill_1)]
	public class Mon_spector_F_Skill_1 : ITargetSkillHandler
	{
	...
	[SkillHandler(SkillId.Mon_spector_F_Skill_2)]
	public class Mon_spector_F_Skill_2 : ITargetSkillHandler
	{
		public void Handle(Skill skill, ICombatEntity caster, ICombatEntity target)
		{
			if (!caster.TrySpendSp(skill))
		...
		private async Task HandleSkill(ICombatEntity caster, ICombatEntity target, Skill skill, Position originPos, Position farPos)
		{
			...
			var position = originPos.GetRelative(farPos, distance: 60, angle: 54f);
	...
	public class Mon_Spector_Gh_Attack : ITargetSkillHandler
	{
	...
	public class Mon_Spector_Gh_Skill : ITargetSkillHandler
	{
