...
{
	[SkillHandler(SkillId.Mon_wisnol_Skill_1)]
	public class Mon_wisnol_Skill_1 : ITargetSkillHandler
	{
	...
	public class Mon_wisnol_Skill_2 : ITargetSkillHandler
	{
		...
		private async Task HandleSkill(ICombatEntity caster, ICombatEntity target, Skill skill, Position originPos, Position farPos)
		{
			var splashParam = skill.GetSplashParameters(caster, originPos, farPos, length: 45, width: 10);
