...
{
	[SkillHandler(SkillId.Mon_rompelnuka_Skill_1)]
	public class Mon_rompelnuka_Skill_1 : ITargetSkillHandler
	{
	...
	public class Mon_rompelnuka_Skill_2 : ITargetSkillHandler
	{
		protected TimeSpan DamageDelay { get; } = TimeSpan.FromMilliseconds(800);
		public void Handle(Skill skill, ICombatEntity caster, ICombatEntity target)
		{
