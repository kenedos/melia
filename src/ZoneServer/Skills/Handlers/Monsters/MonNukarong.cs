...
{
	[SkillHandler(SkillId.Mon_nukarong_Skill_1)]
	public class Mon_nukarong_Skill_1 : ITargetSkillHandler
	{
	...
	[SkillHandler(SkillId.Mon_nukarong_Skill_2)]
	public class Mon_nukarong_Skill_2 : ITargetSkillHandler
	{
		protected TimeSpan DamageDelay { get; } = TimeSpan.FromMilliseconds(800);
		public void Handle(Skill skill, ICombatEntity caster, ICombatEntity target)
		{
