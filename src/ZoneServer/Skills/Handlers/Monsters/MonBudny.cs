...
{
	[SkillHandler(SkillId.Mon_budny_Skill_1)]
	public class Mon_budny_Skill_1 : ITargetSkillHandler
	{
		...
		public void Handle(Skill skill, ICombatEntity caster, ICombatEntity target)
		{
			...
			var hitDelay = 400 + (int)(caster.Position.Get2DDistance(target.Position) * 3.8);
	...
	[SkillHandler(SkillId.Mon_budny_Skill_2)]
	public class Mon_budny_Skill_2 : ITargetSkillHandler
	{
		public void Handle(Skill skill, ICombatEntity caster, ICombatEntity target)
		{
			if (!caster.TrySpendSp(skill))
		...
		private async Task HandleSkill(ICombatEntity caster, ICombatEntity target, Skill skill, Position originPos, Position farPos)
		{
			...
			{
				ArrowEffect = new EffectConfig("F_explosion108_shockwave", 0.7f),
				ArrowSpacing = 25f,
