...
{
	[SkillHandler(SkillId.Mon_moringbird_Skill_1)]
	public class Mon_moringbird_Skill_1 : ITargetSkillHandler
	{
	...
	[SkillHandler(SkillId.Mon_moringbird_Skill_2)]
	public class Mon_moringbird_Skill_2 : ITargetSkillHandler
	{
