...
namespace Melia.Zone.Skills.Handlers.Mon
{
	...
	public class Mon_PagDoper_Skill_1 : ITargetSkillHandler
	{
		...
		public void Handle(Skill skill, ICombatEntity caster, ICombatEntity target)
		{
			...
			var hitDelay = 1000 + (int)(caster.Position.Get2DDistance(target.Position) * 2.2);
		...
		private async Task HandleSkill(ICombatEntity caster, ICombatEntity target, Skill skill, Position originPos, Position farPos, int hitDelay)
		{
			...
			SkillResultTargetBuff(caster, skill, BuffId.UC_poison, 1, hits.Sum(h => h.HitInfo.Damage) * 0.2f, 5000f, 0, 5, -1, hits);
		}
	}

	[SkillHandler(SkillId.Mon_PagDoper_Skill_2)]
	public class Mon_PagDoper_Skill_2 : ITargetSkillHandler
	{
