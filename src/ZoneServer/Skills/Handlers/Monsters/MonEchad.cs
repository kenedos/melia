...
{
	[SkillHandler(SkillId.Mon_Echad_bow_Skill_1)]
	public class Mon_Echad_bow_Skill_1 : ITargetSkillHandler
	{
		...
		public void Handle(Skill skill, ICombatEntity caster, ICombatEntity target)
		{
			...
			var hitDelay = 500 + (int)(caster.Position.Get2DDistance(target.Position) * 4.6);
	...
	[SkillHandler(SkillId.Mon_Echad_Skill_1)]
	public class Mon_Echad_Skill_1 : ITargetSkillHandler
	{
