...
{
	[SkillHandler(SkillId.Mon_thornball_Attack1)]
	public class Mon_thornball_Attack1 : ITargetSkillHandler
	{
	...
	[SkillHandler(SkillId.Mon_thornball_Attack2)]
	public class Mon_thornball_Attack2 : ITargetSkillHandler
	{
		...
		private async Task HandleSkill(ICombatEntity caster, ICombatEntity target, Skill skill, Position originPos, Position farPos)
		{
			...
			SkillCreatePad(caster, skill, caster.Position, 0f, PadName.BubeMageNormal_ReflectShield);
		}
	}
