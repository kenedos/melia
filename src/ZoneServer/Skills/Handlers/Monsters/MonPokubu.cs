...
{
	[SkillHandler(SkillId.Mon_Pokubu_Attack)]
	public class Mon_Pokubu_Attack : ITargetSkillHandler
	{
	...
	[SkillHandler(SkillId.Mon_Pokubu_Gray_Skill_1)]
	public class Mon_Pokubu_Gray_Skill_1 : ITargetSkillHandler
	{
		protected TimeSpan DamageDelay { get; } = TimeSpan.FromMilliseconds(1000);
		public void Handle(Skill skill, ICombatEntity caster, ICombatEntity target)
		{
	...
	[SkillHandler(SkillId.Mon_Pokubu_Skill_1)]
	public class Mon_Pokubu_Skill_1 : ITargetSkillHandler
	{
		protected TimeSpan DamageDelay { get; } = TimeSpan.FromMilliseconds(1000);
		public void Handle(Skill skill, ICombatEntity caster, ICombatEntity target)
		{
