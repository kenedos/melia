...
namespace Melia.Zone.Skills.Handlers.Mon
{
	...
	public class Mon_Mallardu_Skill_1 : ITargetSkillHandler
	{
		...
		private async Task HandleSkill(ICombatEntity caster, ICombatEntity target, Skill skill, Position originPos, Position farPos)
		{
			...
			SkillResultTargetBuff(caster, skill, BuffId.UC_fear, 1, 0f, 5000f, 1, 15, -1, hits);
		}
	}

	[SkillHandler(SkillId.Mon_Mallardu_Skill_2)]
	public class Mon_Mallardu_Skill_2 : ITargetSkillHandler
	{
