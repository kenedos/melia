...
namespace Melia.Zone.Skills.Handlers.Mon
{
	...
	public class Mon_vilkas_archer_Skill_1 : ITargetSkillHandler
	{
	...
	[SkillHandler(SkillId.Mon_vilkas_archer_Skill_2)]
	public class Mon_vilkas_archer_Skill_2 : ITargetSkillHandler
	{
		public void Handle(Skill skill, ICombatEntity caster, ICombatEntity target)
		{
			if (!caster.TrySpendSp(skill))
	...
	[SkillHandler(SkillId.Mon_vilkas_fighter_Skill_1)]
	public class Mon_vilkas_fighter_Skill_1 : ITargetSkillHandler
	{
		public void Handle(Skill skill, ICombatEntity caster, ICombatEntity target)
		{
			if (!caster.TrySpendSp(skill))
		...
		private async Task HandleSkill(ICombatEntity caster, ICombatEntity target, Skill skill, Position originPos, Position farPos)
		{
			...
			await EffectAndHit(skill, caster, position, new EffectHitConfig
			{
				...
				PositionDelay = 0,
				Effect = new EffectConfig("F_burstup029_smoke_grey", 0.8f),
				Range = 30f,
				KnockdownPower = 200f,
				Delay = 0f,
				HitCount = 1,
	...
	public class Mon_vilkas_fighter_Skill_2 : ITargetSkillHandler
	{
	...
	[SkillHandler(SkillId.Mon_vilkas_mage_Skill_1)]
	public class Mon_vilkas_mage_Skill_1 : ITargetSkillHandler
	{
		public void Handle(Skill skill, ICombatEntity caster, ICombatEntity target)
		{
			if (!caster.TrySpendSp(skill))
		...
		private async Task HandleSkill(ICombatEntity caster, ICombatEntity target, Skill skill, Position originPos, Position farPos)
		{
			...
			await EffectAndHit(skill, caster, position, new EffectHitConfig
			{
				GroundEffect = EffectConfig.None,
				PositionDelay = 0,
				Effect = new EffectConfig("F_spin030_fire", 0.3f),
				Range = 20f,
				KnockdownPower = 100f,
				Delay = 0f,
				HitCount = 1,
	...
	[SkillHandler(SkillId.Mon_vilkas_mage_Skill_2)]
	public class Mon_vilkas_mage_Skill_2 : ITargetSkillHandler
	{
		public void Handle(Skill skill, ICombatEntity caster, ICombatEntity target)
		{
			if (!caster.TrySpendSp(skill))
		...
		private async Task HandleSkill(ICombatEntity caster, ICombatEntity target, Skill skill, Position originPos, Position farPos)
		{
			...
			await EffectAndHit(skill, caster, position, new EffectHitConfig
			{
				GroundEffect = new EffectConfig("F_spread_in002_red#Bip001 Spine", 0.3f),
				PositionDelay = 1500,
				Effect = new EffectConfig("F_burstup028_fire", 2f),
				Range = 60f,
				KnockdownPower = 200f,
				Delay = 0f,
				HitCount = 1,
	...
	[SkillHandler(SkillId.Mon_vilkas_soldier_Skill_1)]
	public class Mon_vilkas_soldier_Skill_1 : ITargetSkillHandler
	{
		protected TimeSpan AniTime { get; } = TimeSpan.FromMilliseconds(800);
		public void Handle(Skill skill, ICombatEntity caster, ICombatEntity target)
		{
	...
	[SkillHandler(SkillId.Mon_vilkas_soldier_Skill_2)]
	public class Mon_vilkas_soldier_Skill_2 : ITargetSkillHandler
	{
		protected TimeSpan AniTime { get; } = TimeSpan.FromMilliseconds(800);
		public void Handle(Skill skill, ICombatEntity caster, ICombatEntity target)
		{
	...
	public class Mon_vilkas_spearman_Skill_1 : ITargetSkillHandler
	{
		protected TimeSpan AniTime { get; } = TimeSpan.FromMilliseconds(800);
		public void Handle(Skill skill, ICombatEntity caster, ICombatEntity target)
		{
	...
	[SkillHandler(SkillId.Mon_vilkas_spearman_Skill_2)]
	public class Mon_vilkas_spearman_Skill_2 : ITargetSkillHandler
	{
	...
	public class Mon_vilkas_warrior_Skill_1 : ITargetSkillHandler
	{
		protected TimeSpan AniTime { get; } = TimeSpan.FromMilliseconds(800);
		public void Handle(Skill skill, ICombatEntity caster, ICombatEntity target)
		{
	...
	[SkillHandler(SkillId.Mon_vilkas_warrior_Skill_2)]
	public class Mon_vilkas_warrior_Skill_2 : ITargetSkillHandler
	{
		protected TimeSpan AniTime { get; } = TimeSpan.FromMilliseconds(800);
		public void Handle(Skill skill, ICombatEntity caster, ICombatEntity target)
		{
