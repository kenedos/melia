...
namespace Melia.Zone.Skills.Handlers.Mon
{
	...
	public class Mon_Zombie_hoplite_Skill_1 : ITargetSkillHandler
	{
		...
		{
			var splashParam = skill.GetSplashParameters(caster, originPos, farPos, length: 60, width: 25, angle: 30f);
	...
	public class Mon_Zombie_hoplite_Skill_2 : ITargetSkillHandler
	{
