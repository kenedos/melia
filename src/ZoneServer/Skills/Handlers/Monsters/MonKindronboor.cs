...
{
	[SkillHandler(SkillId.Mon_KindronBoor_Skill_1)]
	public class Mon_KindronBoor_Skill_1 : ITargetSkillHandler
	{
	...
	public class Mon_KindronBoor_Skill_2 : ITargetSkillHandler
	{
		protected TimeSpan DamageDelay { get; } = TimeSpan.FromMilliseconds(700);
		public void Handle(Skill skill, ICombatEntity caster, ICombatEntity target)
		{
