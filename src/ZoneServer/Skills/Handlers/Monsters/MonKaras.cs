...
{
	[SkillHandler(SkillId.Mon_Karas_mage_Skill_1)]
	public class Mon_Karas_mage_Skill_1 : ITargetSkillHandler
	{
		...
		public void Handle(Skill skill, ICombatEntity caster, ICombatEntity target)
		{
			...
			var hitDelay = 500 + (int)(caster.Position.Get2DDistance(target.Position) * 3.5);
	...
	public class Mon_Karas_Skill_1 : ITargetSkillHandler
	{
	...
	public class Mon_Karas_Skill_2 : ITargetSkillHandler
	{
		protected TimeSpan AniTime { get; } = TimeSpan.FromMilliseconds(300);
		public void Handle(Skill skill, ICombatEntity caster, ICombatEntity target)
		{
