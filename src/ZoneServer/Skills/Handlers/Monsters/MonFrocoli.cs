...
namespace Melia.Zone.Skills.Handlers.Mon
{
	...
	public class Mon_Frocoli_Skill_1 : ITargetSkillHandler
	{
		...
		{
			var splashParam = skill.GetSplashParameters(caster, originPos, farPos, length: 45, width: 15, angle: 30f);
	...
	public class Mon_Frocoli_Skill_2 : ITargetSkillHandler
	{
