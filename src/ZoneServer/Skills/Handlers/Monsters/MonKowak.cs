...
{
	[SkillHandler(SkillId.Mon_kowak_Skill_1)]
	public class Mon_kowak_Skill_1 : ITargetSkillHandler
	{
	...
	[SkillHandler(SkillId.Mon_kowak_Skill_2)]
	public class Mon_kowak_Skill_2 : ITargetSkillHandler
	{
