...
{
	[SkillHandler(SkillId.Mon_pumpkin_dog_Skill_1)]
	public class Mon_pumpkin_dog_Skill_1 : ITargetSkillHandler
	{
	...
	[SkillHandler(SkillId.Mon_pumpkin_dog_Skill_2)]
	public class Mon_pumpkin_dog_Skill_2 : ITargetSkillHandler
	{
		public void Handle(Skill skill, ICombatEntity caster, ICombatEntity target)
		{
			if (!caster.TrySpendSp(skill))
		...
		private async Task HandleSkill(ICombatEntity caster, ICombatEntity target, Skill skill, Position originPos, Position farPos)
		{
			...
			var endingPosition = originPos.GetRelative(farPos, distance: 45f);
