...
{
	[SkillHandler(SkillId.Mon_darong_Skill_1)]
	public class Mon_darong_Skill_1 : ITargetSkillHandler
	{
	...
	[SkillHandler(SkillId.Mon_darong_Skill_2)]
	public class Mon_darong_Skill_2 : ITargetSkillHandler
	{
