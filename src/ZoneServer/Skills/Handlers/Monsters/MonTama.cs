...
{
	[SkillHandler(SkillId.Mon_Tama_Skill_1)]
	public class Mon_Tama_Skill_1 : ITargetSkillHandler
	{
	...
	public class Mon_Tama_Skill_2 : ITargetSkillHandler
	{
		...
		private async Task HandleSkill(ICombatEntity caster, ICombatEntity target, Skill skill, Position originPos, Position farPos)
		{
			...
			SkillResultTargetBuff(caster, skill, BuffId.UC_petrify, 1, 0f, 2000f, 1, 10, -1, hits);
		}
	}
