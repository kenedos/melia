...
{
	[SkillHandler(SkillId.Mon_Pandroceum_Skill_1)]
	public class Mon_Pandroceum_Skill_1 : ITargetSkillHandler
	{
	...
	[SkillHandler(SkillId.Mon_Pandroceum_Skill_2)]
	public class Mon_Pandroceum_Skill_2 : ITargetSkillHandler
	{
		public void Handle(Skill skill, ICombatEntity caster, ICombatEntity target)
		{
			if (!caster.TrySpendSp(skill))
		...
		private async Task HandleSkill(ICombatEntity caster, ICombatEntity target, Skill skill, Position originPos, Position farPos)
		{
			...
			{
				Effect = new EffectConfig("I_force039_orange#Dummy001", 0.3f),
				EndEffect = new EffectConfig("I_explosion009_orange", 0.4f),
			...
			//SkillResultTargetBuff(caster, skill, BuffId.UC_sleep, 1, 0f, 3000f, 1, 10, hits);
		}
	}
}
