...
{
	[SkillHandler(SkillId.Mon_aclis_angel_Skill_1)]
	public class Mon_aclis_angel_Skill_1 : ITargetSkillHandler
	{
	...
	[SkillHandler(SkillId.Mon_aclis_angel_Skill_2)]
	public class Mon_aclis_angel_Skill_2 : ITargetSkillHandler
	{
		public void Handle(Skill skill, ICombatEntity caster, ICombatEntity target)
		{
			if (!caster.TrySpendSp(skill))
