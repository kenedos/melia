...
namespace Melia.Zone.Skills.Handlers.Mon
{
	...
	public class Mon_llapindal_ribbon_Skill_1 : ITargetSkillHandler
	{
	...
	[SkillHandler(SkillId.Mon_llapindal_ribbon_Skill_2)]
	public class Mon_llapindal_ribbon_Skill_2 : ITargetSkillHandler
	{
