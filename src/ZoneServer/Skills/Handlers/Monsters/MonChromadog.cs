...
namespace Melia.Zone.Skills.Handlers.Mon
{
	...
	public class Mon_Chromadog_Skill_1 : ITargetSkillHandler
	{
	...
	[SkillHandler(SkillId.Mon_Chromadog_Skill_2)]
	public class Mon_Chromadog_Skill_2 : ITargetSkillHandler
	{
