...
namespace Melia.Zone.Skills.Handlers.Mon
{
	...
	public class Mon_Npanto_archer_Skill_1 : ITargetSkillHandler
	{
	...
	public class Mon_Npanto_archer_Skill_2 : ITargetSkillHandler
	{
		public void Handle(Skill skill, ICombatEntity caster, ICombatEntity target)
		{
			if (!caster.TrySpendSp(skill))
	...
	[SkillHandler(SkillId.Mon_Npanto_baby_Skill_1)]
	public class Mon_Npanto_baby_Skill_1 : ITargetSkillHandler
	{
	...
	[SkillHandler(SkillId.Mon_Npanto_baby_Skill_2)]
	public class Mon_Npanto_baby_Skill_2 : ITargetSkillHandler
	{
		protected TimeSpan AniTime { get; } = TimeSpan.FromMilliseconds(900);
		public void Handle(Skill skill, ICombatEntity caster, ICombatEntity target)
		{
	...
	[SkillHandler(SkillId.Mon_Npanto_baby_Skill_3)]
	public class Mon_Npanto_baby_Skill_3 : ITargetSkillHandler
	{
		public void Handle(Skill skill, ICombatEntity caster, ICombatEntity target)
		{
			if (!caster.TrySpendSp(skill))
	...
	[SkillHandler(SkillId.Mon_Npanto_hand_Skill_1)]
	public class Mon_Npanto_hand_Skill_1 : ITargetSkillHandler
	{
	...
	[SkillHandler(SkillId.Mon_Npanto_hand_Skill_2)]
	public class Mon_Npanto_hand_Skill_2 : ITargetSkillHandler
	{
	...
	public class Mon_Npanto_staff_Skill_1 : ITargetSkillHandler
	{
		...
		private async Task HandleSkill(ICombatEntity caster, ICombatEntity target, Skill skill, Position originPos, Position farPos, int hitDelay, int aniTime)
		{
			...
			SkillResultTargetBuff(caster, skill, BuffId.UC_sleep, 1, 0f, 2000f, 1, 5, -1, hits);
		}
	}

	[SkillHandler(SkillId.Mon_Npanto_staff_Skill_2)]
	public class Mon_Npanto_staff_Skill_2 : ITargetSkillHandler
	{
		public void Handle(Skill skill, ICombatEntity caster, ICombatEntity target)
		{
			if (!caster.TrySpendSp(skill))
		...
		private async Task HandleSkill(ICombatEntity caster, ICombatEntity target, Skill skill, Position originPos, Position farPos)
		{
			...
			{
				GroundEffect = new EffectConfig("F_ground028_rize##0.3", 0.3f),
				PositionDelay = 300,
			...
			position = GetRelativePosition(PosType.TargetDistance, caster, target, rand: 50);
			await EffectAndHit(skill, caster, position, config);
			position = GetRelativePosition(PosType.TargetDistance, caster, target, rand: 50);
			await EffectAndHit(skill, caster, position, config);
		}
	...
	[SkillHandler(SkillId.Mon_Npanto_sword_Skill_1)]
	public class Mon_Npanto_sword_Skill_1 : ITargetSkillHandler
	{
		protected TimeSpan AniTime { get; } = TimeSpan.FromMilliseconds(900);
		public void Handle(Skill skill, ICombatEntity caster, ICombatEntity target)
		{
	...
	[SkillHandler(SkillId.Mon_Npanto_sword_Skill_2)]
	public class Mon_Npanto_sword_Skill_2 : ITargetSkillHandler
	{
		protected TimeSpan AniTime { get; } = TimeSpan.FromMilliseconds(900);
		public void Handle(Skill skill, ICombatEntity caster, ICombatEntity target)
		{
