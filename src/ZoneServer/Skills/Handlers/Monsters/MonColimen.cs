...
{
	[SkillHandler(SkillId.Mon_colimen_mage_Skill_1)]
	public class Mon_colimen_mage_Skill_1 : ITargetSkillHandler
	{
		...
		private async Task HandleSkill(ICombatEntity caster, ICombatEntity target, Skill skill, Position originPos, Position farPos)
		{
			...
			caster.SetTargets(SkillSelectEnemiesInCircle(caster, targetPos, 60f, 1));
			...
			{
				Effect = new EffectConfig("I_force080_green_blue#Dummy006", 0.3f),
				EndEffect = new EffectConfig("F_explosion066_green_blue", 0.5f),
				Range = 10f,
				FlyTime = 1f,
				DelayTime = 0f,
				Gravity = 300f,
	...
	[SkillHandler(SkillId.Mon_colimen_mage_Skill_2)]
	public class Mon_colimen_mage_Skill_2 : ITargetSkillHandler
	{
		public void Handle(Skill skill, ICombatEntity caster, ICombatEntity target)
		{
			if (!caster.TrySpendSp(skill))
		...
		private async Task HandleSkill(ICombatEntity caster, ICombatEntity target, Skill skill, Position originPos, Position farPos)
		{
			...
			await EffectHitArrow(skill, caster, startingPosition, endingPosition, new ArrowConfig
			{
				...
				ArrowLifeTime = 1f,
				PositionDelay = 0f,
				HitEffect = new EffectConfig("F_explosion002_yellow", 0.5f),
				Range = 10f,
				KnockdownPower = 100f,
				Delay = 0f,
	...
	[SkillHandler(SkillId.Mon_colimen_Skill_1)]
	public class Mon_colimen_Skill_1 : ITargetSkillHandler
	{
		...
		private async Task HandleSkill(ICombatEntity caster, ICombatEntity target, Skill skill, Position originPos, Position farPos, int hitDelay, int aniTime)
		{
			...
			SkillResultTargetBuff(caster, skill, BuffId.UC_slowdown, 1, 0f, 6000f, 1, 20, -1, hits);
		}
	}
}
