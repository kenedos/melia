...
{
	[SkillHandler(SkillId.Mon_Rambear_bow_Skill_1)]
	public class Mon_Rambear_bow_Skill_1 : ITargetSkillHandler
	{
		...
		public void Handle(Skill skill, ICombatEntity caster, ICombatEntity target)
		{
			...
			var hitDelay = 300 + (int)(caster.Position.Get2DDistance(target.Position) * 3.2);
	...
	[SkillHandler(SkillId.Mon_Rambear_mage_Skill_1)]
	public class Mon_Rambear_mage_Skill_1 : ITargetSkillHandler
	{
	...
	[SkillHandler(SkillId.Mon_rambear_Skill_1)]
	public class Mon_rambear_Skill_1 : ITargetSkillHandler
	{
	...
	[SkillHandler(SkillId.Mon_rambear_Skill_2)]
	public class Mon_rambear_Skill_2 : ITargetSkillHandler
	{
		protected TimeSpan AniTime { get; } = TimeSpan.FromMilliseconds(1000);
		public void Handle(Skill skill, ICombatEntity caster, ICombatEntity target)
		{
	...
	[SkillHandler(SkillId.Mon_rambear_Skill_3)]
	public class Mon_rambear_Skill_3 : ITargetSkillHandler
	{
		protected TimeSpan AniTime { get; } = TimeSpan.FromMilliseconds(1000);
		public void Handle(Skill skill, ICombatEntity caster, ICombatEntity target)
		{
