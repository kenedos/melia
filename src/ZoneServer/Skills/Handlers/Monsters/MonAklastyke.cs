...
{
	[SkillHandler(SkillId.Mon_aklastyke_Skill_1)]
	public class Mon_aklastyke_Skill_1 : ITargetSkillHandler
	{
	...
	[SkillHandler(SkillId.Mon_aklastyke_Skill_2)]
	public class Mon_aklastyke_Skill_2 : ITargetSkillHandler
	{
		public void Handle(Skill skill, ICombatEntity caster, ICombatEntity target)
		{
			if (!caster.TrySpendSp(skill))
		...
		private async Task HandleSkill(ICombatEntity caster, ICombatEntity target, Skill skill, Position originPos, Position farPos)
		{
			...
			await EffectHitArrow(skill, caster, startingPosition, endingPosition, new ArrowConfig
			{
				...
				ArrowLifeTime = 1f,
				PositionDelay = 0f,
				HitEffect = new EffectConfig("F_hit006_dark_violet", 0.8f),
				Range = 15f,
				KnockdownPower = 160f,
				Delay = 0f,
