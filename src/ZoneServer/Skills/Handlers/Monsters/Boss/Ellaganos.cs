...
{
	[SkillHandler(SkillId.Mon_boss_ellaganos_Skill_1)]
	public class Mon_boss_ellaganos_Skill_1 : ITargetSkillHandler
	{
	...
	[SkillHandler(SkillId.Mon_boss_ellaganos_Skill_2)]
	public class Mon_boss_ellaganos_Skill_2 : ITargetSkillHandler
	{
		public void Handle(Skill skill, ICombatEntity caster, ICombatEntity target)
		{
			if (!caster.TrySpendSp(skill))
	...
	[SkillHandler(SkillId.Mon_boss_ellaganos_Skill_3)]
	public class Mon_boss_ellaganos_Skill_3 : ITargetSkillHandler
	{
		...
		private async Task HandleSkill(ICombatEntity caster, ICombatEntity target, Skill skill, Position originPos, Position farPos)
		{
			...
			var arrowConfig = new ArrowConfig
			{
				...
				ArrowLifeTime = 0.6f,
				PositionDelay = 1000f,
				HitEffect = new EffectConfig("F_burstup002_dark", 0.6f),
				Range = 15f,
				KnockdownPower = 100f,
				Delay = 0f,
	...
	[SkillHandler(SkillId.Mon_boss_ellaganos_Skill_4)]
	public class Mon_boss_ellaganos_Skill_4 : ITargetSkillHandler
	{
	...
	[SkillHandler(SkillId.Mon_boss_ellaganos_Skill_5)]
	public class Mon_boss_ellaganos_Skill_5 : ITargetSkillHandler
	{
		public void Handle(Skill skill, ICombatEntity caster, ICombatEntity target)
		{
			if (!caster.TrySpendSp(skill))
