...
namespace Melia.Zone.Skills.Handlers.Monsters.Boss
{
	...
	public class Mon_boss_Kimeleech_Skill_1 : ITargetSkillHandler
	{
	...
	[SkillHandler(SkillId.Mon_boss_Kimeleech_Skill_2)]
	public class Mon_boss_Kimeleech_Skill_2 : ITargetSkillHandler
	{
		protected TimeSpan AniTime { get; } = TimeSpan.FromMilliseconds(300);
		public void Handle(Skill skill, ICombatEntity caster, ICombatEntity target)
		{
		...
		private async Task HandleSkill(ICombatEntity caster, ICombatEntity target, Skill skill, Position originPos, Position farPos)
		{
			...
			{
				ArrowEffect = new EffectConfig("Non", 1f),
				ArrowSpacing = 20f,
				ArrowSpacingTime = 0.01f,
				ArrowLifeTime = 1f,
				PositionDelay = 2000f,
				HitEffect = new EffectConfig("I_kirmeleech001_mash", 1f),
				Range = 15f,
				KnockdownPower = 100f,
				Delay = 0f,
			...
			endingPosition = originPos.GetRelative(farPos, distance: 160f);
			await EffectHitArrow(skill, caster, startingPosition, endingPosition, new ArrowConfig
			{
				...
				ArrowLifeTime = 1f,
				PositionDelay = 2100f,
				HitEffect = new EffectConfig("F_smoke046", 1f),
				Range = 0f,
				KnockdownPower = 0f,
				Delay = 0f,
				HitEffectSpacing = 20f,
	...
	public class Mon_boss_Kimeleech_Skill_3 : ITargetSkillHandler
	{
		protected TimeSpan AniTime { get; } = TimeSpan.FromMilliseconds(300);
		public void Handle(Skill skill, ICombatEntity caster, ICombatEntity target)
		{
	...
	[SkillHandler(SkillId.Mon_boss_Kimeleech_Skill_4)]
	public class Mon_boss_Kimeleech_Skill_4 : ITargetSkillHandler
	{
		protected TimeSpan AniTime { get; } = TimeSpan.FromMilliseconds(300);
		public void Handle(Skill skill, ICombatEntity caster, ICombatEntity target)
		{
