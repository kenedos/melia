...
{
	[SkillHandler(SkillId.Mon_boss_unicorn_Skill_1)]
	public class Mon_boss_unicorn_Skill_1 : ITargetSkillHandler
	{
	...
	public class Mon_boss_unicorn_Skill_2 : ITargetSkillHandler
	{
	...
	[SkillHandler(SkillId.Mon_boss_unicorn_Skill_3)]
	public class Mon_boss_unicorn_Skill_3 : ITargetSkillHandler
	{
		protected TimeSpan AniTime { get; } = TimeSpan.FromMilliseconds(200);
		public void Handle(Skill skill, ICombatEntity caster, ICombatEntity target)
		{
	...
	[SkillHandler(SkillId.Mon_boss_unicorn_Skill_4)]
	public class Mon_boss_unicorn_Skill_4 : ITargetSkillHandler
	{
		protected TimeSpan AniTime { get; } = TimeSpan.FromMilliseconds(200);
		public void Handle(Skill skill, ICombatEntity caster, ICombatEntity target)
		{
