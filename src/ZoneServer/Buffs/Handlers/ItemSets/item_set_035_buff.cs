...
namespace Melia.Zone.Buffs.Handlers.ItemSets
{
	...
	public class item_set_035_buff : BuffHandler
	{
		/// <summary>
		...
		/// </summary>
		[CombatCalcModifier(CombatCalcPhase.AfterCalc, BuffId.item_set_035_buff)]
		...
		{
			if (!attacker.TryGetBuff(BuffId.item_set_035_buff, out var buff))
				return;
