...
namespace Melia.Zone.Skills.Handlers.Scouts.OutLaw
{
	...
	public class OutLaw_MangleOverride : IMeleeGroundSkillHandler
	{
		/// <summary>
		...
		public void Handle(Skill skill, ICombatEntity caster, Position originPos, Position farPos, ICombatEntity[] targets)
		{
			...
			var splashParam = skill.GetSplashParameters(caster, originPos, farPos, length: 35, width: 0, angle: 150);
		...
		/// Adds 50% final damage on enemies debuffed with sprinkle sands
		/// </summary>
