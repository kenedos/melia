...
{
	[Package("laima")]
	[SkillHandler(SkillId.Chronomancer_TimeForward_2)]
	public class Chronomancer_TimeForward_2Override : IMeleeGroundSkillHandler
	{
		public void Handle(Skill skill, ICombatEntity caster, Position originPos, Position farPos, params ICombatEntity[] targets)
		{
			...
			foreach (var currentTarget in targetList.LimitBySDR(caster, skill))
			{
				...
				var duration = TimeSpan.FromSeconds(8 + skill.Level * 2);
