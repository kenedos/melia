...
namespace Melia.Zone.Skills.Handlers.Swordsman.Highlander
{
	...
	public class Highlander_WagonWheelOverride : IGroundSkillHandler
	{
		...
		private async Task HandleSkill(Skill skill, ICombatEntity caster, Position originPos, Position farPos)
		{
			...
			await SkillAttack(caster, skill, splashArea, hitDelay, aniTime, hits, modifySkillHitResult: this.ModifySkillHitResult);
