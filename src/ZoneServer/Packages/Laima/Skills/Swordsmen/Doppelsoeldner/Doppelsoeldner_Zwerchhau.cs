...
namespace Melia.Zone.Skills.HandlersOverrides.Swordsmen.Doppelsoeldner
{
	...
	public class Doppelsoeldner_ZwerchhauOverride : IGroundSkillHandler
	{
		/// <summary>
		...
		public void Handle(Skill skill, ICombatEntity caster, Position originPos, Position farPos, ICombatEntity target)
		{
			...
			var splashParam = skill.GetSplashParameters(caster, originPos, farPos, length: 90, width: 0, angle: 90);
