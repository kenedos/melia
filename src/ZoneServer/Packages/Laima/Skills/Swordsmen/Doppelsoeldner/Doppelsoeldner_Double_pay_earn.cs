...
namespace Melia.Zone.Skills.HandlersOverrides.Swordsmen.Doppelsoeldner
{
	...
	public class Doppelsoeldner_Double_pay_earnOverride : ISelfSkillHandler
	{
		/// <summary>
		...
		public void Handle(Skill skill, ICombatEntity caster, Position originPos, Direction dir)
		{
			...
			target.StartBuff(BuffId.Double_pay_earn_Buff, skill.Level, 0, duration, caster, skill.Id);
