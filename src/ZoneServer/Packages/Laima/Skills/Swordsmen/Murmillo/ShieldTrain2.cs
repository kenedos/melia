...
{
	/// <summary>
	/// Handler for the Murmillo skill Shield Train 2.
	/// </summary>
	[Package("laima")]
	[SkillHandler(SkillId.Murmillo_ShieldTrain_2)]
	public class Murmillo_ShieldTrain_2Override : IMeleeGroundSkillHandler
	{
