...
namespace Melia.Zone.Skills.Handlers.Clerics.Sadhu
{
	...
	public class Sadhu_Skill_Base
	{
		...
		public void CreateAISpiritClone(Skill skill, Character casterCharacter, Position originPos, Position farPos, ICombatEntity target, BuffId buffId)
		{
			...
			Send.ZC_NORMAL.SetActorColor(spirit, 255, 200, 100, 150, 0.01f);
			Send.ZC_NORMAL.Skill_DynamicCastStart(spirit, SkillId.None);
		...
		private void SkillEffects(Character character, IActor target, Position position, Position farPos)
		{
			...
			Send.ZC_GROUND_EFFECT(character, farPos, "I_only_quest_smoke013_blue_smoke", 1, 0.7f, 0, 0, 0);
			Send.ZC_GROUND_EFFECT(character, position, "I_only_quest_smoke013_blue_smoke", 1.5f, 0.3f, 0, 0, 0);
			Send.ZC_GROUND_EFFECT(character, farPos, "I_only_quest_smoke058_blue", 3f, 0.5f, 0, 0, 0);
			Send.ZC_GROUND_EFFECT(character, position, "I_only_quest_smoke058_blue", 3, 0.5f, 0, 0, 0);			
		}
