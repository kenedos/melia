...
namespace Melia.Zone.Skills.Handlers.Clerics.Monk
{
	...
	public class Monk_IronSkinOverride : IGroundSkillHandler
	{
		...
		private async Task HandleSkill(ICombatEntity caster, Skill skill, Position originPos, Position farPos)
		{
			...
			caster.StartBuff(BuffId.Ironskin_Buff, skill.Level, 0, TimeSpan.FromMilliseconds(300000), caster, skill.Id);
		}
	}
}
