...
{
	/// <summary>
	/// Handler override for the Blizzard Storm: Second Storm debuff.
	/// Periodically deals Ice property damage and reduces movement speed.
	/// </summary>
	[Package("laima")]
	[BuffHandler(BuffId.StormDust_Abil_Debuff)]
	public class StormDust_Abil_DebuffOverride : BuffHandler
	{
		...
		public override void OnEnd(Buff buff)
		{
				...
				&& !buff.Vars.GetBool("Melia.Extended"))
			{
				...
				var newBuff = buff.Target.StartBuff(BuffId.StormDust_Abil_Debuff, buff.NumArg1, buff.NumArg2, duration, caster);
				if (newBuff != null)
