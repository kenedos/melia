namespace Melia.Shared.Game.Const
{
	...
	public static class SkillTag
	{
		...
		public const string DefenderConditionCurseNo100 = "DefenderConditionCurse#100";
		public const string DefenderConditionFearNo50 = "DefenderConditionFear#50";
		public const string DefenderConditionStunNo20 = "DefenderConditionStun#20";
		...
		public const string UseDaggerSkill = "UseDaggerSkill";
		public const string UseGlobalCoolTime = "UseGlobalCoolTime";
		public const string UseMaceSkill = "UseMaceSkill";
		public const string UseMaceSkillf = "UseMaceSkillf";
		public const string UseMoveSpeedColumn = "UseMoveSpeedColumn";
		public const string UseMusketSkill = "UseMusketSkill";
		public const string UseOneHandSwordSkill = "UseOneHandSwordSkill";
		public const string UsePistolSkill = "UsePistolSkill";
		public const string UseShieldSkill = "UseShieldSkill";
		public const string UseSpearSkill = "UseSpearSkill";
	}
}
