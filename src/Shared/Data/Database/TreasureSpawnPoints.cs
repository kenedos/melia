...
{
	[Serializable]
	public class TreasureSpawnPointData
	{
	...
	/// <summary>
	/// Treasure location database..
	/// </summary>
	public class TreasureSpawnPointDb : DatabaseJson<TreasureSpawnPointData>
	{
		/// <summary>
		...
		/// <returns></returns>
		public TreasureSpawnPointData[] Find(string mapClassName)
			=> this.Entries.Where(x => x.MapClassName == mapClassName).ToArray();

		/// <summary>
		/// Returns all treasure locations for the given map.
		/// </summary>
		/// <param name="mapClassName"></param>
		/// <returns></returns>
		...
		protected override void ReadEntry(JObject entry)
		{
			...
			var data = new TreasureSpawnPointData();
