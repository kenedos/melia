...
public class IdCatacomb382MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("id_catacomb_38_2.Id2", MonsterId.Rambear_Mage, min: 12, max: 15, tendency: TendencyType.Aggressive);
		AddSpawner("id_catacomb_38_2.Id3", MonsterId.Ticen_Bow, min: 12, max: 15, tendency: TendencyType.Aggressive);
		AddSpawner("id_catacomb_38_2.Id4", MonsterId.Hepatica_Purple, min: 19, max: 25, tendency: TendencyType.Aggressive);
		...
		AddSpawnPoint("id_catacomb_38_2.Id2", "id_catacomb_38_2", Rectangle(-73, -1626, 25));
		...
		AddSpawnPoint("id_catacomb_38_2.Id2", "id_catacomb_38_2", Rectangle(31, -1767, 25));
		AddSpawnPoint("id_catacomb_38_2.Id2", "id_catacomb_38_2", Rectangle(61, -1507, 25));
		AddSpawnPoint("id_catacomb_38_2.Id2", "id_catacomb_38_2", Rectangle(-209, -1601, 25));
