...
public class FCastle201MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("f_castle_20_1.Id1", MonsterId.Rootcrystal_01, min: 12, max: 15, respawn: Minutes(1), tendency: TendencyType.Peaceful);
		...
		AddSpawnPoint("f_castle_20_1.Id1", "f_castle_20_1", Rectangle(-881, -617, 100));
		...
		AddSpawnPoint("f_castle_20_1.Id2", "f_castle_20_1", Rectangle(1046, 336, 40));
		...
		AddSpawnPoint("f_castle_20_1.Id4", "f_castle_20_1", Rectangle(1061, 410, 40));
