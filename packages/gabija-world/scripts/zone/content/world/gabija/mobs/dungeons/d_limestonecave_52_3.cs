...
public class DLimestonecave523MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("d_limestonecave_52_3.Id1", MonsterId.Flamme_Priest_Green, min: 15, max: 20, tendency: TendencyType.Aggressive);
		...
		AddSpawner("d_limestonecave_52_3.Id4", MonsterId.Rubblem_Green, min: 23, max: 30, tendency: TendencyType.Aggressive);
		AddSpawner("d_limestonecave_52_3.Id5", MonsterId.Bavon_Green, min: 12, max: 15, tendency: TendencyType.Aggressive);
		AddSpawner("d_limestonecave_52_3.Id6", MonsterId.Flamme_Priest_Green, min: 23, max: 30, tendency: TendencyType.Aggressive);
		...
		AddSpawner("d_limestonecave_52_3.Id8", MonsterId.Rocktanon, min: 30, max: 40, tendency: TendencyType.Aggressive);
