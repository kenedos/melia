//--- Melia Script -----------------------------------------------------------
// Elgos Abbey Main Building Spawns
//--- Description -----------------------------------------------------------
...
public class DAbbey354MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("d_abbey_35_4.Id1", MonsterId.Hohen_Mane_Brown, min: 15, max: 20);
		AddSpawner("d_abbey_35_4.Id2", MonsterId.Hohen_Orben_Green, min: 12, max: 15);
		AddSpawner("d_abbey_35_4.Id3", MonsterId.Harugal_Brown, min: 6, max: 8);
		AddSpawner("d_abbey_35_4.Id4", MonsterId.Hohen_Mane_Brown, min: 19, max: 25);
		AddSpawner("d_abbey_35_4.Id5", MonsterId.Rootcrystal_01, min: 14, max: 18, respawn: Minutes(1));
		...
		AddSpawnPoint("d_abbey_35_4.Id3", "d_abbey_35_4", Rectangle(166, 27, 30));
		...
		AddSpawnPoint("d_abbey_35_4.Id3", "d_abbey_35_4", Rectangle(1447, -837, 30));
		AddSpawnPoint("d_abbey_35_4.Id3", "d_abbey_35_4", Rectangle(1734, -1113, 30));
		AddSpawnPoint("d_abbey_35_4.Id3", "d_abbey_35_4", Rectangle(1484, -1289, 30));
		AddSpawnPoint("d_abbey_35_4.Id3", "d_abbey_35_4", Rectangle(815, -485, 30));
		AddSpawnPoint("d_abbey_35_4.Id3", "d_abbey_35_4", Rectangle(-1415, 766, 30));
		AddSpawnPoint("d_abbey_35_4.Id3", "d_abbey_35_4", Rectangle(-1209, -455, 30));
		AddSpawnPoint("d_abbey_35_4.Id3", "d_abbey_35_4", Rectangle(-607, 127, 30));
