...
public class DAbbey643MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("d_abbey_64_3.Id1", MonsterId.Lapemiter, min: 19, max: 25, tendency: TendencyType.Aggressive);
		AddSpawner("d_abbey_64_3.Id2", MonsterId.Lapflammer, min: 19, max: 25, tendency: TendencyType.Aggressive);
		AddSpawner("d_abbey_64_3.Id3", MonsterId.Lapeman, min: 19, max: 25, tendency: TendencyType.Aggressive);
		...
		AddSpawner("d_abbey_64_3.Id6", MonsterId.Humming_Bud_Purple, min: 8, max: 10, tendency: TendencyType.Peaceful);
		AddSpawner("d_abbey_64_3.Id7", MonsterId.Sec_Deadbornscab, min: 20, max: 26, tendency: TendencyType.Aggressive);
		AddSpawner("d_abbey_64_3.Id8", MonsterId.Sec_Deadbornscab, min: 5, max: 6, tendency: TendencyType.Aggressive);
