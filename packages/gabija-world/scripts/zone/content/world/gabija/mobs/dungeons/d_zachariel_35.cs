...
public class DZachariel35MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("d_zachariel_35.Id8", MonsterId.Wolf_Statue_Bow, min: 8, max: 10, tendency: TendencyType.Peaceful);
		AddSpawner("d_zachariel_35.Id9", MonsterId.Karas_Mage, min: 4, max: 5, tendency: TendencyType.Peaceful);
