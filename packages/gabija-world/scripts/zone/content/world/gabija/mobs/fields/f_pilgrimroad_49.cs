...
public class FPilgrimroad49MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("f_pilgrimroad_49.Id5", MonsterId.Sec_Dandel_Orange, min: 23, max: 30);
		AddSpawner("f_pilgrimroad_49.Id6", MonsterId.Sec_Beetle, min: 12, max: 15);
		AddSpawner("f_pilgrimroad_49.Id7", MonsterId.Sec_Beetle, min: 15, max: 20);
		AddSpawner("f_pilgrimroad_49.Id8", MonsterId.Sec_Kepari_Mage, min: 19, max: 25);
		...
		AddSpawnPoint("f_pilgrimroad_49.Id2", "f_pilgrimroad_49", Rectangle(-241, -1582, 30));
