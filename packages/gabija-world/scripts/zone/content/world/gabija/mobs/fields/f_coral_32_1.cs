...
public class FCoral321MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("f_coral_32_1.Id2", MonsterId.Greentoshell, min: 23, max: 30);
		AddSpawner("f_coral_32_1.Id3", MonsterId.Lapasape_Mage_Blue, min: 12, max: 15);
		AddSpawner("f_coral_32_1.Id4", MonsterId.Rootcrystal_01, min: 9, max: 12, respawn: Seconds(30));
		...
		AddSpawnPoint("f_coral_32_1.Id2", "f_coral_32_1", Rectangle(469, -928, 25));
		...
		AddSpawnPoint("f_coral_32_1.Id2", "f_coral_32_1", Rectangle(846, -1158, 25));
		AddSpawnPoint("f_coral_32_1.Id2", "f_coral_32_1", Rectangle(645, -1139, 25));
		AddSpawnPoint("f_coral_32_1.Id2", "f_coral_32_1", Rectangle(758, -990, 25));
		...
		AddSpawnPoint("f_coral_32_1.Id2", "f_coral_32_1", Rectangle(726, -1279, 25));
