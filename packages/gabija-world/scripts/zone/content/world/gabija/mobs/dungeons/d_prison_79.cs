...
public class DPrison79MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("d_prison_79.Id1", MonsterId.Nuo_Purple, min: 45, max: 60, tendency: TendencyType.Aggressive);
		...
		AddSpawner("d_prison_79.Id4", MonsterId.Rootcrystal_05, min: 15, max: 20, respawn: Minutes(1), tendency: TendencyType.Peaceful);
