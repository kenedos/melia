...
public class DLimestonecave525MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("d_limestonecave_52_5.Id1", MonsterId.Wood_Goblin_Green, min: 30, max: 40, tendency: TendencyType.Aggressive);
		AddSpawner("d_limestonecave_52_5.Id2", MonsterId.Rockoff_Orange, min: 27, max: 35, tendency: TendencyType.Aggressive);
		AddSpawner("d_limestonecave_52_5.Id3", MonsterId.Flamil_Green, min: 30, max: 40, tendency: TendencyType.Aggressive);
		AddSpawner("d_limestonecave_52_5.Id4", MonsterId.Rondo, amount: 1, tendency: TendencyType.Aggressive);
