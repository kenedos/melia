...
public class DAbbey642MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("d_abbey_64_2.Id1", MonsterId.Lapfighter, min: 34, max: 45, tendency: TendencyType.Aggressive);
		...
		AddSpawner("d_abbey_64_2.Id10", MonsterId.Sec_Whip_Vine_Ra, min: 27, max: 35, tendency: TendencyType.Aggressive);
		AddSpawner("d_abbey_64_2.Id11", MonsterId.Sec_Whip_Vine_Ra, min: 27, max: 35, tendency: TendencyType.Aggressive);
		AddSpawner("d_abbey_64_2.Id12", MonsterId.Sec_Whip_Vine_Ra, min: 27, max: 35, tendency: TendencyType.Aggressive);
		AddSpawner("d_abbey_64_2.Id13", MonsterId.Sec_Minos, min: 18, max: 23, tendency: TendencyType.Aggressive);
		...
		// 'Firetower_Defense_Q' GenType 337 Spawn Points
		AddSpawnPoint("d_abbey_64_2.Id5", "d_abbey_64_2", Rectangle(547, -1222, 20));

		// 'Firetower_Defense_Q' GenType 338 Spawn Points
		AddSpawnPoint("d_abbey_64_2.Id6", "d_abbey_64_2", Rectangle(545, -1346, 20));
