...
public class DThorn23MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("d_thorn_23.Id2", MonsterId.Raider, min: 19, max: 25, respawn: Seconds(15));
		AddSpawner("d_thorn_23.Id3", MonsterId.Infroholder, min: 12, max: 15, respawn: Seconds(15));
		AddSpawner("d_thorn_23.Id4", MonsterId.Raider, min: 4, max: 5, respawn: Seconds(20));
		AddSpawner("d_thorn_23.Id5", MonsterId.Infroholder, min: 5, max: 6, respawn: Seconds(20));
		AddSpawner("d_thorn_23.Id6", MonsterId.Duckey, min: 8, max: 10, respawn: Seconds(15));
		AddSpawner("d_thorn_23.Id7", MonsterId.InfroHoglan, min: 8, max: 10, respawn: Seconds(15));
		AddSpawner("d_thorn_23.Id8", MonsterId.Cronewt, min: 8, max: 10, respawn: Seconds(15));
		AddSpawner("d_thorn_23.Id9", MonsterId.InfroHoglan, min: 4, max: 5, respawn: Seconds(20));
		AddSpawner("d_thorn_23.Id10", MonsterId.Cronewt, min: 6, max: 8, respawn: Seconds(20));
		AddSpawner("d_thorn_23.Id11", MonsterId.Duckey, min: 4, max: 5, respawn: Seconds(25));
		AddSpawner("d_thorn_23.Id12", MonsterId.Infroholder, min: 4, max: 5, respawn: Minutes(1));
		AddSpawner("d_thorn_23.Id13", MonsterId.Duckey, min: 8, max: 10, respawn: Seconds(5));
		AddSpawner("d_thorn_23.Id14", MonsterId.Raider, min: 6, max: 7, respawn: Seconds(5));
		...
		AddSpawnPoint("d_thorn_23.Id4", "d_thorn_23", Rectangle(-1858, -2242, 30));
		...
		AddSpawnPoint("d_thorn_23.Id5", "d_thorn_23", Rectangle(-1954, -2323, 30));
		...
		AddSpawnPoint("d_thorn_23.Id12", "d_thorn_23", Rectangle(392, 359, 30));
		AddSpawnPoint("d_thorn_23.Id12", "d_thorn_23", Rectangle(504, 485, 30));
		AddSpawnPoint("d_thorn_23.Id12", "d_thorn_23", Rectangle(296, 632, 30));
		AddSpawnPoint("d_thorn_23.Id12", "d_thorn_23", Rectangle(763, 757, 30));
		AddSpawnPoint("d_thorn_23.Id12", "d_thorn_23", Rectangle(625, 607, 30));
		AddSpawnPoint("d_thorn_23.Id12", "d_thorn_23", Rectangle(693, 396, 30));
		AddSpawnPoint("d_thorn_23.Id12", "d_thorn_23", Rectangle(871, 377, 30));
