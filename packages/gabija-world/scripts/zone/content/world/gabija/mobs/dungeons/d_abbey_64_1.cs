...
public class DAbbey641MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("d_abbey_64_1.Id5", MonsterId.Shtayim_Mage, min: 23, max: 30, tendency: TendencyType.Aggressive);
		AddSpawner("d_abbey_64_1.Id6", MonsterId.Sec_Spector_Gh, min: 19, max: 25, tendency: TendencyType.Aggressive);
		AddSpawner("d_abbey_64_1.Id7", MonsterId.Sec_Spector_Gh, min: 6, max: 7, tendency: TendencyType.Aggressive);
