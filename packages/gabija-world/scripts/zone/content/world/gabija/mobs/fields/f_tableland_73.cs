...
public class FTableland73MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("f_tableland_73.Id1", MonsterId.Wendigo_Archer_Gray, min: 9, max: 12);
		AddSpawner("f_tableland_73.Id2", MonsterId.Tiny_Bow_Blue, min: 27, max: 35);
		AddSpawner("f_tableland_73.Id3", MonsterId.Hohen_Gulak_Blue, min: 8, max: 10);
		AddSpawner("f_tableland_73.Id4", MonsterId.Rootcrystal_03, min: 19, max: 25, respawn: Minutes(1));
		AddSpawner("f_tableland_73.Id5", MonsterId.Tiny_Bow_Blue, min: 3, max: 4);
		...
		AddSpawnPoint("f_tableland_73.Id1", "f_tableland_73", Rectangle(527, 317, 30));
		...
		AddSpawnPoint("f_tableland_73.Id3", "f_tableland_73", Rectangle(-931, -242, 30));
		AddSpawnPoint("f_tableland_73.Id3", "f_tableland_73", Rectangle(-1246, -300, 30));
		AddSpawnPoint("f_tableland_73.Id3", "f_tableland_73", Rectangle(-180, 299, 30));
		AddSpawnPoint("f_tableland_73.Id3", "f_tableland_73", Rectangle(308, 848, 30));
		AddSpawnPoint("f_tableland_73.Id3", "f_tableland_73", Rectangle(106, 761, 30));
		AddSpawnPoint("f_tableland_73.Id3", "f_tableland_73", Rectangle(325, -1468, 30));
		AddSpawnPoint("f_tableland_73.Id3", "f_tableland_73", Rectangle(437, -1223, 30));
		AddSpawnPoint("f_tableland_73.Id3", "f_tableland_73", Rectangle(-93, 93, 30));
		AddSpawnPoint("f_tableland_73.Id3", "f_tableland_73", Rectangle(-50, -57, 30));
		AddSpawnPoint("f_tableland_73.Id3", "f_tableland_73", Rectangle(-159, -293, 30));
		AddSpawnPoint("f_tableland_73.Id3", "f_tableland_73", Rectangle(1, -574, 30));
		AddSpawnPoint("f_tableland_73.Id3", "f_tableland_73", Rectangle(298, -250, 30));
		AddSpawnPoint("f_tableland_73.Id3", "f_tableland_73", Rectangle(361, -145, 30));
		AddSpawnPoint("f_tableland_73.Id3", "f_tableland_73", Rectangle(511, 358, 30));
		AddSpawnPoint("f_tableland_73.Id3", "f_tableland_73", Rectangle(1309, 94, 30));
		AddSpawnPoint("f_tableland_73.Id3", "f_tableland_73", Rectangle(777, 533, 30));
		AddSpawnPoint("f_tableland_73.Id3", "f_tableland_73", Rectangle(887, -124, 30));
		AddSpawnPoint("f_tableland_73.Id3", "f_tableland_73", Rectangle(773, 979, 30));
		...
		AddSpawnPoint("f_tableland_73.Id5", "f_tableland_73", Rectangle(-706, -1115, 40));
		AddSpawnPoint("f_tableland_73.Id5", "f_tableland_73", Rectangle(-911, -895, 40));
		AddSpawnPoint("f_tableland_73.Id5", "f_tableland_73", Rectangle(-850, -1329, 40));
		AddSpawnPoint("f_tableland_73.Id5", "f_tableland_73", Rectangle(-989, -1349, 40));
	}
}
