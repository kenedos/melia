...
public class FSiauliai2MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawnPoint("f_siauliai_2.Id8", "f_siauliai_2", Rectangle(-1955, -1269, 50));
		...
		AddSpawnPoint("f_siauliai_2.Id8", "f_siauliai_2", Rectangle(-810, -698, 50));
		AddSpawnPoint("f_siauliai_2.Id8", "f_siauliai_2", Rectangle(-910, -546, 50));
