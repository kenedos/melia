...
public class FPilgrimroad411MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("f_pilgrimroad_41_1.Id1", MonsterId.Rootcrystal_05, min: 12, max: 16, respawn: Seconds(5));
		...
		AddSpawner("f_pilgrimroad_41_1.Id7", MonsterId.Tiny_Brown, amount: 3);
		...
		AddSpawnPoint("f_pilgrimroad_41_1.Id2", "f_pilgrimroad_41_1", Rectangle(1279, 211, 25));
		...
		AddSpawnPoint("f_pilgrimroad_41_1.Id2", "f_pilgrimroad_41_1", Rectangle(535, 651, 25));
		...
		AddSpawnPoint("f_pilgrimroad_41_1.Id3", "f_pilgrimroad_41_1", Rectangle(1296, 333, 25));
