...
public class DPrison622MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("d_prison_62_2.Id3", MonsterId.Sec_Escape_Wendigo, min: 19, max: 25, tendency: TendencyType.Aggressive);
		...
		AddSpawner("d_prison_62_2.Id6", MonsterId.Sec_Escape_Wendigo, min: 30, max: 40, tendency: TendencyType.Aggressive);
		AddSpawner("d_prison_62_2.Id7", MonsterId.Sec_Goblin_Archer_Blue, min: 23, max: 30, tendency: TendencyType.Aggressive);
		AddSpawner("d_prison_62_2.Id8", MonsterId.Sec_Bat, min: 53, max: 70, tendency: TendencyType.Aggressive);
