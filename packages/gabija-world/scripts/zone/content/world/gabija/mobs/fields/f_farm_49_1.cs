...
public class FFarm491MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("f_farm_49_1.Id1", MonsterId.Lizardman_Orange, min: 12, max: 15, respawn: Seconds(20), tendency: TendencyType.Aggressive);
		AddSpawner("f_farm_49_1.Id2", MonsterId.Lizardman_Orange, min: 15, max: 20, respawn: Seconds(20), tendency: TendencyType.Aggressive);
		AddSpawner("f_farm_49_1.Id3", MonsterId.Tama_Orange, min: 19, max: 25, respawn: Seconds(20), tendency: TendencyType.Aggressive);
		AddSpawner("f_farm_49_1.Id4", MonsterId.Tama_Orange, min: 23, max: 30, respawn: Seconds(20), tendency: TendencyType.Aggressive);
