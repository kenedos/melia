...
public class FSiauliai501MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("f_siauliai_50_1.Id1", MonsterId.Chupaluka_Pink, min: 9, max: 12, tendency: TendencyType.Aggressive);
		AddSpawner("f_siauliai_50_1.Id2", MonsterId.Sakmoli_Orange, min: 12, max: 15, tendency: TendencyType.Peaceful);
		...
		AddSpawner("f_siauliai_50_1.Id6", MonsterId.Ridimed_Purple, min: 12, max: 15, tendency: TendencyType.Peaceful);
