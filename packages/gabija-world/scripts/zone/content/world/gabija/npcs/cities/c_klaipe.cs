...
public class CKlaipeNpcScript : GeneralScript
{
	protected override void Load()
	{
		...
		mirina.ShopType = ShopType.Potion;
		...
		equipmentMerchant.AssociatedShopName = "KlaipedaWeapons";
		equipmentMerchant.ShopType = ShopType.Weapon;
		...
		ronesa.ShopType = ShopType.Accessory;
