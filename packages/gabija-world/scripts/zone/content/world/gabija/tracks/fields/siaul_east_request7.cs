...
public class SiaulEastRequest7Track : TrackScript
{
	...
	public override IActor[] OnStart(Character character, Track track)
	{
		...
		actors.Add(AddTrackActor(character, 57193, 549.11865, 162.4583, 709.63055, 44, new TrackActorSpec { Ai = "TrackWaitMonster" }));
		actors.Add(AddTrackActor(character, 57192, 841.61285, 130.0327, 207.54842, 87, new TrackActorSpec { Ai = "TrackWaitMonster" }));
		actors.Add(AddTrackActor(character, 57192, 787.44415, 130.02271, 260.29916, 73, new TrackActorSpec { Ai = "TrackWaitMonster" }));
		actors.Add(AddTrackActor(character, 57193, 814.35852, 130.0327, 202.93602, 61, new TrackActorSpec { Ai = "TrackWaitMonster" }));
		actors.Add(AddTrackActor(character, 57192, 771.22968, 130.0327, 212.34544, 75, new TrackActorSpec { Ai = "TrackWaitMonster" }));
		actors.Add(AddTrackActor(character, 40120, 233, 157, 724, 0, new TrackActorSpec { Ai = "TrackWaitMonster" }));
		actors.Add(AddTrackActor(character, 57192, 579.28333, 162.4583, 679.73444, 59, new TrackActorSpec { Ai = "TrackWaitMonster" }));
		actors.Add(AddTrackActor(character, 57192, 690.33923, 130.02271, 306.6019, 56, new TrackActorSpec { Ai = "TrackWaitMonster" }));
