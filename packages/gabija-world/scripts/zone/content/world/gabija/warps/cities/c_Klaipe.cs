...
public class c_KlaipeWarpsScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddWarp(10004, "WS_KLAPEDA_SIAULST1", -10, From("c_Klaipe", -201, -1182), To("f_siauliai_west", 1630, -733));

		// Klaipeda to East Siauliai Woods
		AddWarp(21, "WS_KLAPEDA_SIAULST2", 135, From("c_Klaipe", 799, 331), To("f_siauliai_2", -2414, -1150));
