...
public class f_rokas_31WarpsScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddWarp(1, "ROKAS31_ROKAS30", 139, From("f_rokas_31", 940, -998), To("f_rokas_30", -1669, -134));
		...
		AddWarp(3, "ROKAS31_REMAINS37", -49, From("f_rokas_31", 470, -1399), To("f_remains_37", -1322, -2902));
	}
}
