...
public class f_siauliai_46_1WarpsScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddWarp(2, "SIAULIAI46_1_SIAULIAI46_2", 270, From("f_siauliai_46_1", -1872, -427), To("f_siauliai_46_2", 1279, 4301));

		// Spring Light Woods to Glade Hillroad
		AddWarp(24, "SIAULIAI46_1_THORN39_2", 200, From("f_siauliai_46_1", 585.5263, 1320.263), To("d_thorn_39_2", -2028, -1509));
	}
}
