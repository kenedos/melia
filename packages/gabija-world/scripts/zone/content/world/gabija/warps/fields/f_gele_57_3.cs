...
public class f_gele_57_3WarpsScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddWarp(3, "GELE573_TO_HUE581", -54, From("f_gele_57_3", -1357.6, -739.9471), To("f_huevillage_58_1", 1467, -1161));

		// Nefritas Cliff to Thaumas Trail
		AddWarp(38, "GELE57_3_PILGRIM41_1", 90, From("f_gele_57_3", 1494.618, -711.321), To("f_pilgrimroad_41_1", -1033, -1020));
	}
}
