...
public class f_maple_23_2WarpsScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddWarp(2, "MAPLE23_2_TO_MAPLE25_3", 21, From("f_maple_23_2", 1564.166, -1382.529), To("f_maple_25_3", -624, 1314));
		...
		// Pystis Forest to Maple Forest 24_3
		AddWarp(4, "MAPLE23_2_TO_MAPLE24_3", 89, From("f_maple_23_2", -901.704, -1639.13), To("f_maple_24_3", -634, 1318));
	}
}
