...
public class f_rokas_26WarpsScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddWarp(1, "ROKAS26_ROKAS25", 0, From("f_rokas_26", 483, -2502), To("f_rokas_25", 2714, -1106));

		// Overlong Bridge Valley to Akmens Ridge
		AddWarp(2, "ROKAS26_ROKAS27", 268, From("f_rokas_26", -1090, -1740), To("f_rokas_27", -187, -3475));
	}
}
