...
public class f_remains_39WarpsScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddWarp(20, "REMAINS39_REMAINS40", 190, From("f_remains_39", 873, 1635), To("f_remains_40", 48, -2541));

		// Escanciu Village to King's Plateau
		AddWarp(44, "REMAINS39_ROKAS30", 90, From("f_remains_39", 1261, -325), To("f_rokas_30", -174, 684));
	}
}
