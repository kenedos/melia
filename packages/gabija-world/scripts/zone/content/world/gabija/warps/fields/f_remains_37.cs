...
public class f_remains_37WarpsScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddWarp(30, "REMAINS37_ROKAS31", 45, From("f_remains_37", -1292, -2944), To("f_rokas_31", 553, -1337));
		...
		AddWarp(46, "REMAINS37_PCATHEDRAL1", 360, From("f_remains_37", 485, -2623), To("p_cathedral_1", 55, 191));
		...
		AddWarp(65, "REMAINS37_TO_FIRETOWER691", -1, From("f_remains_37", 1165.491, -2714.446), To("d_firetower_69_1", -2479, -246));
	}
}
