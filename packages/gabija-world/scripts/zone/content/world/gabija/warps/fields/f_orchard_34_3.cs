...
public class f_orchard_34_3WarpsScript : GeneralScript
{
	protected override void Load()
	{
		...
		// Barha Forest to Penitence Route of Great Cathedral
		...
		AddWarp(34, "ORCHARD34_3_CORAL32_1", 55, From("f_orchard_34_3", 1286.19, -1034.503), To("f_coral_32_1", -172, -1615));

		// Barha Forest to Nahash Forest
		AddWarp(35, "ORCHARD34_3_SIAULIAI_35_1", 35, From("f_orchard_34_3", -226.9505, -1173.142), To("f_siauliai_35_1", 180, 1857));
	}
}
