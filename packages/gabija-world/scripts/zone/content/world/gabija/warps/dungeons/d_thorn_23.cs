...
public class d_thorn_23WarpsScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddWarp(15, "THORN23_THORN22", 252, From("d_thorn_23", -2159, -2969), To("d_thorn_22", 952, 1015));

		// Sunset Flag Forest to Gateway of the Great King
		AddWarp(16, "THORN23_ROKAS24", 163, From("d_thorn_23", 2420, 2163), To("f_rokas_24", 886, -2885));
		...
		AddWarp(604, "THORN23_THORN21", 180, From("d_thorn_23", -588, 899), To("d_thorn_21", 988, -1485));
	}
}
