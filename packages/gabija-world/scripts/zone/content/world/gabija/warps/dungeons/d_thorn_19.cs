...
public class d_thorn_19WarpsScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddWarp(2, "THORN19_HUEVILLAGE58_4", 259, From("d_thorn_19", -286, -3924), To("f_huevillage_58_4", 991, 1194));

		// Gate Route to Sirdgela Forest
		AddWarp(3, "THORN19_THORN20", -79, From("d_thorn_19", 1980.25, -1018.94), To("d_thorn_20", -1441, -1879));
	}
}
