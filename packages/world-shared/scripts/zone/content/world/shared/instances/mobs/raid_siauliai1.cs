...
public class RaidSiauliai1MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		// Boss Spawners ---------------------------------
		AddBossSpawner(MonsterId.M_Boss_Poata, "raid_siauliai1", 1, Hours(2), Hours(4));
		AddBossSpawner(MonsterId.M_Boss_Glass_Mole, "raid_siauliai1", 1, Hours(2), Hours(4));
		AddBossSpawner(MonsterId.M_Boss_Woodspirit, "raid_siauliai1", 1, Hours(2), Hours(4));
	}
}
