...
public class MissionChaple01MobScript : GeneralScript
{
	...
	{
		AddSpawner("mission_chaple_01.Id1", MonsterId.Rootcrystal_01, amount: 1, respawn: Seconds(15));
		...
		// Boss Spawners ---------------------------------
		AddBossSpawner(MonsterId.M_Boss_Ironbaum, "mission_chaple_01", 1, Hours(2), Hours(4));
		AddBossSpawner(MonsterId.M_Boss_Gorgon, "mission_chaple_01", 1, Hours(2), Hours(4));
	}
}
