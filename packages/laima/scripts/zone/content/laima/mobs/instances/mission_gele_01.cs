...
public class MissionGele01MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		// Boss Spawners ---------------------------------
		AddBossSpawner(MonsterId.M_Boss_Clymen, "mission_gele_01", 1, Hours(2), Hours(4));
		AddBossSpawner(MonsterId.M_Boss_BiteRegina, "mission_gele_01", 1, Hours(2), Hours(4));
		AddBossSpawner(MonsterId.M_Boss_Chapparition, "mission_gele_01", 1, Hours(2), Hours(4));
		AddBossSpawner(MonsterId.M_Boss_Woodspirit_Green, "mission_gele_01", 1, Hours(2), Hours(4));
	}
}
