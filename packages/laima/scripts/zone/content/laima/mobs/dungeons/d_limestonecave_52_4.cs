...
public class DLimestonecave524MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("d_limestonecave_52_4.Id1", MonsterId.Zolem_Green, min: 15, max: 20, tendency: TendencyType.Aggressive);
		AddSpawner("d_limestonecave_52_4.Id2", MonsterId.Warleader_Tala, min: 19, max: 25, tendency: TendencyType.Aggressive);
		AddSpawner("d_limestonecave_52_4.Id3", MonsterId.Rocktanon, min: 19, max: 25, tendency: TendencyType.Aggressive);
		AddSpawner("d_limestonecave_52_4.Id4", MonsterId.Zolem_Green, min: 19, max: 25, tendency: TendencyType.Aggressive);
		AddSpawner("d_limestonecave_52_4.Id5", MonsterId.Rootcrystal_04, min: 19, max: 25, respawn: Seconds(30), tendency: TendencyType.Peaceful);
		...
		// Boss Spawners ---------------------------------
		AddBossSpawner(MonsterId.Boss_Rambandgad, "d_limestonecave_52_4", 1, Hours(2), Hours(4));
	}
}
