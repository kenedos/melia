...
public class DPrison78MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("d_prison_78.Id1", MonsterId.TerraNymph_Brown, min: 54, max: 75, tendency: TendencyType.Aggressive);
		AddSpawner("d_prison_78.Id2", MonsterId.NightMaiden_Mage_Red, min: 12, max: 18, tendency: TendencyType.Aggressive);
		AddSpawner("d_prison_78.Id3", MonsterId.Elet_Blue, min: 12, max: 16, tendency: TendencyType.Aggressive);
		AddSpawner("d_prison_78.Id4", MonsterId.Rootcrystal_05, min: 12, max: 15, respawn: Minutes(1), tendency: TendencyType.Peaceful);
		AddSpawner("d_prison_78.Id5", MonsterId.TerraNymph_Brown, min: 34, max: 45, tendency: TendencyType.Aggressive);
