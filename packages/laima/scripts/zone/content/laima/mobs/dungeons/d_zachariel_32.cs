...
public class DZachariel32MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		// 'Varv' Spawn Points
		AddSpawnPoint("d_zachariel_32.Id10", "d_zachariel_32", Rectangle(1105, 99, 200));
		AddSpawnPoint("d_zachariel_32.Id10", "d_zachariel_32", Rectangle(1098, -948, 200));
		AddSpawnPoint("d_zachariel_32.Id10", "d_zachariel_32", Rectangle(1138, 1401, 200));
