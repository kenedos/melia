...
public class DThorn19MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("d_thorn_19.Id2", MonsterId.Thornball, min: 17, max: 22);
		...
		AddSpawner("d_thorn_19.Id7", MonsterId.Truffle, min: 42, max: 55);
		...
		AddSpawner("d_thorn_19.Id13", MonsterId.Groll, min: 30, max: 42);
		...
		// 'Groll' Spawn Points
		AddSpawnPoint("d_thorn_19.Id13", "d_thorn_19", Rectangle(-107, -3268, 300));
		AddSpawnPoint("d_thorn_19.Id13", "d_thorn_19", Rectangle(-180, -2158, 300));
		AddSpawnPoint("d_thorn_19.Id13", "d_thorn_19", Rectangle(118, -1148, 300));
		AddSpawnPoint("d_thorn_19.Id13", "d_thorn_19", Rectangle(153, 242, 200));
		AddSpawnPoint("d_thorn_19.Id13", "d_thorn_19", Rectangle(-582, 212, 200));
		AddSpawnPoint("d_thorn_19.Id13", "d_thorn_19", Rectangle(672, 2494, 300));

		// Boss Spawners ---------------------------------
		AddBossSpawner(MonsterId.Boss_Archon, "d_thorn_20", 1, Hours(2), Hours(4));
		AddBossSpawner(MonsterId.Boss_Spector_Gh, "d_thorn_20", 1, Hours(2), Hours(4));
	}
}
