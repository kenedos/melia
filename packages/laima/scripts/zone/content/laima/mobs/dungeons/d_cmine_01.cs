...
public class DCmine01MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("d_cmine_01.Id1", MonsterId.Rootcrystal_01, min: 12, max: 15, respawn: Seconds(80), tendency: TendencyType.Peaceful);
		AddSpawner("d_cmine_01.Id2", MonsterId.Goblin_Miners, min: 21, max: 27, respawn: Minutes(3), tendency: TendencyType.Aggressive);
		AddSpawner("d_cmine_01.Id3", MonsterId.Goblin_Miners, min: 6, max: 7, respawn: Minutes(3), tendency: TendencyType.Aggressive);
		AddSpawner("d_cmine_01.Id4", MonsterId.Bat, min: 16, max: 24, respawn: Minutes(3), tendency: TendencyType.Aggressive);
		AddSpawner("d_cmine_01.Id5", MonsterId.StonOrca, min: 15, max: 20, respawn: Minutes(3), tendency: TendencyType.Aggressive);
		AddSpawner("d_cmine_01.Id6", MonsterId.Whip_Vine_Ra, min: 23, max: 30, respawn: Minutes(3), tendency: TendencyType.Aggressive);
		AddSpawner("d_cmine_01.Id7", MonsterId.Whip_Vine_Ra, min: 23, max: 30, respawn: Minutes(3), tendency: TendencyType.Aggressive);
		AddSpawner("d_cmine_01.Id8", MonsterId.Whip_Vine_Ra, min: 23, max: 30, respawn: Minutes(3), tendency: TendencyType.Aggressive);
		AddSpawner("d_cmine_01.Id9", MonsterId.StonOrca, amount: 15, respawn: Minutes(3), tendency: TendencyType.Aggressive);
		AddSpawner("d_cmine_01.Id10", MonsterId.Goblin_Miners, min: 20, max: 40, respawn: Minutes(3), tendency: TendencyType.Aggressive);
		AddSpawner("d_cmine_01.Id11", MonsterId.Bat, min: 140, max: 170, respawn: Seconds(30), tendency: TendencyType.Aggressive);
		AddSpawner("d_cmine_01.Id12", MonsterId.Goblin_Miners, min: 20, max: 90, respawn: Seconds(30), tendency: TendencyType.Aggressive);
		...
		// 'Bat' GenType 535 Spawn Points
		AddSpawnPoint("d_cmine_01.Id12", "d_cmine_01", Rectangle(-723, -892, 9999));

		// Boss Spawners ---------------------------------
		AddBossSpawner(MonsterId.Boss_Salamander, "d_cmine_01", 1, Hours(2), Hours(4));
		AddBossSpawner(MonsterId.Boss_Strongholder, "d_cmine_01", 1, Hours(2), Hours(4));
		AddBossSpawner(MonsterId.Boss_Spector_F, "d_cmine_01", 1, Hours(2), Hours(4));
		AddBossSpawner(MonsterId.Boss_Spector_M, "d_cmine_01", 1, Hours(2), Hours(4));
		AddBossSpawner(MonsterId.Boss_Bearkaras, "d_cmine_01", 1, Hours(2), Hours(4));
	}
}
