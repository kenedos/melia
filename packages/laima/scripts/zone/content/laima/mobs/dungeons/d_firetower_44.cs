...
public class DFiretower44MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("d_firetower_44.Id2", MonsterId.New_Desmodus_Black, min: 28, max: 40, tendency: TendencyType.Aggressive);
		...
		AddSpawner("d_firetower_44.Id5", MonsterId.Minivern, min: 36, max: 46, tendency: TendencyType.Aggressive);
		AddSpawner("d_firetower_44.Id6", MonsterId.Minivern_Elite, amount: 13, tendency: TendencyType.Aggressive);
		AddSpawner("d_firetower_44.Id7", MonsterId.Pyran, min: 20, max: 30, tendency: TendencyType.Aggressive);
		AddSpawner("d_firetower_44.Id8", MonsterId.Minivern, min: 36, max: 46, tendency: TendencyType.Aggressive);
		...
		// 'Pyran' Spawn Points
		AddSpawnPoint("d_firetower_44.Id7", "d_firetower_44", Rectangle(673, -733, 9999));

		// 'Minivern' Spawn Points
		AddSpawnPoint("d_firetower_44.Id8", "d_firetower_44", Rectangle(579, -1319, 9999));

		// Boss Spawners ---------------------------------
		AddBossSpawner(MonsterId.Boss_Yonazolem, "d_firetower_44", 1, Hours(2), Hours(4));
		AddBossSpawner(MonsterId.Boss_Grinender, "d_firetower_44", 1, Hours(2), Hours(4));
	}
}
