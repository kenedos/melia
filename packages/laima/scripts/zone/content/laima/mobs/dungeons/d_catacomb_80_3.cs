...
public class DCatacomb803MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("d_catacomb_80_3.Id1", MonsterId.Cronewt_Blue, min: 11, max: 14, tendency: TendencyType.Aggressive);
		AddSpawner("d_catacomb_80_3.Id2", MonsterId.Infroholder_Red, min: 11, max: 14, tendency: TendencyType.Aggressive);
		AddSpawner("d_catacomb_80_3.Id3", MonsterId.Cronewt_Bow_Blue, min: 11, max: 14, tendency: TendencyType.Aggressive);
		AddSpawner("d_catacomb_80_3.Id4", MonsterId.Cronewt_Mage_Blue, min: 11, max: 14, tendency: TendencyType.Aggressive);
		AddSpawner("d_catacomb_80_3.Id5", MonsterId.Hohen_Gulak, min: 5, max: 6, tendency: TendencyType.Aggressive);
		AddSpawner("d_catacomb_80_3.Id6", MonsterId.Socket_Green, min: 11, max: 14, tendency: TendencyType.Aggressive);
		AddSpawner("d_catacomb_80_3.Id7", MonsterId.Socket_Mage_Green, min: 11, max: 14, tendency: TendencyType.Aggressive);
		AddSpawner("d_catacomb_80_3.Id8", MonsterId.Siaulav_Bow_Blue, min: 14, max: 18, tendency: TendencyType.Aggressive);
		AddSpawner("d_catacomb_80_3.Id9", MonsterId.Siaulav_Blue, min: 14, max: 18, tendency: TendencyType.Aggressive);
		AddSpawner("d_catacomb_80_3.Id10", MonsterId.Siaulav_Mage_Blue, min: 14, max: 18, tendency: TendencyType.Aggressive);
		AddSpawner("d_catacomb_80_3.Id11", MonsterId.Nuka, min: 18, max: 24, tendency: TendencyType.Aggressive);
		AddSpawner("d_catacomb_80_3.Id12", MonsterId.Elma, min: 18, max: 24, tendency: TendencyType.Aggressive);
		AddSpawner("d_catacomb_80_3.Id13", MonsterId.Rootcrystal_05, min: 23, max: 30, respawn: Seconds(20), tendency: TendencyType.Peaceful);
