...
public class DLimestonecave525MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("d_limestonecave_52_5.Id1", MonsterId.Warleader_Tala, min: 23, max: 30, tendency: TendencyType.Aggressive);
		AddSpawner("d_limestonecave_52_5.Id2", MonsterId.Rocktanon, min: 35, max: 55, tendency: TendencyType.Aggressive);
		AddSpawner("d_limestonecave_52_5.Id3", MonsterId.Warleader_Tala, min: 23, max: 30, tendency: TendencyType.Aggressive);
		AddSpawner("d_limestonecave_52_5.Id4", MonsterId.Rocktanon, min: 40, max: 60, tendency: TendencyType.Aggressive);
		AddSpawner("d_limestonecave_52_5.Id5", MonsterId.Schlesien_Heavycavarly, min: 23, max: 30, tendency: TendencyType.Aggressive);
		...
		// Boss Spawners ---------------------------------
		// No skill handlers
		// AddBossSpawner(MonsterId.Boss_Stalakan, "d_limestonecave_52_5", 1, Hours(2), Hours(4));
	}
}
