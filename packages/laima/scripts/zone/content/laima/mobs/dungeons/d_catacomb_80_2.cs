...
public class DCatacomb802MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("d_catacomb_80_2.Id1", MonsterId.Yognome_Yellow, min: 9, max: 12, tendency: TendencyType.Aggressive);
		AddSpawner("d_catacomb_80_2.Id2", MonsterId.Moya, min: 14, max: 18, tendency: TendencyType.Aggressive);
		AddSpawner("d_catacomb_80_2.Id3", MonsterId.Mushroom_Boy_Green, min: 14, max: 18, tendency: TendencyType.Aggressive);
		AddSpawner("d_catacomb_80_2.Id4", MonsterId.Mirtislampa, min: 30, max: 40, tendency: TendencyType.Aggressive);
		AddSpawner("d_catacomb_80_2.Id5", MonsterId.Infroholder_Mage_Green, min: 12, max: 16, tendency: TendencyType.Aggressive);
		AddSpawner("d_catacomb_80_2.Id6", MonsterId.NightMaiden_Bow_Red, min: 12, max: 16, tendency: TendencyType.Aggressive);
		AddSpawner("d_catacomb_80_2.Id7", MonsterId.Gazing_Golem_Yellow, min: 9, max: 12, tendency: TendencyType.Aggressive);
		AddSpawner("d_catacomb_80_2.Id8", MonsterId.Egnome_Yellow, min: 4, max: 5, tendency: TendencyType.Aggressive);
		AddSpawner("d_catacomb_80_2.Id9", MonsterId.Wendigo_Archer_Blue, min: 15, max: 20, tendency: TendencyType.Aggressive);
		AddSpawner("d_catacomb_80_2.Id10", MonsterId.Wendigo_Magician_Blue, min: 15, max: 20, tendency: TendencyType.Aggressive);
		AddSpawner("d_catacomb_80_2.Id11", MonsterId.Kepari_Mage, min: 12, max: 16, tendency: TendencyType.Aggressive);
		AddSpawner("d_catacomb_80_2.Id12", MonsterId.Mushroom_Ent_Green, min: 4, max: 5, tendency: TendencyType.Aggressive);
