...
public class DThorn22MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("d_thorn_22.Id3", MonsterId.RavineLerva, min: 12, max: 15, respawn: Seconds(15), tendency: TendencyType.Aggressive);
		...
		AddSpawner("d_thorn_22.Id6", MonsterId.RavineLerva, min: 11, max: 14, respawn: Seconds(20), tendency: TendencyType.Aggressive);
		AddSpawner("d_thorn_22.Id7", MonsterId.Flower_Blue, min: 10, max: 13, respawn: Seconds(20), tendency: TendencyType.Aggressive);
		AddSpawner("d_thorn_22.Id8", MonsterId.Wood_Goblin, min: 38, max: 50, respawn: Seconds(5));
		AddSpawner("d_thorn_22.Id9", MonsterId.RavineLerva, min: 4, max: 5, respawn: Seconds(15), tendency: TendencyType.Aggressive);
		...
		// Boss Spawners ---------------------------------
		AddBossSpawner(MonsterId.Boss_GiantWoodGoblin_Red, "d_thorn_22", 1, Hours(2), Hours(4));
		AddBossSpawner(MonsterId.Boss_Ironbaum, "d_thorn_22", 1, Hours(2), Hours(4));
	}
}
