...
public class DCatacomb801MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("d_catacomb_80_1.Id1", MonsterId.Triffid, min: 14, max: 18, tendency: TendencyType.Aggressive);
		AddSpawner("d_catacomb_80_1.Id2", MonsterId.Goblin2_Hammer, min: 14, max: 18, tendency: TendencyType.Aggressive);
		AddSpawner("d_catacomb_80_1.Id3", MonsterId.Kowak, min: 14, max: 18, tendency: TendencyType.Aggressive);
		AddSpawner("d_catacomb_80_1.Id4", MonsterId.Kowak_Orange, min: 14, max: 18, tendency: TendencyType.Aggressive);
		AddSpawner("d_catacomb_80_1.Id5", MonsterId.Fisherman_Red, min: 23, max: 30, tendency: TendencyType.Aggressive);
		AddSpawner("d_catacomb_80_1.Id6", MonsterId.Panto_Rspear, min: 14, max: 18, tendency: TendencyType.Aggressive);
		AddSpawner("d_catacomb_80_1.Id7", MonsterId.Tree_Root_Mole_Pink, min: 14, max: 18, tendency: TendencyType.Aggressive);
		AddSpawner("d_catacomb_80_1.Id8", MonsterId.Melatanun, min: 30, max: 40, tendency: TendencyType.Aggressive);
		AddSpawner("d_catacomb_80_1.Id9", MonsterId.Rudas_Loxodon, min: 4, max: 5, tendency: TendencyType.Aggressive);
		AddSpawner("d_catacomb_80_1.Id10", MonsterId.GoblinWarrior_Blue, min: 4, max: 5, tendency: TendencyType.Aggressive);
