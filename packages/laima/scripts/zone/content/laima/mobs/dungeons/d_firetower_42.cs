...
public class DFiretower42MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("d_firetower_42.Id3", MonsterId.Slime_Elite, min: 24, max: 30, tendency: TendencyType.Aggressive);
		AddSpawner("d_firetower_42.Id4", MonsterId.Blindlem, min: 19, max: 25, tendency: TendencyType.Aggressive);
		AddSpawner("d_firetower_42.Id5", MonsterId.Belegg, min: 17, max: 25, tendency: TendencyType.Aggressive);
		AddSpawner("d_firetower_42.Id6", MonsterId.Chromadog, min: 24, max: 30, tendency: TendencyType.Aggressive);
		AddSpawner("d_firetower_42.Id7", MonsterId.Slime_Elite_Big, amount: 8, tendency: TendencyType.Aggressive);
		AddSpawner("d_firetower_42.Id8", MonsterId.Slime_Elite, min: 24, max: 30, tendency: TendencyType.Aggressive);
		...
		AddSpawnPoint("d_firetower_42.Id7", "d_firetower_42", Rectangle(2544, -121, 200));
		AddSpawnPoint("d_firetower_42.Id7", "d_firetower_42", Rectangle(1934, -142, 200));
		AddSpawnPoint("d_firetower_42.Id7", "d_firetower_42", Rectangle(1928, -1353, 200));
		AddSpawnPoint("d_firetower_42.Id7", "d_firetower_42", Rectangle(1030, -1361, 200));
		AddSpawnPoint("d_firetower_42.Id7", "d_firetower_42", Rectangle(1030, -1361, 200));
		AddSpawnPoint("d_firetower_42.Id7", "d_firetower_42", Rectangle(-1239, -2352, 200));
		AddSpawnPoint("d_firetower_42.Id7", "d_firetower_42", Rectangle(-1477, -1177, 200));
		AddSpawnPoint("d_firetower_42.Id7", "d_firetower_42", Rectangle(998, 122, 200));

		// 'Slime_Elite' Spawn Points
		AddSpawnPoint("d_firetower_42.Id8", "d_firetower_42", Rectangle(2544, -121, 200));
		AddSpawnPoint("d_firetower_42.Id8", "d_firetower_42", Rectangle(1934, -142, 200));
		AddSpawnPoint("d_firetower_42.Id8", "d_firetower_42", Rectangle(1928, -1353, 200));
		AddSpawnPoint("d_firetower_42.Id8", "d_firetower_42", Rectangle(1030, -1361, 200));
		AddSpawnPoint("d_firetower_42.Id8", "d_firetower_42", Rectangle(1030, -1361, 200));
		AddSpawnPoint("d_firetower_42.Id8", "d_firetower_42", Rectangle(-1239, -2352, 200));
	}
}
