...
public class DCmine8MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("d_cmine_8.Id4", MonsterId.Crystal_Lump, min: 4, max: 5, respawn: Seconds(10), tendency: TendencyType.Peaceful);
		AddSpawner("d_cmine_8.Id5", MonsterId.Crystal_Lump, min: 4, max: 5, respawn: Seconds(10), tendency: TendencyType.Peaceful);
		AddSpawner("d_cmine_8.Id6", MonsterId.Crystal_Lump, min: 4, max: 5, respawn: Seconds(10), tendency: TendencyType.Peaceful);
		AddSpawner("d_cmine_8.Id7", MonsterId.Crystal_Lump, min: 4, max: 5, respawn: Seconds(10), tendency: TendencyType.Peaceful);
		AddSpawner("d_cmine_8.Id8", MonsterId.Crystal_Lump, min: 4, max: 5, respawn: Seconds(10), tendency: TendencyType.Peaceful);
		AddSpawner("d_cmine_8.Id9", MonsterId.Crystal_Lump, min: 4, max: 5, respawn: Seconds(10), tendency: TendencyType.Peaceful);
		AddSpawner("d_cmine_8.Id10", MonsterId.FD_Bubbe_Mage_Fire, min: 8, max: 10, tendency: TendencyType.Aggressive);
		AddSpawner("d_cmine_8.Id11", MonsterId.FD_Bubbe_Mage_Fire, min: 9, max: 12, tendency: TendencyType.Aggressive);
		AddSpawner("d_cmine_8.Id12", MonsterId.FD_Bubbe_Chaser, min: 120, max: 160, respawn: Seconds(30), tendency: TendencyType.Aggressive);
		AddSpawner("d_cmine_8.Id13", MonsterId.Golemlet_Blue, min: 19, max: 25, respawn: Seconds(30), tendency: TendencyType.Aggressive);
		...
		// 'FD_Bubbe_Chaser' Custom Gentype Spawn Points
		AddSpawnPoint("d_cmine_8.Id12", "d_cmine_8", Rectangle(636, 693, 9999));

		// 'Golemlet_Blue' Custom Gentype Spawn Points
		AddSpawnPoint("d_cmine_8.Id13", "d_cmine_8", Rectangle(636, 693, 9999));

		// Boss Spawners ---------------------------------
		AddBossSpawner(MonsterId.Boss_Kubas, "d_cmine_8", 3, Hours(2), Hours(4));
	}
}
