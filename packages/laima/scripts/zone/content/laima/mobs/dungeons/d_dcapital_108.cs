...
public class DDcapital108MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("d_dcapital_108.Id4", MonsterId.Raganosis_Ram, amount: 2);
		AddSpawner("d_dcapital_108.Id5", MonsterId.Raganosis_Ram, min: 7, max: 9, respawn: Minutes(1));
		AddSpawner("d_dcapital_108.Id6", MonsterId.Raganosis_Guardian, min: 18, max: 24, respawn: Minutes(1));
		AddSpawner("d_dcapital_108.Id7", MonsterId.Raganosis_Seeker, min: 20, max: 26, respawn: Minutes(1));
		AddSpawner("d_dcapital_108.Id8", MonsterId.Rootcrystal_02, min: 19, max: 25, respawn: Seconds(20));
		...
		// Boss Spawners ---------------------------------
		AddBossSpawner(MonsterId.Boss_RaganosisCommander, "d_dcapital_108", 1, Hours(2), Hours(4));
	}
}
