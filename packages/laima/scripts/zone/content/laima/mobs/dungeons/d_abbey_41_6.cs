...
public class DAbbey416MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("d_abbey_41_6.Id2", MonsterId.Ticen_Bow_Red, min: 24, max: 30, tendency: TendencyType.Aggressive);
		AddSpawner("d_abbey_41_6.Id3", MonsterId.Ticen_Red, min: 130, max: 170, tendency: TendencyType.Aggressive);
		AddSpawner("d_abbey_41_6.Id4", MonsterId.Ticen_Mage_Red, min: 24, max: 30, tendency: TendencyType.Aggressive);
		AddSpawner("d_abbey_41_6.Id5", MonsterId.Nuo_Red, min: 20, max: 25, tendency: TendencyType.Aggressive);
		AddSpawner("d_abbey_41_6.Id6", MonsterId.Ticen_Mage_Red, amount: 2, tendency: TendencyType.Aggressive);
