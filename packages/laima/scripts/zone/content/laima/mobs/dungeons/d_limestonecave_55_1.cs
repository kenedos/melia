...
public class DLimestonecave551MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("d_limestonecave_55_1.Id5", MonsterId.RavineLerva_Cave, min: 15, max: 20, respawn: Seconds(2.5), tendency: TendencyType.Aggressive);
		AddSpawner("d_limestonecave_55_1.Id6", MonsterId.Rootcrystal_04, min: 12, max: 15, respawn: Seconds(30), tendency: TendencyType.Peaceful);
