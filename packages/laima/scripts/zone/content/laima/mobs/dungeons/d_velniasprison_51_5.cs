...
public class DVelniasprison515MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("d_velniasprison_51_5.Id2", MonsterId.Hohen_Mage, min: 23, max: 30, tendency: TendencyType.Aggressive);
		AddSpawner("d_velniasprison_51_5.Id3", MonsterId.Hohen_Barkle, min: 23, max: 30, tendency: TendencyType.Aggressive);
		AddSpawner("d_velniasprison_51_5.Id4", MonsterId.Hohen_Ritter, min: 23, max: 30, tendency: TendencyType.Aggressive);
		AddSpawner("d_velniasprison_51_5.Id5", MonsterId.Hohen_Gulak, min: 8, max: 10, tendency: TendencyType.Aggressive);
		AddSpawner("d_velniasprison_51_5.Id6", MonsterId.Hohen_Orben, min: 14, max: 20, tendency: TendencyType.Aggressive);
		AddSpawner("d_velniasprison_51_5.Id7", MonsterId.Harugal, min: 8, max: 16, tendency: TendencyType.Aggressive);
		AddSpawner("d_velniasprison_51_5.Id8", MonsterId.Hohen_Mage, min: 10, max: 25, respawn: Seconds(60), tendency: TendencyType.Aggressive);
		AddSpawner("d_velniasprison_51_5.Id9", MonsterId.Hohen_Mage, min: 25, max: 35, respawn: Seconds(60), tendency: TendencyType.Aggressive);
		AddSpawner("d_velniasprison_51_5.Id10", MonsterId.Hohen_Mage, min: 15, max: 25, respawn: Seconds(60), tendency: TendencyType.Aggressive);
		AddSpawner("d_velniasprison_51_5.Id11", MonsterId.Hohen_Gulak, min: 4, max: 8, respawn: Seconds(60), tendency: TendencyType.Aggressive);
		...
		AddSpawnPoint("d_velniasprison_51_5.Id6", "d_velniasprison_51_5", Rectangle(852, 610, 45));
		AddSpawnPoint("d_velniasprison_51_5.Id6", "d_velniasprison_51_5", Rectangle(1303, 163, 45));
		AddSpawnPoint("d_velniasprison_51_5.Id6", "d_velniasprison_51_5", Rectangle(643, 778, 45));
		AddSpawnPoint("d_velniasprison_51_5.Id6", "d_velniasprison_51_5", Rectangle(1328, -78, 45));
		AddSpawnPoint("d_velniasprison_51_5.Id6", "d_velniasprison_51_5", Rectangle(255, 1101, 45));
		AddSpawnPoint("d_velniasprison_51_5.Id6", "d_velniasprison_51_5", Rectangle(540, -488, 45));
		AddSpawnPoint("d_velniasprison_51_5.Id6", "d_velniasprison_51_5", Rectangle(-180, 1092, 45));
		AddSpawnPoint("d_velniasprison_51_5.Id6", "d_velniasprison_51_5", Rectangle(635, 644, 45));
		AddSpawnPoint("d_velniasprison_51_5.Id6", "d_velniasprison_51_5", Rectangle(-930, 705, 45));
		AddSpawnPoint("d_velniasprison_51_5.Id6", "d_velniasprison_51_5", Rectangle(58, 42, 45));
		AddSpawnPoint("d_velniasprison_51_5.Id6", "d_velniasprison_51_5", Rectangle(77, 150, 45));
		AddSpawnPoint("d_velniasprison_51_5.Id6", "d_velniasprison_51_5", Rectangle(530, -683, 45));
		AddSpawnPoint("d_velniasprison_51_5.Id6", "d_velniasprison_51_5", Rectangle(1324, 449, 45));
		AddSpawnPoint("d_velniasprison_51_5.Id6", "d_velniasprison_51_5", Rectangle(-765, 496, 45));
		AddSpawnPoint("d_velniasprison_51_5.Id6", "d_velniasprison_51_5", Rectangle(-2057, -22, 45));
		AddSpawnPoint("d_velniasprison_51_5.Id6", "d_velniasprison_51_5", Rectangle(-2039, 141, 45));
		AddSpawnPoint("d_velniasprison_51_5.Id6", "d_velniasprison_51_5", Rectangle(-1453, 101, 45));
		AddSpawnPoint("d_velniasprison_51_5.Id6", "d_velniasprison_51_5", Rectangle(-632, 715, 45));
		AddSpawnPoint("d_velniasprison_51_5.Id6", "d_velniasprison_51_5", Rectangle(-1219, 200, 45));
		AddSpawnPoint("d_velniasprison_51_5.Id6", "d_velniasprison_51_5", Rectangle(-1280, -44, 45));
		AddSpawnPoint("d_velniasprison_51_5.Id6", "d_velniasprison_51_5", Rectangle(571, 51, 45));
		AddSpawnPoint("d_velniasprison_51_5.Id6", "d_velniasprison_51_5", Rectangle(788, -676, 45));
		AddSpawnPoint("d_velniasprison_51_5.Id6", "d_velniasprison_51_5", Rectangle(1539, 91, 45));
		AddSpawnPoint("d_velniasprison_51_5.Id6", "d_velniasprison_51_5", Rectangle(0, 1078, 45));
		AddSpawnPoint("d_velniasprison_51_5.Id6", "d_velniasprison_51_5", Rectangle(-305, -34, 45));

		// 'Harugal' Spawn Points
		AddSpawnPoint("d_velniasprison_51_5.Id7", "d_velniasprison_51_5", Rectangle(852, 610, 45));
		AddSpawnPoint("d_velniasprison_51_5.Id7", "d_velniasprison_51_5", Rectangle(1303, 163, 45));
		AddSpawnPoint("d_velniasprison_51_5.Id7", "d_velniasprison_51_5", Rectangle(643, 778, 45));
		AddSpawnPoint("d_velniasprison_51_5.Id7", "d_velniasprison_51_5", Rectangle(1328, -78, 45));
		AddSpawnPoint("d_velniasprison_51_5.Id7", "d_velniasprison_51_5", Rectangle(255, 1101, 45));
		AddSpawnPoint("d_velniasprison_51_5.Id7", "d_velniasprison_51_5", Rectangle(540, -488, 45));
		AddSpawnPoint("d_velniasprison_51_5.Id7", "d_velniasprison_51_5", Rectangle(-180, 1092, 45));
		AddSpawnPoint("d_velniasprison_51_5.Id7", "d_velniasprison_51_5", Rectangle(635, 644, 45));
		AddSpawnPoint("d_velniasprison_51_5.Id7", "d_velniasprison_51_5", Rectangle(-930, 705, 45));
		AddSpawnPoint("d_velniasprison_51_5.Id7", "d_velniasprison_51_5", Rectangle(58, 42, 45));
		AddSpawnPoint("d_velniasprison_51_5.Id7", "d_velniasprison_51_5", Rectangle(77, 150, 45));
		AddSpawnPoint("d_velniasprison_51_5.Id7", "d_velniasprison_51_5", Rectangle(530, -683, 45));
		AddSpawnPoint("d_velniasprison_51_5.Id7", "d_velniasprison_51_5", Rectangle(1324, 449, 45));
		AddSpawnPoint("d_velniasprison_51_5.Id7", "d_velniasprison_51_5", Rectangle(-765, 496, 45));
		AddSpawnPoint("d_velniasprison_51_5.Id7", "d_velniasprison_51_5", Rectangle(-2057, -22, 45));
		AddSpawnPoint("d_velniasprison_51_5.Id7", "d_velniasprison_51_5", Rectangle(-2039, 141, 45));
		AddSpawnPoint("d_velniasprison_51_5.Id7", "d_velniasprison_51_5", Rectangle(-1453, 101, 45));
		AddSpawnPoint("d_velniasprison_51_5.Id7", "d_velniasprison_51_5", Rectangle(-632, 715, 45));
		AddSpawnPoint("d_velniasprison_51_5.Id7", "d_velniasprison_51_5", Rectangle(-1219, 200, 45));
		AddSpawnPoint("d_velniasprison_51_5.Id7", "d_velniasprison_51_5", Rectangle(-1280, -44, 45));
		AddSpawnPoint("d_velniasprison_51_5.Id7", "d_velniasprison_51_5", Rectangle(571, 51, 45));
		AddSpawnPoint("d_velniasprison_51_5.Id7", "d_velniasprison_51_5", Rectangle(788, -676, 45));
		AddSpawnPoint("d_velniasprison_51_5.Id7", "d_velniasprison_51_5", Rectangle(1539, 91, 45));
		AddSpawnPoint("d_velniasprison_51_5.Id7", "d_velniasprison_51_5", Rectangle(0, 1078, 45));
		AddSpawnPoint("d_velniasprison_51_5.Id7", "d_velniasprison_51_5", Rectangle(-305, -34, 45));

		// 'Hohen_Mage' Spawn Points
		AddSpawnPoint("d_velniasprison_51_5.Id8", "d_velniasprison_51_5", Rectangle(-2127, 37, 200));

		// 'Hohen_Mage' Spawn Points
		AddSpawnPoint("d_velniasprison_51_5.Id9", "d_velniasprison_51_5", Rectangle(-124, 227, 200));
		AddSpawnPoint("d_velniasprison_51_5.Id9", "d_velniasprison_51_5", Rectangle(-329, -23, 200));
		AddSpawnPoint("d_velniasprison_51_5.Id9", "d_velniasprison_51_5", Rectangle(-87, -223, 200));
		AddSpawnPoint("d_velniasprison_51_5.Id9", "d_velniasprison_51_5", Rectangle(147, 50, 200));

		// 'Hohen_Mage' Spawn Points
		AddSpawnPoint("d_velniasprison_51_5.Id10", "d_velniasprison_51_5", Rectangle(2102, 63, 300));
		AddSpawnPoint("d_velniasprison_51_5.Id10", "d_velniasprison_51_5", Rectangle(2450, 45, 300));
