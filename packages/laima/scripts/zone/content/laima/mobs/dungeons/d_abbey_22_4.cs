...
public class DAbbey224MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("d_abbey_22_4.Id2", MonsterId.Hohen_Mage_Black, min: 72, max: 95, tendency: TendencyType.Aggressive);
		...
		AddSpawner("d_abbey_22_4.Id7", MonsterId.Hohen_Mage_Black, min: 8, max: 12, respawn: Seconds(40), tendency: TendencyType.Aggressive);
		AddSpawner("d_abbey_22_4.Id8", MonsterId.Hohen_Mage_Black, min: 8, max: 12, respawn: Minutes(1), tendency: TendencyType.Aggressive);
