...
public class FFlash61MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("f_flash_61.Id4", MonsterId.Goblin2_Sword, min: 75, max: 100, tendency: TendencyType.Aggressive);
		...
		// Boss Spawners ---------------------------------
		AddBossSpawner(MonsterId.Boss_ShadowGaoler, "f_flash_61", 1, Hours(2), Hours(4));
	}
}
