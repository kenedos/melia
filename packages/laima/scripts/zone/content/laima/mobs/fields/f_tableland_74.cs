...
public class FTableland74MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("f_tableland_74.Id1", MonsterId.Tiny_Mage_Brown, min: 27, max: 35, tendency: TendencyType.Aggressive);
		AddSpawner("f_tableland_74.Id2", MonsterId.Spion_Mage_White, min: 12, max: 15);
		AddSpawner("f_tableland_74.Id3", MonsterId.Harugal_Blue, min: 4, max: 5, tendency: TendencyType.Aggressive);
		AddSpawner("f_tableland_74.Id4", MonsterId.Kepari_Purple, min: 42, max: 55);
		AddSpawner("f_tableland_74.Id5", MonsterId.Rootcrystal_01, min: 23, max: 30, respawn: Minutes(1));
		AddSpawner("f_tableland_74.Id6", MonsterId.Hohen_Gulak_Blue, min: 4, max: 5, tendency: TendencyType.Aggressive);
		...
		AddSpawnPoint("f_tableland_74.Id6", "f_tableland_74", Rectangle(1300, 374, 25));
		AddSpawnPoint("f_tableland_74.Id6", "f_tableland_74", Rectangle(386, 930, 25));
		AddSpawnPoint("f_tableland_74.Id6", "f_tableland_74", Rectangle(1287, 1277, 25));
		AddSpawnPoint("f_tableland_74.Id6", "f_tableland_74", Rectangle(1059, 2067, 25));
		AddSpawnPoint("f_tableland_74.Id6", "f_tableland_74", Rectangle(932, 2175, 25));
		AddSpawnPoint("f_tableland_74.Id6", "f_tableland_74", Rectangle(-638, -1023, 25));
		AddSpawnPoint("f_tableland_74.Id6", "f_tableland_74", Rectangle(153, -1060, 25));
		AddSpawnPoint("f_tableland_74.Id6", "f_tableland_74", Rectangle(-746, -185, 25));
		AddSpawnPoint("f_tableland_74.Id6", "f_tableland_74", Rectangle(-1741, -340, 25));
		AddSpawnPoint("f_tableland_74.Id6", "f_tableland_74", Rectangle(-1742, -1085, 25));
		AddSpawnPoint("f_tableland_74.Id6", "f_tableland_74", Rectangle(243, 1001, 25));
		AddSpawnPoint("f_tableland_74.Id6", "f_tableland_74", Rectangle(601, 1634, 25));
		AddSpawnPoint("f_tableland_74.Id6", "f_tableland_74", Rectangle(1006, -130, 25));
	}
}
