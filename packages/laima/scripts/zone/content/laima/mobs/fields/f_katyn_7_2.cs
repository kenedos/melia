...
public class FKatyn72MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("f_katyn_7_2.Id5", MonsterId.Sakmoli, min: 5, max: 6, tendency: TendencyType.Aggressive);
		AddSpawner("f_katyn_7_2.Id6", MonsterId.Ridimed, min: 6, max: 8);
		AddSpawner("f_katyn_7_2.Id7", MonsterId.Sakmoli, min: 6, max: 8, tendency: TendencyType.Aggressive);
		AddSpawner("f_katyn_7_2.Id8", MonsterId.Ellomago, min: 6, max: 8);
		AddSpawner("f_katyn_7_2.Id9", MonsterId.Ridimed, min: 12, max: 15);
		AddSpawner("f_katyn_7_2.Id10", MonsterId.Sakmoli, min: 8, max: 10, tendency: TendencyType.Aggressive);
