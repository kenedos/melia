...
public class FKatyn133MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("f_katyn_13_3.Id1", MonsterId.New_Desmodus, min: 15, max: 20, respawn: Seconds(15), tendency: TendencyType.Aggressive);
		...
		AddSpawner("f_katyn_13_3.Id5", MonsterId.New_Desmodus, min: 15, max: 20, respawn: Seconds(5), tendency: TendencyType.Aggressive);
		AddSpawner("f_katyn_13_3.Id6", MonsterId.Ellom, min: 15, max: 20);
		AddSpawner("f_katyn_13_3.Id7", MonsterId.Pappus_Kepa, min: 15, max: 20);
		...
		// 'Ellom' Spawn Points
		AddSpawnPoint("f_katyn_13_3.Id6", "f_katyn_13_3", Rectangle(-34, -449, 200));
		AddSpawnPoint("f_katyn_13_3.Id6", "f_katyn_13_3", Rectangle(-1477, 350, 200));

		// 'Pappus_Kepa' Spawn Points
		AddSpawnPoint("f_katyn_13_3.Id7", "f_katyn_13_3", Rectangle(-34, -449, 200));
		AddSpawnPoint("f_katyn_13_3.Id7", "f_katyn_13_3", Rectangle(-1477, 350, 200));


		// Boss Spawners ---------------------------------
		AddBossSpawner(MonsterId.Boss_Deadbone, "f_katyn_13_3", 1, Hours(2), Hours(4));
		AddBossSpawner(MonsterId.Boss_Saltistter, "f_katyn_13_3", 1, Hours(2), Hours(4));
	}
}
