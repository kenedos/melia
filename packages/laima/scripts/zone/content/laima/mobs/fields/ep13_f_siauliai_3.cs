...
public class Ep13FSiauliai3MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("ep13_f_siauliai_3.Id1", MonsterId.Rootcrystal_01, min: 13, max: 17, respawn: Seconds(20));
		AddSpawner("ep13_f_siauliai_3.Id2", MonsterId.Biblioteka_Keeper, min: 38, max: 50, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id3", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id4", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id5", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id6", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id7", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id8", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id9", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id10", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id11", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id12", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id13", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id14", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id15", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id16", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id17", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id18", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id19", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id20", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id21", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id22", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id23", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id24", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id25", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id26", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id27", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id28", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id29", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id30", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id31", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id32", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id33", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id34", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id35", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id36", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id37", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id38", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id39", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id40", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id41", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id42", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id43", MonsterId.Biblioteka_Keeper, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id44", MonsterId.Biblioteka_Keeper, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id45", MonsterId.Biblioteka_Keeper, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id46", MonsterId.Biblioteka_Keeper, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id47", MonsterId.Biblioteka_Keeper, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id48", MonsterId.Biblioteka_Keeper, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id49", MonsterId.Biblioteka_Keeper, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id50", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id51", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id52", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id53", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id54", MonsterId.Darbas_Leader, min: 23, max: 30, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id55", MonsterId.Darbas_Cleaner, min: 45, max: 60, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id56", MonsterId.Biblioteka_Keeper, min: 12, max: 15, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id57", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id58", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id59", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id60", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id61", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id62", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id63", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id64", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id65", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id66", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id67", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id68", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id69", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id70", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id71", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id72", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id73", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id74", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id75", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id76", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id77", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id78", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id79", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id80", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id81", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id82", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id83", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id84", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id85", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id86", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_3.Id87", MonsterId.Vynmedis, amount: 1, respawn: Minutes(1));
