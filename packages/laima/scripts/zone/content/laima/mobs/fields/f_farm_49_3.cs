...
public class FFarm493MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("f_farm_49_3.Id1", MonsterId.Melatanun, min: 38, max: 50, respawn: Seconds(20), tendency: TendencyType.Aggressive);
		AddSpawner("f_farm_49_3.Id2", MonsterId.Melatanun, min: 19, max: 25, respawn: Seconds(30), tendency: TendencyType.Aggressive);
		AddSpawner("f_farm_49_3.Id3", MonsterId.Carcashu_Green, min: 38, max: 50, respawn: Seconds(20), tendency: TendencyType.Aggressive);
