...
public class FHuevillage581MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		// Boss Spawners ---------------------------------
		AddBossSpawner(MonsterId.Boss_Moyabruka, "f_huevillage_58_1", 1, Hours(2), Hours(4));
		AddBossSpawner(MonsterId.Boss_Merregina, "f_huevillage_58_1", 1, Hours(2), Hours(4));
	}
}
