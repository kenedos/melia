...
public class FWhitetrees221MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("f_whitetrees_22_1.Id1", MonsterId.Banterer_Red, min: 38, max: 50, tendency: TendencyType.Aggressive);
		AddSpawner("f_whitetrees_22_1.Id2", MonsterId.Umbra_Mage, min: 30, max: 40, tendency: TendencyType.Peaceful);
		AddSpawner("f_whitetrees_22_1.Id3", MonsterId.Umbra_Warrior, min: 30, max: 40, tendency: TendencyType.Peaceful);
