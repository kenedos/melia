...
public class F3Cmlake87MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("f_3cmlake_87.Id5", MonsterId.KindronBoor, min: 19, max: 25, respawn: Minutes(1));
		AddSpawner("f_3cmlake_87.Id6", MonsterId.Rootcrystal_02, min: 23, max: 30, respawn: Seconds(20));
		...
		// Boss Spawners ---------------------------------
		AddBossSpawner(MonsterId.Boss_Pbeta, "f_3cmlake_87", 1, Hours(2), Hours(4));
	}
}
