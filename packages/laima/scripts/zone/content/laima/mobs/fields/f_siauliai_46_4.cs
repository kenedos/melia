...
public class FSiauliai464MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("f_siauliai_46_4.Id3", MonsterId.Siaulamb, min: 15, max: 20, respawn: Seconds(30));
		AddSpawner("f_siauliai_46_4.Id4", MonsterId.Siaulogre, min: 3, max: 4, tendency: TendencyType.Aggressive);
		...
		AddSpawner("f_siauliai_46_4.Id9", MonsterId.Pendinmire, amount: 1, respawn: Hours(1), tendency: TendencyType.Aggressive);
		...
		AddSpawner("f_siauliai_46_4.Id13", MonsterId.Honeymeli, min: 14, max: 18, respawn: Seconds(30), tendency: TendencyType.Aggressive);
		...
		AddSpawnPoint("f_siauliai_46_4.Id13", "f_siauliai_46_4", Rectangle(413, -164, 2500));
	}
}
