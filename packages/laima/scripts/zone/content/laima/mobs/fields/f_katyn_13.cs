...
public class FKatyn13MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("f_katyn_13.Id2", MonsterId.HighBube_Spear, min: 15, max: 20, tendency: TendencyType.Aggressive);
		AddSpawner("f_katyn_13.Id3", MonsterId.HighBube_Archer, min: 15, max: 20, tendency: TendencyType.Aggressive);
		AddSpawner("f_katyn_13.Id4", MonsterId.Arburn_Pokubu_Green, min: 30, max: 40, tendency: TendencyType.Aggressive);
		AddSpawner("f_katyn_13.Id5", MonsterId.HighBube_Spear, min: 15, max: 20, tendency: TendencyType.Aggressive);
		AddSpawner("f_katyn_13.Id6", MonsterId.HighBube_Archer, min: 8, max: 10, tendency: TendencyType.Aggressive);
		AddSpawner("f_katyn_13.Id7", MonsterId.Arburn_Pokubu_Green, min: 12, max: 15, tendency: TendencyType.Aggressive);
		AddSpawner("f_katyn_13.Id8", MonsterId.Bushspider, min: 12, max: 15);
		AddSpawner("f_katyn_13.Id9", MonsterId.Fisherman, min: 8, max: 10);
		...
		AddSpawnPoint("f_katyn_13.Id8", "f_katyn_13", Rectangle(903, -691, 300));
		AddSpawnPoint("f_katyn_13.Id8", "f_katyn_13", Rectangle(-1080, 1092, 300));

		// 'Fisherman' Spawn Points
		AddSpawnPoint("f_katyn_13.Id9", "f_katyn_13", Rectangle(903, -691, 300));
