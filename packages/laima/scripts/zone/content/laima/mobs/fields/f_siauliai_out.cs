...
public class FSiauliaiOutMobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("f_siauliai_out.Id3", MonsterId.Rootcrystal_01, min: 23, max: 30, respawn: Seconds(20));
		...
		AddBossSpawner(MonsterId.Boss_Goblin_Warrior_Red, "f_siauliai_out", 1, Hours(2), Hours(4));
		AddBossSpawner(MonsterId.Boss_Goblin_Warrior, "f_siauliai_out", 1, Hours(2), Hours(4));
	}
}
