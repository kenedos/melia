...
public class FFlash64MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("f_flash_64.Id2", MonsterId.Lemuria, min: 12, max: 15, tendency: TendencyType.Aggressive);
		AddSpawner("f_flash_64.Id3", MonsterId.Rubabos, min: 6, max: 7, tendency: TendencyType.Aggressive);
		AddSpawner("f_flash_64.Id4", MonsterId.Lemuria, min: 12, max: 16, tendency: TendencyType.Aggressive);
		AddSpawner("f_flash_64.Id5", MonsterId.Repusbunny, min: 12, max: 15);
		AddSpawner("f_flash_64.Id6", MonsterId.Lemuria, min: 12, max: 15, tendency: TendencyType.Aggressive);
		...
		AddSpawner("f_flash_64.Id9", MonsterId.Lemuria, min: 57, max: 76, tendency: TendencyType.Aggressive);
