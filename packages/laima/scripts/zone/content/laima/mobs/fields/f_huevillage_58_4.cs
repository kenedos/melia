...
public class FHuevillage584MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("f_huevillage_58_4.Id2", MonsterId.Mentiwood, amount: 20, tendency: TendencyType.Aggressive);
		...
		AddSpawner("f_huevillage_58_4.Id9", MonsterId.Beetow, min: 12, max: 16);
		...
		// 'Beetow' Spawn Points
		AddSpawnPoint("f_huevillage_58_4.Id9", "f_huevillage_58_4", Rectangle(1341, -878, 30));
		AddSpawnPoint("f_huevillage_58_4.Id9", "f_huevillage_58_4", Rectangle(1324, -693, 30));
		AddSpawnPoint("f_huevillage_58_4.Id9", "f_huevillage_58_4", Rectangle(1418, -329, 30));
		AddSpawnPoint("f_huevillage_58_4.Id9", "f_huevillage_58_4", Rectangle(1014, -261, 30));
		AddSpawnPoint("f_huevillage_58_4.Id9", "f_huevillage_58_4", Rectangle(681, -312, 30));
		AddSpawnPoint("f_huevillage_58_4.Id9", "f_huevillage_58_4", Rectangle(625, -144, 30));
		AddSpawnPoint("f_huevillage_58_4.Id9", "f_huevillage_58_4", Rectangle(432, -234, 30));
		AddSpawnPoint("f_huevillage_58_4.Id9", "f_huevillage_58_4", Rectangle(32, -457, 30));
		AddSpawnPoint("f_huevillage_58_4.Id9", "f_huevillage_58_4", Rectangle(-252, -383, 30));
		AddSpawnPoint("f_huevillage_58_4.Id9", "f_huevillage_58_4", Rectangle(-829, -548, 30));
		AddSpawnPoint("f_huevillage_58_4.Id9", "f_huevillage_58_4", Rectangle(-762, -748, 30));
		AddSpawnPoint("f_huevillage_58_4.Id9", "f_huevillage_58_4", Rectangle(-1024, -736, 30));
		AddSpawnPoint("f_huevillage_58_4.Id9", "f_huevillage_58_4", Rectangle(-860, -975, 30));
		AddSpawnPoint("f_huevillage_58_4.Id9", "f_huevillage_58_4", Rectangle(-1073, -45, 30));
		AddSpawnPoint("f_huevillage_58_4.Id9", "f_huevillage_58_4", Rectangle(-1209, -226, 30));
		AddSpawnPoint("f_huevillage_58_4.Id9", "f_huevillage_58_4", Rectangle(-1405, -402, 30));

		// Boss Spawners ---------------------------------
		AddBossSpawner(MonsterId.Boss_Clymen, "f_huevillage_58_4", 1, Hours(2), Hours(4));
		AddBossSpawner(MonsterId.Boss_Mothstem, "f_huevillage_58_4", 1, Hours(2), Hours(4));
		AddBossSpawner(MonsterId.Boss_Harpeia, "f_huevillage_58_4", 1, Hours(2), Hours(4));
		AddBossSpawner(MonsterId.Boss_Merge, "f_huevillage_58_4", 1, Hours(2), Hours(4));
	}
}
