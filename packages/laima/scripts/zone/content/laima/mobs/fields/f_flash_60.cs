...
public class FFlash60MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("f_flash_60.Id5", MonsterId.Saltisdaughter_Mage, min: 8, max: 10, tendency: TendencyType.Aggressive);
		AddSpawner("f_flash_60.Id6", MonsterId.Rootcrystal_01, min: 12, max: 15, respawn: Seconds(20));
		AddSpawner("f_flash_60.Id7", MonsterId.Saltisdaughter_Mage, min: 6, max: 8, tendency: TendencyType.Aggressive);
