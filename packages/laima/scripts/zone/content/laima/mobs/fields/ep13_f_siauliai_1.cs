...
public class Ep13FSiauliai1MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("ep13_f_siauliai_1.Id1", MonsterId.Rootcrystal_01, min: 15, max: 20, respawn: Seconds(20));
		AddSpawner("ep13_f_siauliai_1.Id2", MonsterId.Liepsna_Invader, min: 60, max: 80, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_1.Id3", MonsterId.Liepsna_Destroyer, min: 30, max: 40, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_1.Id4", MonsterId.Liepsna_Chaser, min: 60, max: 80, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_1.Id5", MonsterId.Liepsna_Spreader, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_1.Id6", MonsterId.Liepsna_Spreader, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_1.Id7", MonsterId.Liepsna_Spreader, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_1.Id8", MonsterId.Liepsna_Spreader, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_1.Id9", MonsterId.Liepsna_Spreader, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_1.Id10", MonsterId.Liepsna_Spreader, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_1.Id11", MonsterId.Liepsna_Spreader, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_1.Id12", MonsterId.Liepsna_Spreader, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_1.Id13", MonsterId.Liepsna_Spreader, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_1.Id14", MonsterId.Liepsna_Spreader, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_1.Id15", MonsterId.Liepsna_Spreader, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_1.Id16", MonsterId.Liepsna_Spreader, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_1.Id17", MonsterId.Liepsna_Spreader, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_1.Id18", MonsterId.Liepsna_Spreader, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_1.Id19", MonsterId.Liepsna_Spreader, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_1.Id20", MonsterId.Liepsna_Spreader, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_1.Id21", MonsterId.Liepsna_Spreader, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_1.Id22", MonsterId.Liepsna_Spreader, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_1.Id23", MonsterId.Liepsna_Spreader, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_1.Id24", MonsterId.Liepsna_Spreader, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_1.Id25", MonsterId.Liepsna_Spreader, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_1.Id26", MonsterId.Liepsna_Spreader, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_1.Id27", MonsterId.Liepsna_Spreader, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_1.Id28", MonsterId.Liepsna_Spreader, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_1.Id29", MonsterId.Liepsna_Spreader, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_1.Id30", MonsterId.Liepsna_Spreader, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_1.Id31", MonsterId.Liepsna_Spreader, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_1.Id32", MonsterId.Liepsna_Spreader, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_1.Id33", MonsterId.Liepsna_Spreader, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_1.Id34", MonsterId.Liepsna_Spreader, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_1.Id35", MonsterId.Liepsna_Spreader, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_1.Id36", MonsterId.Liepsna_Spreader, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_1.Id37", MonsterId.Liepsna_Spreader, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_1.Id38", MonsterId.Liepsna_Spreader, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_1.Id39", MonsterId.Liepsna_Spreader, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_1.Id40", MonsterId.Liepsna_Spreader, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_1.Id41", MonsterId.Liepsna_Spreader, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_1.Id42", MonsterId.Liepsna_Spreader, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_1.Id43", MonsterId.Liepsna_Spreader, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_1.Id44", MonsterId.Liepsna_Spreader, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_1.Id45", MonsterId.Liepsna_Invader, min: 15, max: 20, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_1.Id46", MonsterId.Liepsna_Spreader, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_1.Id47", MonsterId.Liepsna_Spreader, amount: 1, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_1.Id48", MonsterId.Liepsna_Spreader, amount: 1, respawn: Minutes(1));
		...
		// Boss Spawners ---------------------------------
		AddBossSpawner(MonsterId.Boss_Liepsna_Firebug, "ep13_f_siauliai_1", 1, Hours(2), Hours(4));
	}
}
