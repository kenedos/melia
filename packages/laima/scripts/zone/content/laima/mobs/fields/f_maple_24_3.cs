...
public class FMaple243MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("f_maple_24_3.Id1", MonsterId.Fragolin, min: 60, max: 80, respawn: Minutes(1));
		AddSpawner("f_maple_24_3.Id2", MonsterId.Cloverin, min: 60, max: 80, respawn: Minutes(1));
		AddSpawner("f_maple_24_3.Id3", MonsterId.Blueberrin, min: 44, max: 58, respawn: Minutes(1));
		AddSpawner("f_maple_24_3.Id4", MonsterId.Rootcrystal_01, min: 23, max: 30, respawn: Seconds(20));
