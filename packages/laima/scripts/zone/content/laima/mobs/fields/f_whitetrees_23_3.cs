...
public class FWhitetrees233MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("f_whitetrees_23_3.Id1", MonsterId.Rootcrystal_03, min: 9, max: 12, respawn: Seconds(5));
		AddSpawner("f_whitetrees_23_3.Id2", MonsterId.Fragolin, min: 15, max: 20);
		AddSpawner("f_whitetrees_23_3.Id3", MonsterId.Fragolin, min: 12, max: 15);
		AddSpawner("f_whitetrees_23_3.Id4", MonsterId.Rafflet, min: 18, max: 20);
		AddSpawner("f_whitetrees_23_3.Id5", MonsterId.Cloverin, min: 20, max: 25);
		AddSpawner("f_whitetrees_23_3.Id6", MonsterId.Rafflet, min: 18, max: 20);
		AddSpawner("f_whitetrees_23_3.Id7", MonsterId.Cloverin, min: 20, max: 25);
		...
		// 'Fragolin' GenType 100 Spawn Points
		...
		// 'Fragolin' GenType 103 Spawn Points
		...
		// 'Rafflet' GenType 104 Spawn Points
		...
		// 'Cloverin' GenType 105 Spawn Points
