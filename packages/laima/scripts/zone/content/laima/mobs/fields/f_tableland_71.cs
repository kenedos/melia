...
public class FTableland71MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("f_tableland_71.Id1", MonsterId.Hohen_Ritter_Purple, min: 23, max: 30, respawn: Seconds(25), tendency: TendencyType.Aggressive);
		AddSpawner("f_tableland_71.Id2", MonsterId.Cronewt_Bow_Blue, min: 8, max: 10, respawn: Seconds(25));
		AddSpawner("f_tableland_71.Id3", MonsterId.Hohen_Barkle_Blue, min: 8, max: 10, respawn: Seconds(25), tendency: TendencyType.Aggressive);
		AddSpawner("f_tableland_71.Id4", MonsterId.Tiny_Blue, min: 8, max: 10, respawn: Seconds(25), tendency: TendencyType.Aggressive);
		AddSpawner("f_tableland_71.Id5", MonsterId.Rootcrystal_03, min: 27, max: 35, respawn: Seconds(30));
		AddSpawner("f_tableland_71.Id6", MonsterId.Hohen_Ritter_Purple, amount: 3, respawn: Seconds(25), tendency: TendencyType.Aggressive);
		AddSpawner("f_tableland_71.Id7", MonsterId.Hohen_Barkle_Blue, amount: 2, respawn: Seconds(25), tendency: TendencyType.Aggressive);
		AddSpawner("f_tableland_71.Id8", MonsterId.Tiny_Blue, amount: 1, respawn: Seconds(25), tendency: TendencyType.Aggressive);
		AddSpawner("f_tableland_71.Id9", MonsterId.Cronewt_Bow_Blue, amount: 1, respawn: Seconds(25));
		AddSpawner("f_tableland_71.Id10", MonsterId.Tiny_Blue, min: 75, max: 100, respawn: Seconds(25), tendency: TendencyType.Aggressive);
		AddSpawner("f_tableland_71.Id11", MonsterId.Cronewt_Bow_Blue, min: 3, max: 4, respawn: Minutes(1));
		AddSpawner("f_tableland_71.Id12", MonsterId.Hohen_Ritter_Purple, min: 8, max: 10, respawn: Seconds(30), tendency: TendencyType.Aggressive);
