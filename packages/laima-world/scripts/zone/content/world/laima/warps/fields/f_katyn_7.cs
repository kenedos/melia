...
public class f_katyn_7WarpsScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddWarp(101, "KATYN7_GELE574", 0, From("f_katyn_7", 663, -4459), To("f_gele_57_4", -909, 2390));

		// Entrance of Kateen Forest to Owl Burial Ground
		AddWarp(103, "KATYN7_KATYN7_2", 180, From("f_katyn_7", -864, 3894), To("f_katyn_7_2", 299, -4327));
	}
}
