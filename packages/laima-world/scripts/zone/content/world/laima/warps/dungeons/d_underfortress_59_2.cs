...
public class d_underfortress_59_2WarpsScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddWarp(1, "UNDERF592_TO_UNDERF593", 270, From("d_underfortress_59_2", -40.84153, 281.1239), To("d_underfortress_59_3", -1289, -1209));

		// Royal Mausoleum Constructors' Chapel to Royal Mausoleum Workers Lodge
		AddWarp(2, "UNDERF592_TO_UNDERF591", 93, From("d_underfortress_59_2", 456.9549, -386.4884), To("d_underfortress_59_1", 581, 236));
	}
}
