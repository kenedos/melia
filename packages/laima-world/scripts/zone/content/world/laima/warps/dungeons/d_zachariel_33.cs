...
public class d_zachariel_33WarpsScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddWarp(15, "ZACHARIEL33_ZACHARIEL32", 0, From("d_zachariel_33", -93, -2677), To("d_zachariel_32", 35, 2749));

		// Royal Mausoleum 2F to Royal Mausoleum 3F
		AddWarp(16, "ZACHARIEL33_ZACHARIEL34", 239, From("d_zachariel_33", -372, 1880), To("d_zachariel_34", 3558, 124));
