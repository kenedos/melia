...
public class DCmine6MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("d_cmine_6.Id2", MonsterId.Quartz_Weaver, min: 20, max: 30, respawn: Seconds(30), tendency: TendencyType.Aggressive);
		AddSpawner("d_cmine_6.Id3", MonsterId.Bubbe_Mage_Priest, min: 30, max: 50, respawn: Seconds(30), tendency: TendencyType.Aggressive);
		AddSpawner("d_cmine_6.Id4", MonsterId.GoblinWarrior, amount: 30, respawn: Seconds(30), tendency: TendencyType.Aggressive);
		AddSpawner("d_cmine_6.Id5", MonsterId.Quartz_Weaver, min: 20, max: 30, respawn: Seconds(30), tendency: TendencyType.Aggressive);
		AddSpawner("d_cmine_6.Id6", MonsterId.Bubbe_Mage_Priest, min: 20, max: 30, respawn: Seconds(30), tendency: TendencyType.Aggressive);
		...
		// Boss Spawners ---------------------------------
		AddBossSpawner(MonsterId.Boss_NetherBovine, "d_cmine_6", 1, Hours(2), Hours(4));
		AddBossSpawner(MonsterId.Boss_Mirtis, "d_cmine_6", 1, Hours(2), Hours(4));
	}
}
