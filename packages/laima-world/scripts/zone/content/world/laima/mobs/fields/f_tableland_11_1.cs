...
public class FTableland111MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("f_tableland_11_1.Id3", MonsterId.Repusbunny_Mage_Green, min: 15, max: 20, respawn: Minutes(1), tendency: TendencyType.Aggressive);
		AddSpawner("f_tableland_11_1.Id4", MonsterId.Groll_White, min: 19, max: 25, respawn: Minutes(1), tendency: TendencyType.Aggressive);
		AddSpawner("f_tableland_11_1.Id5", MonsterId.Groll_White, min: 30, max: 40, respawn: Minutes(1), tendency: TendencyType.Aggressive);
		...
		// Boss Spawners ---------------------------------
		AddBossSpawner(MonsterId.Boss_Armaox, "f_tableland_11_1", 1, Hours(2), Hours(4));
	}
}
