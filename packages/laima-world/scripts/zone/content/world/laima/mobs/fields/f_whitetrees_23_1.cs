...
public class FWhitetrees231MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("f_whitetrees_23_1.Id2", MonsterId.Kucarry_Somy, min: 8, max: 12);
		AddSpawner("f_whitetrees_23_1.Id3", MonsterId.Kucarry_Somy, min: 8, max: 12);
		AddSpawner("f_whitetrees_23_1.Id4", MonsterId.Kucarry_Tot, min: 6, max: 12);
		AddSpawner("f_whitetrees_23_1.Id5", MonsterId.Kucarry_Lioni, min: 4, max: 8);
		AddSpawner("f_whitetrees_23_1.Id6", MonsterId.Kucarry_Lioni, min: 4, max: 6);
		AddSpawner("f_whitetrees_23_1.Id7", MonsterId.Kucarry_Somy, min: 4, max: 8);
		AddSpawner("f_whitetrees_23_1.Id8", MonsterId.Kucarry_Tot, min: 6, max: 12);
		AddSpawner("f_whitetrees_23_1.Id9", MonsterId.Kucarry_Lioni, min: 4, max: 8);
		AddSpawner("f_whitetrees_23_1.Id10", MonsterId.Kucarry_Somy, min: 4, max: 8);
