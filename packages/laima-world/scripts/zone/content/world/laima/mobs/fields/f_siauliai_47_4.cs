...
public class FSiauliai474MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("f_siauliai_47_4.Id1", MonsterId.Haming_Orange, min: 40, max: 50);
		AddSpawner("f_siauliai_47_4.Id2", MonsterId.Popolion_Orange, min: 18, max: 25);
		AddSpawner("f_siauliai_47_4.Id3", MonsterId.Popolion_Orange, min: 18, max: 25);
		...
		AddSpawner("f_siauliai_47_4.Id6", MonsterId.Spion_Mage, min: 8, max: 10, respawn: Minutes(1));
