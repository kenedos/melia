...
public class FWhitetrees212MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("f_whitetrees_21_2.Id1", MonsterId.Kucarry_Symbani, min: 8, max: 14);
		AddSpawner("f_whitetrees_21_2.Id2", MonsterId.Kucarry_Balzer, min: 8, max: 14);
		AddSpawner("f_whitetrees_21_2.Id3", MonsterId.Kucarry_Zeffi, min: 8, max: 14);
		AddSpawner("f_whitetrees_21_2.Id4", MonsterId.Kucarry_Zeffi, min: 8, max: 14);
		AddSpawner("f_whitetrees_21_2.Id5", MonsterId.Kucarry_Balzer, min: 7, max: 12);
		AddSpawner("f_whitetrees_21_2.Id6", MonsterId.Kucarry_Symbani, min: 8, max: 14);
		AddSpawner("f_whitetrees_21_2.Id7", MonsterId.Kucarry_Zeffi, min: 10, max: 15);
