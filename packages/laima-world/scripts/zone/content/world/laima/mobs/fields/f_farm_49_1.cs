...
public class FFarm491MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("f_farm_49_1.Id1", MonsterId.Lizardman_Orange, min: 12, max: 15, respawn: Seconds(5), tendency: TendencyType.Aggressive);
		AddSpawner("f_farm_49_1.Id2", MonsterId.Lizardman_Orange, min: 15, max: 20, respawn: Seconds(5), tendency: TendencyType.Aggressive);
		AddSpawner("f_farm_49_1.Id3", MonsterId.Tama_Orange, min: 19, max: 25, tendency: TendencyType.Peaceful);
		AddSpawner("f_farm_49_1.Id4", MonsterId.Tama_Orange, min: 23, max: 30, tendency: TendencyType.Peaceful);
		AddSpawner("f_farm_49_1.Id5", MonsterId.Rambear_Bow, min: 12, max: 15, respawn: Seconds(20), tendency: TendencyType.Peaceful);
		AddSpawner("f_farm_49_1.Id6", MonsterId.Rootcrystal_01, min: 9, max: 12, respawn: Seconds(5), tendency: TendencyType.Peaceful);
		AddSpawner("f_farm_49_1.Id7", MonsterId.Spion_Blue, min: 15, max: 32, respawn: Seconds(5), tendency: TendencyType.Peaceful);
		AddSpawner("f_farm_49_1.Id8", MonsterId.Spion_Bow_Blue, min: 10, max: 26, respawn: Seconds(5), tendency: TendencyType.Peaceful);
		AddSpawner("f_farm_49_1.Id9", MonsterId.Spion_Mage_Blue, min: 5, max: 16, respawn: Seconds(5), tendency: TendencyType.Peaceful);
		...
		AddSpawnPoint("f_farm_49_1.Id7", "f_farm_49_1", Rectangle(1688, 731, 250));
		AddSpawnPoint("f_farm_49_1.Id7", "f_farm_49_1", Rectangle(1504, -130, 250));
		AddSpawnPoint("f_farm_49_1.Id7", "f_farm_49_1", Rectangle(466, 859, 250));
		AddSpawnPoint("f_farm_49_1.Id7", "f_farm_49_1", Rectangle(788, -429, 250));
		AddSpawnPoint("f_farm_49_1.Id7", "f_farm_49_1", Rectangle(-147, -495, 250));
		AddSpawnPoint("f_farm_49_1.Id7", "f_farm_49_1", Rectangle(-864, -1314, 250));
		AddSpawnPoint("f_farm_49_1.Id7", "f_farm_49_1", Rectangle(-1872, 224, 250));
		AddSpawnPoint("f_farm_49_1.Id7", "f_farm_49_1", Rectangle(-1088, 317, 250));

		// 'Spion_Bow_Blue' Spawn Points
		AddSpawnPoint("f_farm_49_1.Id8", "f_farm_49_1", Rectangle(1688, 731, 250));
		AddSpawnPoint("f_farm_49_1.Id8", "f_farm_49_1", Rectangle(1504, -130, 250));
		AddSpawnPoint("f_farm_49_1.Id8", "f_farm_49_1", Rectangle(466, 859, 250));
		AddSpawnPoint("f_farm_49_1.Id8", "f_farm_49_1", Rectangle(788, -429, 250));
		AddSpawnPoint("f_farm_49_1.Id8", "f_farm_49_1", Rectangle(-147, -495, 250));
		AddSpawnPoint("f_farm_49_1.Id8", "f_farm_49_1", Rectangle(-864, -1314, 250));
		AddSpawnPoint("f_farm_49_1.Id8", "f_farm_49_1", Rectangle(-1872, 224, 250));
		AddSpawnPoint("f_farm_49_1.Id8", "f_farm_49_1", Rectangle(-1088, 317, 250));

		// 'Spion_Mage_Blue' Spawn Points
		AddSpawnPoint("f_farm_49_1.Id9", "f_farm_49_1", Rectangle(1688, 731, 250));
		AddSpawnPoint("f_farm_49_1.Id9", "f_farm_49_1", Rectangle(1504, -130, 250));
		AddSpawnPoint("f_farm_49_1.Id9", "f_farm_49_1", Rectangle(466, 859, 250));
		AddSpawnPoint("f_farm_49_1.Id9", "f_farm_49_1", Rectangle(788, -429, 250));
		AddSpawnPoint("f_farm_49_1.Id9", "f_farm_49_1", Rectangle(-147, -495, 250));
		AddSpawnPoint("f_farm_49_1.Id9", "f_farm_49_1", Rectangle(-864, -1314, 250));
		AddSpawnPoint("f_farm_49_1.Id9", "f_farm_49_1", Rectangle(-1872, 224, 250));
		AddSpawnPoint("f_farm_49_1.Id9", "f_farm_49_1", Rectangle(-1088, 317, 250));
	}
}
