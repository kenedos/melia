...
public class DThorn392MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("d_thorn_39_2.Id1", MonsterId.Rootcrystal_01, min: 7, max: 9, respawn: Seconds(5));
		...
		AddSpawner("d_thorn_39_2.Id6", MonsterId.Chafperor, min: 15, max: 20);
		...
		AddSpawnPoint("d_thorn_39_2.Id6", "d_thorn_39_2", Rectangle(341, 1065, 200));
		AddSpawnPoint("d_thorn_39_2.Id6", "d_thorn_39_2", Rectangle(1350, 392, 200));
		AddSpawnPoint("d_thorn_39_2.Id6", "d_thorn_39_2", Rectangle(649, -370, 200));
		AddSpawnPoint("d_thorn_39_2.Id6", "d_thorn_39_2", Rectangle(-361, -321, 200));
	}
}
