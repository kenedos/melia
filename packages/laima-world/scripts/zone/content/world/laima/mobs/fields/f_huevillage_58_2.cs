...
public class FHuevillage582MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		// Boss Spawners ---------------------------------
		AddBossSpawner(MonsterId.Boss_Moldyhorn, "f_huevillage_58_2", 1, Hours(2), Hours(4));
		AddBossSpawner(MonsterId.Boss_Woodspirit_Blue, "f_huevillage_58_2", 1, Hours(2), Hours(4));
		AddBossSpawner(MonsterId.Boss_Moyabruka, "f_huevillage_58_2", 1, Hours(2), Hours(4));
		AddBossSpawner(MonsterId.Boss_Merregina, "f_huevillage_58_2", 1, Hours(2), Hours(4));
	}
}
