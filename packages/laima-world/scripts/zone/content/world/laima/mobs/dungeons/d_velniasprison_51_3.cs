...
public class DVelniasprison513MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("d_velniasprison_51_3.Id7", MonsterId.Hohen_Ritter, min: 4, max: 8, respawn: Seconds(60), tendency: TendencyType.Aggressive);
		AddSpawner("d_velniasprison_51_3.Id8", MonsterId.Hohen_Barkle, min: 4, max: 8, respawn: Seconds(60), tendency: TendencyType.Aggressive);
		AddSpawner("d_velniasprison_51_3.Id9", MonsterId.Hohen_Mane, min: 8, max: 16, respawn: Seconds(60), tendency: TendencyType.Aggressive);

		AddSpawner("d_velniasprison_51_3.Id10", MonsterId.Hohen_Ritter, min: 8, max: 16, respawn: Seconds(60), tendency: TendencyType.Aggressive);
		AddSpawner("d_velniasprison_51_3.Id11", MonsterId.Hohen_Barkle, min: 4, max: 8, respawn: Seconds(60), tendency: TendencyType.Aggressive);
		AddSpawner("d_velniasprison_51_3.Id12", MonsterId.Hohen_Mane, min: 4, max: 8, respawn: Seconds(60), tendency: TendencyType.Aggressive);

		AddSpawner("d_velniasprison_51_3.Id13", MonsterId.Hohen_Ritter, min: 4, max: 8, respawn: Seconds(60), tendency: TendencyType.Aggressive);
		AddSpawner("d_velniasprison_51_3.Id14", MonsterId.Hohen_Barkle, min: 8, max: 16, respawn: Seconds(60), tendency: TendencyType.Aggressive);
		AddSpawner("d_velniasprison_51_3.Id15", MonsterId.Hohen_Mane, min: 4, max: 8, respawn: Seconds(60), tendency: TendencyType.Aggressive);

		AddSpawner("d_velniasprison_51_3.Id16", MonsterId.Hohen_Ritter, min: 4, max: 8, respawn: Seconds(60), tendency: TendencyType.Aggressive);
		AddSpawner("d_velniasprison_51_3.Id17", MonsterId.Hohen_Barkle, min: 4, max: 8, respawn: Seconds(60), tendency: TendencyType.Aggressive);
		AddSpawner("d_velniasprison_51_3.Id18", MonsterId.Hohen_Mane, min: 8, max: 16, respawn: Seconds(60), tendency: TendencyType.Aggressive);

		AddSpawner("d_velniasprison_51_3.Id19", MonsterId.Hohen_Mane, min: 8, max: 16, respawn: Seconds(60), tendency: TendencyType.Aggressive);
		AddSpawner("d_velniasprison_51_3.Id20", MonsterId.Hohen_Barkle, min: 8, max: 16, respawn: Seconds(60), tendency: TendencyType.Aggressive);
		AddSpawner("d_velniasprison_51_3.Id21", MonsterId.Hohen_Ritter, min: 8, max: 16, respawn: Seconds(60), tendency: TendencyType.Aggressive);
		AddSpawner("d_velniasprison_51_3.Id22", MonsterId.Hohen_Mane, min: 8, max: 16, respawn: Seconds(60), tendency: TendencyType.Aggressive);
		AddSpawner("d_velniasprison_51_3.Id23", MonsterId.Hohen_Barkle, min: 8, max: 16, respawn: Seconds(60), tendency: TendencyType.Aggressive);
		AddSpawner("d_velniasprison_51_3.Id24", MonsterId.Hohen_Ritter, min: 8, max: 16, respawn: Seconds(60), tendency: TendencyType.Aggressive);
		...
		// Ishidevi Hideout Spawn Points
		AddSpawnPoint("d_velniasprison_51_3.Id7", "d_velniasprison_51_3", Rectangle(2191, 405, 500));
		AddSpawnPoint("d_velniasprison_51_3.Id8", "d_velniasprison_51_3", Rectangle(2191, 405, 500));
		AddSpawnPoint("d_velniasprison_51_3.Id9", "d_velniasprison_51_3", Rectangle(2191, 405, 500));

		// Galutin Solitary Confinement Spawn Points
		AddSpawnPoint("d_velniasprison_51_3.Id10", "d_velniasprison_51_3", Rectangle(1037, 344, 500));
		AddSpawnPoint("d_velniasprison_51_3.Id11", "d_velniasprison_51_3", Rectangle(1037, 344, 500));
		AddSpawnPoint("d_velniasprison_51_3.Id12", "d_velniasprison_51_3", Rectangle(1037, 344, 500));

		// Indiga Solitary Confinement Spawn Points
		AddSpawnPoint("d_velniasprison_51_3.Id13", "d_velniasprison_51_3", Rectangle(-1494, 344, 500));
		AddSpawnPoint("d_velniasprison_51_3.Id14", "d_velniasprison_51_3", Rectangle(-1494, 344, 500));
		AddSpawnPoint("d_velniasprison_51_3.Id15", "d_velniasprison_51_3", Rectangle(-1494, 344, 500));

		// Aklaga Isolation Area Spawn Points
		AddSpawnPoint("d_velniasprison_51_3.Id16", "d_velniasprison_51_3", Rectangle(-2534, 319, 500));
		AddSpawnPoint("d_velniasprison_51_3.Id17", "d_velniasprison_51_3", Rectangle(-2534, 319, 500));
		AddSpawnPoint("d_velniasprison_51_3.Id18", "d_velniasprison_51_3", Rectangle(-2534, 319, 500));

		// 'Hohen_Mane' Spawn Points
		AddSpawnPoint("d_velniasprison_51_3.Id19", "d_velniasprison_51_3", Rectangle(2216, -1077, 500));

		// 'Hohen_Barkle' Spawn Points
		AddSpawnPoint("d_velniasprison_51_3.Id20", "d_velniasprison_51_3", Rectangle(2249, -222, 500));

		// 'Hohen_Ritter' Spawn Points
		AddSpawnPoint("d_velniasprison_51_3.Id21", "d_velniasprison_51_3", Rectangle(521, 471, 500));

		// 'Hohen_Mane' Spawn Points
		AddSpawnPoint("d_velniasprison_51_3.Id22", "d_velniasprison_51_3", Rectangle(-714, 482, 500));

		// 'Hohen_Barkle' Spawn Points
		AddSpawnPoint("d_velniasprison_51_3.Id23", "d_velniasprison_51_3", Rectangle(-2491, -289, 500));

		// 'Hohen_Ritter' Spawn Points
		AddSpawnPoint("d_velniasprison_51_3.Id24", "d_velniasprison_51_3", Rectangle(-2500, -1106, 500));
	}
}
