...
public class FTableland282MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("f_tableland_28_2.Id5", MonsterId.Lapasape_Blue, min: 30, max: 40, tendency: TendencyType.Aggressive);
		...
		// Boss Spawners ---------------------------------
		AddBossSpawner(MonsterId.Boss_Sparnashorn_Blue, "f_tableland_28_2", 1, Hours(2), Hours(4));
	}
}
