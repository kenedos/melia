...
public class DThorn21MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("d_thorn_21.Id10", MonsterId.Bagworm, min: 12, max: 18);
		...
		AddSpawnPoint("d_thorn_21.Id10", "d_thorn_21", Rectangle(798, 95, 200));
		AddSpawnPoint("d_thorn_21.Id10", "d_thorn_21", Rectangle(5772, -199, 200));

		// Boss Spawners ---------------------------------
		AddBossSpawner(MonsterId.Boss_Gaigalas, "d_thorn_21", 1, Hours(2), Hours(4));
		AddBossSpawner(MonsterId.Boss_Honeypin, "d_thorn_21", 1, Hours(2), Hours(4));
		AddBossSpawner(MonsterId.Boss_Molich, "d_thorn_21", 1, Hours(2), Hours(4));
		AddBossSpawner(MonsterId.Boss_Bramble, "d_thorn_21", 1, Hours(2), Hours(4));
	}
}
