...
public class FRemains38MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("f_remains_38.Id2", MonsterId.Lizardman, min: 8, max: 10, tendency: TendencyType.Aggressive);
		AddSpawner("f_remains_38.Id3", MonsterId.Long_Arm, min: 8, max: 10);
		AddSpawner("f_remains_38.Id4", MonsterId.Lizardman, min: 8, max: 10, tendency: TendencyType.Aggressive);
		AddSpawner("f_remains_38.Id5", MonsterId.Lizardman, min: 15, max: 20, tendency: TendencyType.Aggressive);
		...
		// Boss Spawners ---------------------------------
		AddBossSpawner(MonsterId.Boss_Moa, "f_remains_38", 1, Hours(2), Hours(4));
		AddBossSpawner(MonsterId.Boss_Devilglove, "f_remains_38", 1, Hours(2), Hours(4));
	}
}
