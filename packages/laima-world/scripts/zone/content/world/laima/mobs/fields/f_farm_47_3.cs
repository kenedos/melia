...
public class FFarm473MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("f_farm_47_3.Id1", MonsterId.Kepo_Seed_Violet, min: 25, max: 30);
		AddSpawner("f_farm_47_3.Id2", MonsterId.Ellom_Violet, min: 60, max: 80);
		AddSpawner("f_farm_47_3.Id3", MonsterId.Kepo_Seed_Violet, min: 25, max: 30);
		AddSpawner("f_farm_47_3.Id4", MonsterId.Rootcrystal_01, min: 23, max: 30, respawn: Minutes(1));
		AddSpawner("f_farm_47_3.Id5", MonsterId.Cronewt_Bow, min: 7, max: 10);
		AddSpawner("f_farm_47_3.Id6", MonsterId.Operor_White, min: 10, max: 12);
