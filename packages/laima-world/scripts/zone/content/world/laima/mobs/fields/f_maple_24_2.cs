...
public class FMaple242MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("f_maple_24_2.Id1", MonsterId.Kucarry_Zeuni, min: 19, max: 25);
		AddSpawner("f_maple_24_2.Id2", MonsterId.Kucarry_Numani, min: 48, max: 63);
		AddSpawner("f_maple_24_2.Id3", MonsterId.Kucarry_Zabbi, min: 46, max: 61);
		AddSpawner("f_maple_24_2.Id4", MonsterId.Rootcrystal_01, min: 19, max: 25, respawn: Seconds(20));
