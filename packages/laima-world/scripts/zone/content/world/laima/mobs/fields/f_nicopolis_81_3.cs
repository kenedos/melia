...
public class FNicopolis813MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("f_nicopolis_81_3.Id5", MonsterId.Rootcrystal_02, min: 15, max: 20, respawn: Seconds(30));
		...
		// Boss Spawners ---------------------------------
		AddBossSpawner(MonsterId.Boss_Quipmage, "f_nicopolis_81_3", 1, Hours(2), Hours(4));
	}
}
