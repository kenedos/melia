...
public class FGele572MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("f_gele_57_2.Id1", MonsterId.Leafly, min: 12, max: 15);
		AddSpawner("f_gele_57_2.Id2", MonsterId.Npanto_Hand, min: 12, max: 15);
		AddSpawner("f_gele_57_2.Id3", MonsterId.Npanto_Sword, min: 8, max: 10);
		...
		AddSpawner("f_gele_57_2.Id9", MonsterId.Mon_Goat_Totem_Q, min: 8, max: 10, respawn: Seconds(15));
		...
		AddSpawner("f_gele_57_2.Id13", MonsterId.Leafly, min: 8, max: 10);
		...
		AddBossSpawner(MonsterId.Boss_Simorph, "f_gele_57_2", 1, Hours(2), Hours(4));
	}
}
