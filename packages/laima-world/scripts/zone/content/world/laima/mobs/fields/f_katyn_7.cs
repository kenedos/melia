...
public class FKatyn7MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		// AddSpawner("f_katyn_7.Id5", MonsterId.Ellom, min: 6, max: 7);
		// AddSpawner("f_katyn_7.Id6", MonsterId.Pappus_Kepa, min: 9, max: 12);
		...
		// Boss Spawners ---------------------------------
		// AddBossSpawner(MonsterId.Boss_Deadbone, "f_katyn_7", 1, Hours(2), Hours(4));
		// AddBossSpawner(MonsterId.Boss_Saltistter, "f_katyn_7", 1, Hours(2), Hours(4));
