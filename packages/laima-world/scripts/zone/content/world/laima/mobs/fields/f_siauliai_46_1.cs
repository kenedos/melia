...
public class FSiauliai461MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("f_siauliai_46_1.Id2", MonsterId.Shardstatue, min: 9, max: 12, tendency: TendencyType.Aggressive);
		AddSpawner("f_siauliai_46_1.Id3", MonsterId.Shardstatue, min: 23, max: 30, tendency: TendencyType.Aggressive);
