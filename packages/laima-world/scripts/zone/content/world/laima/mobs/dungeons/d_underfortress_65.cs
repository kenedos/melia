...
public class DUnderfortress65MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("d_underfortress_65.Id2", MonsterId.Ticen_Blue, min: 40, max: 50, tendency: TendencyType.Peaceful);
		AddSpawner("d_underfortress_65.Id3", MonsterId.Ticen_Bow_Blue, min: 24, max: 30, tendency: TendencyType.Aggressive);
		AddSpawner("d_underfortress_65.Id4", MonsterId.Socket_Red, min: 26, max: 40, tendency: TendencyType.Aggressive);
		AddSpawner("d_underfortress_65.Id9", MonsterId.Socket_Bow_Purple, min: 16, max: 20, tendency: TendencyType.Aggressive);
