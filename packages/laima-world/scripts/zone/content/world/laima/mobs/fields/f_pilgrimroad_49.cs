...
public class FPilgrimroad49MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("f_pilgrimroad_49.Id2", MonsterId.Tiny_Brown, min: 23, max: 30);
		AddSpawner("f_pilgrimroad_49.Id3", MonsterId.Tiny_Bow_Green, min: 23, max: 30);
		AddSpawner("f_pilgrimroad_49.Id4", MonsterId.Tiny_Brown, min: 15, max: 20);
		AddSpawner("f_pilgrimroad_49.Id5", MonsterId.Tiny_Bow_Green, min: 23, max: 30);
		AddSpawner("f_pilgrimroad_49.Id6", MonsterId.Tiny_Mage, min: 12, max: 15);
		AddSpawner("f_pilgrimroad_49.Id7", MonsterId.Tiny_Bow_Green, min: 15, max: 20);
		AddSpawner("f_pilgrimroad_49.Id8", MonsterId.Tiny_Mage, min: 19, max: 25);
