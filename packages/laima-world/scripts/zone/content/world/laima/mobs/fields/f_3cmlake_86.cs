...
public class F3Cmlake86MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("f_3cmlake_86.Id1", MonsterId.Spinacho, min: 21, max: 28);
		AddSpawner("f_3cmlake_86.Id2", MonsterId.Rubeta, min: 14, max: 18);
		...
		AddSpawner("f_3cmlake_86.Id6", MonsterId.Rootcrystal_02, amount: 1, respawn: Seconds(20));
