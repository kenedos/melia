...
public class FCastle101MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("f_castle_101.Id2", MonsterId.Bower_Oblivion, min: 64, max: 85, respawn: Minutes(1));
		AddSpawner("f_castle_101.Id3", MonsterId.Bower_Interfere, min: 49, max: 65, respawn: Minutes(1));
		AddSpawner("f_castle_101.Id4", MonsterId.Bower_Obstructer, min: 38, max: 50, respawn: Minutes(1));
		AddSpawner("f_castle_101.Id5", MonsterId.Rootcrystal_01, min: 23, max: 30, respawn: Seconds(20));
		...
		// Boss Spawners ---------------------------------
		AddBossSpawner(MonsterId.Boss_BowerKeeper, "f_castle_101", 1, Hours(2), Hours(4));
	}
}
