...
public class FKatyn451MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("f_katyn_45_1.Id1", MonsterId.Stoulet_Bow_Blue, min: 38, max: 50, tendency: TendencyType.Aggressive);
		AddSpawner("f_katyn_45_1.Id2", MonsterId.Stoulet_Gray, min: 9, max: 12, tendency: TendencyType.Aggressive);
		AddSpawner("f_katyn_45_1.Id3", MonsterId.Socket_Mage_Green, min: 9, max: 12, tendency: TendencyType.Aggressive);
		AddSpawner("f_katyn_45_1.Id4", MonsterId.Stoulet_Gray, min: 8, max: 10, tendency: TendencyType.Aggressive);
		AddSpawner("f_katyn_45_1.Id5", MonsterId.Rootcrystal_04, min: 15, max: 19, respawn: Seconds(30), tendency: TendencyType.Peaceful);
		AddSpawner("f_katyn_45_1.Id6", MonsterId.Stoulet_Gray, min: 12, max: 15, tendency: TendencyType.Aggressive);
		AddSpawner("f_katyn_45_1.Id7", MonsterId.Stoulet_Bow_Blue, min: 30, max: 40, tendency: TendencyType.Aggressive);
