...
public class FPilgrimroad414MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("f_pilgrimroad_41_4.Id2", MonsterId.Repusbunny_Purple, min: 9, max: 12);
		...
		AddSpawner("f_pilgrimroad_41_4.Id5", MonsterId.Stub_Tree_Mage, min: 40, max: 60);
		...
		AddSpawnPoint("f_pilgrimroad_41_4.Id5", "f_pilgrimroad_41_4", Rectangle(-880, -604, 200));
		AddSpawnPoint("f_pilgrimroad_41_4.Id5", "f_pilgrimroad_41_4", Rectangle(-396, 148, 200));
		AddSpawnPoint("f_pilgrimroad_41_4.Id5", "f_pilgrimroad_41_4", Rectangle(425, -312, 200));
		AddSpawnPoint("f_pilgrimroad_41_4.Id5", "f_pilgrimroad_41_4", Rectangle(-202, -815, 200));
		AddSpawnPoint("f_pilgrimroad_41_4.Id5", "f_pilgrimroad_41_4", Rectangle(639, -1559, 200));
		AddSpawnPoint("f_pilgrimroad_41_4.Id5", "f_pilgrimroad_41_4", Rectangle(302, -1426, 200));
		AddSpawnPoint("f_pilgrimroad_41_4.Id5", "f_pilgrimroad_41_4", Rectangle(-37, 964, 200));
		AddSpawnPoint("f_pilgrimroad_41_4.Id5", "f_pilgrimroad_41_4", Rectangle(622, 693, 200));
		AddSpawnPoint("f_pilgrimroad_41_4.Id5", "f_pilgrimroad_41_4", Rectangle(1312, 95, 200));
		AddSpawnPoint("f_pilgrimroad_41_4.Id5", "f_pilgrimroad_41_4", Rectangle(1974, 26, 200));
		AddSpawnPoint("f_pilgrimroad_41_4.Id5", "f_pilgrimroad_41_4", Rectangle(1200, -782, 200));
		AddSpawnPoint("f_pilgrimroad_41_4.Id5", "f_pilgrimroad_41_4", Rectangle(1859, -1026, 200));
	}
}
