...
public class FSiauliai501MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("f_siauliai_50_1.Id1", MonsterId.Chupaluka_Pink, min: 9, max: 12, tendency: TendencyType.Peaceful);
		AddSpawner("f_siauliai_50_1.Id2", MonsterId.Sakmoli_Orange, min: 12, max: 15, tendency: TendencyType.Aggressive);
		AddSpawner("f_siauliai_50_1.Id3", MonsterId.Chupaluka_Pink, min: 8, max: 10, tendency: TendencyType.Peaceful);
		AddSpawner("f_siauliai_50_1.Id4", MonsterId.Ridimed_Purple, min: 6, max: 8, tendency: TendencyType.Peaceful);
		AddSpawner("f_siauliai_50_1.Id5", MonsterId.Sakmoli_Orange, min: 12, max: 15, tendency: TendencyType.Aggressive);
		...
		AddSpawner("f_siauliai_50_1.Id10", MonsterId.Sakmoli_Orange, min: 8, max: 10, tendency: TendencyType.Aggressive);
		...
		// Boss Spawners ---------------------------------
		AddBossSpawner(MonsterId.Boss_Gorgon, "f_siauliai_50_1", 1, Hours(2), Hours(4));
		AddBossSpawner(MonsterId.Boss_Poata, "f_siauliai_50_1", 1, Hours(2), Hours(4));
		AddBossSpawner(MonsterId.Boss_Tutu, "f_siauliai_50_1", 1, Hours(2), Hours(4));
	}
}
