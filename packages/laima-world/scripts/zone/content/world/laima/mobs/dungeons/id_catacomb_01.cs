...
public class IdCatacomb01MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("id_catacomb_01.Id1", MonsterId.FD_Leaf_Diving_Purple, min: 65, max: 80, respawn: Seconds(10), tendency: TendencyType.Aggressive);
		AddSpawner("id_catacomb_01.Id2", MonsterId.FD_Maggot, min: 62, max: 85, respawn: Seconds(10), tendency: TendencyType.Aggressive);
		AddSpawner("id_catacomb_01.Id3", MonsterId.FD_Mushcarfung, min: 45, max: 60, Seconds(25), tendency: TendencyType.Aggressive);
		...
		AddSpawner("id_catacomb_01.Id6", MonsterId.Cronewt_Bow_Brown, min: 9, max: 12, Seconds(25), tendency: TendencyType.Aggressive);
