...
public class DThorn391MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("d_thorn_39_1.Id1", MonsterId.Rootcrystal_01, min: 8, max: 10, respawn: Minutes(1));
		AddSpawner("d_thorn_39_1.Id2", MonsterId.Chafperor_Mage, min: 15, max: 20, tendency: TendencyType.Aggressive);
		AddSpawner("d_thorn_39_1.Id3", MonsterId.Wood_Lwa, min: 40, max: 50);
		AddSpawner("d_thorn_39_1.Id4", MonsterId.Infrogalas_Mage, min: 16, max: 20);
		AddSpawner("d_thorn_39_1.Id5", MonsterId.Pandroceum, min: 50, max: 60);
		AddSpawner("d_thorn_39_1.Id6", MonsterId.TreeGool, min: 20, max: 30, tendency: TendencyType.Aggressive);
		...
		AddSpawnPoint("d_thorn_39_1.Id6", "d_thorn_39_1", Rectangle(-2278, 932, 50));
		AddSpawnPoint("d_thorn_39_1.Id6", "d_thorn_39_1", Rectangle(-1803, 1271, 50));
		AddSpawnPoint("d_thorn_39_1.Id6", "d_thorn_39_1", Rectangle(-1213, 586, 50));
		AddSpawnPoint("d_thorn_39_1.Id6", "d_thorn_39_1", Rectangle(1527, 797, 50));
		AddSpawnPoint("d_thorn_39_1.Id6", "d_thorn_39_1", Rectangle(201, -1132, 50));
	}
}
