...
public class FDcapital105MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("f_dcapital_105.Id1", MonsterId.Rootcrystal_01, min: 27, max: 35, respawn: Seconds(25));
		...
		AddSpawner("f_dcapital_105.Id6", MonsterId.Bishopstar, min: 6, max: 7, respawn: Seconds(20));
		AddSpawner("f_dcapital_105.Id7", MonsterId.Bishopstar, amount: 3, respawn: Seconds(20));
