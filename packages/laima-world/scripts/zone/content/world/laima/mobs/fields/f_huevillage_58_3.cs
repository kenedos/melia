...
public class FHuevillage583MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("f_huevillage_58_3.Id4", MonsterId.Rootcrystal_01, min: 9, max: 12, respawn: Seconds(30));
		...
		AddSpawner("f_huevillage_58_3.Id7", MonsterId.Tipio, min: 35, max: 50);
		AddSpawner("f_huevillage_58_3.Id8", MonsterId.Doyor, min: 25, max: 40);
		...
		// 'Tipio' Spawn Points
		AddSpawnPoint("f_huevillage_58_3.Id7", "f_huevillage_58_3", Rectangle(-1440, -1289, 30));
		AddSpawnPoint("f_huevillage_58_3.Id7", "f_huevillage_58_3", Rectangle(-1294, -1190, 30));
		AddSpawnPoint("f_huevillage_58_3.Id7", "f_huevillage_58_3", Rectangle(-1266, -1330, 30));
		AddSpawnPoint("f_huevillage_58_3.Id7", "f_huevillage_58_3", Rectangle(-666, -845, 30));
		AddSpawnPoint("f_huevillage_58_3.Id7", "f_huevillage_58_3", Rectangle(-671, -1063, 30));
		AddSpawnPoint("f_huevillage_58_3.Id7", "f_huevillage_58_3", Rectangle(-348, -564, 30));
		AddSpawnPoint("f_huevillage_58_3.Id7", "f_huevillage_58_3", Rectangle(-246, 90, 30));
		AddSpawnPoint("f_huevillage_58_3.Id7", "f_huevillage_58_3", Rectangle(53, 378, 30));
		AddSpawnPoint("f_huevillage_58_3.Id7", "f_huevillage_58_3", Rectangle(1174, -264, 30));
		AddSpawnPoint("f_huevillage_58_3.Id7", "f_huevillage_58_3", Rectangle(1088, -418, 30));
		AddSpawnPoint("f_huevillage_58_3.Id7", "f_huevillage_58_3", Rectangle(1817, -265, 30));
		AddSpawnPoint("f_huevillage_58_3.Id7", "f_huevillage_58_3", Rectangle(1861, -470, 30));
		AddSpawnPoint("f_huevillage_58_3.Id7", "f_huevillage_58_3", Rectangle(1804, -594, 30));
		AddSpawnPoint("f_huevillage_58_3.Id7", "f_huevillage_58_3", Rectangle(1595, -865, 30));

		// 'Doyor' Spawn Points
		AddSpawnPoint("f_huevillage_58_3.Id8", "f_huevillage_58_3", Rectangle(972, -1048, 30));
		AddSpawnPoint("f_huevillage_58_3.Id8", "f_huevillage_58_3", Rectangle(1825, -709, 30));
		AddSpawnPoint("f_huevillage_58_3.Id8", "f_huevillage_58_3", Rectangle(1904, -469, 30));
		AddSpawnPoint("f_huevillage_58_3.Id8", "f_huevillage_58_3", Rectangle(1711, -213, 30));
		AddSpawnPoint("f_huevillage_58_3.Id8", "f_huevillage_58_3", Rectangle(956, -1000, 30));
		AddSpawnPoint("f_huevillage_58_3.Id8", "f_huevillage_58_3", Rectangle(346, -672, 30));
		AddSpawnPoint("f_huevillage_58_3.Id8", "f_huevillage_58_3", Rectangle(192, -638, 30));
		AddSpawnPoint("f_huevillage_58_3.Id8", "f_huevillage_58_3", Rectangle(342, -1337, 30));
		AddSpawnPoint("f_huevillage_58_3.Id8", "f_huevillage_58_3", Rectangle(302, -1505, 30));
		AddSpawnPoint("f_huevillage_58_3.Id8", "f_huevillage_58_3", Rectangle(394, -1456, 30));

		// Boss Spawners ---------------------------------
		AddBossSpawner(MonsterId.Boss_Colimencia, "f_huevillage_58_3", 1, Hours(2), Hours(4));
	}
}
