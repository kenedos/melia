...
public class DFiretower41MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("d_firetower_41.Id1", MonsterId.Fire_Dragon, min: 16, max: 20, tendency: TendencyType.Aggressive);
		AddSpawner("d_firetower_41.Id2", MonsterId.Flight_Hope, min: 12, max: 18, tendency: TendencyType.Aggressive);
		AddSpawner("d_firetower_41.Id3", MonsterId.Rootcrystal_01, min: 7, max: 9, respawn: Seconds(30), tendency: TendencyType.Peaceful);
		AddSpawner("d_firetower_41.Id4", MonsterId.Fire_Dragon, min: 16, max: 20, tendency: TendencyType.Aggressive);
		AddSpawner("d_firetower_41.Id5", MonsterId.Flight_Hope, min: 8, max: 12, tendency: TendencyType.Aggressive);
		AddSpawner("d_firetower_41.Id6", MonsterId.Rubblem, min: 18, max: 22, tendency: TendencyType.Aggressive);
		AddSpawner("d_firetower_41.Id7", MonsterId.Armory, min: 19, max: 30, tendency: TendencyType.Aggressive);
		AddSpawner("d_firetower_41.Id8", MonsterId.Rubblem, min: 18, max: 22, tendency: TendencyType.Aggressive);
		AddSpawner("d_firetower_41.Id9", MonsterId.Flight_Hope, min: 8, max: 10, tendency: TendencyType.Aggressive);
		AddSpawner("d_firetower_41.Id10", MonsterId.Rudasjack, min: 18, max: 22, tendency: TendencyType.Aggressive);
		AddSpawner("d_firetower_41.Id11", MonsterId.Fire_Dragon, min: 22, max: 34, tendency: TendencyType.Aggressive);
		...
		AddSpawnPoint("d_firetower_41.Id11", "d_firetower_41", Rectangle(-561, -1868, 200));
		AddSpawnPoint("d_firetower_41.Id11", "d_firetower_41", Rectangle(-1602, -1391, 200));
		AddSpawnPoint("d_firetower_41.Id11", "d_firetower_41", Rectangle(2084, -1411, 200));
	}
}
