...
public class FBracken421MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("f_bracken_42_1.Id7", MonsterId.Tanu, min: 50, max: 70);
		...
		// 'Tanu' Spawn Points
		AddSpawnPoint("f_bracken_42_1.Id7", "f_bracken_42_1", Rectangle(159, -127, 9999));
		AddSpawnPoint("f_bracken_42_1.Id7", "f_bracken_42_1", Rectangle(963, 563, 9999));
		AddSpawnPoint("f_bracken_42_1.Id7", "f_bracken_42_1", Rectangle(-492, 118, 9999));
	}
}
