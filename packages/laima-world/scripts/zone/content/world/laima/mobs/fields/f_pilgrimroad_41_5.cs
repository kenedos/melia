...
public class FPilgrimroad415MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("f_pilgrimroad_41_5.Id6", MonsterId.Deadbornscab_Bow, min: 30, max: 40);
		...
		AddSpawnPoint("f_pilgrimroad_41_5.Id6", "f_pilgrimroad_41_5", Rectangle(-94, 29, 200));
		AddSpawnPoint("f_pilgrimroad_41_5.Id6", "f_pilgrimroad_41_5", Rectangle(896, -417, 200));
		AddSpawnPoint("f_pilgrimroad_41_5.Id6", "f_pilgrimroad_41_5", Rectangle(1242, -992, 200));
		AddSpawnPoint("f_pilgrimroad_41_5.Id6", "f_pilgrimroad_41_5", Rectangle(5, -858, 200));
		AddSpawnPoint("f_pilgrimroad_41_5.Id6", "f_pilgrimroad_41_5", Rectangle(-875, 215, 200));
		AddSpawnPoint("f_pilgrimroad_41_5.Id6", "f_pilgrimroad_41_5", Rectangle(-886, -432, 200));
		AddSpawnPoint("f_pilgrimroad_41_5.Id6", "f_pilgrimroad_41_5", Rectangle(-1095, -1032, 200));
		AddSpawnPoint("f_pilgrimroad_41_5.Id6", "f_pilgrimroad_41_5", Rectangle(-268, 867, 200));
		AddSpawnPoint("f_pilgrimroad_41_5.Id6", "f_pilgrimroad_41_5", Rectangle(692, 384, 200));
		AddSpawnPoint("f_pilgrimroad_41_5.Id6", "f_pilgrimroad_41_5", Rectangle(1291, 225, 200));
	}
}
