...
public class FRokas26MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("f_rokas_26.Id1", MonsterId.Rootcrystal_05, min: 12, max: 16, respawn: Seconds(5));
		...
		// Boss Spawners ---------------------------------
		AddBossSpawner(MonsterId.Boss_Shnayim, "f_rokas_26", 1, Hours(2), Hours(4));
		AddBossSpawner(MonsterId.Boss_Denoptic, "f_rokas_26", 1, Hours(2), Hours(4));
	}
}
