...
public class FOrchard343MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("f_orchard_34_3.Id2", MonsterId.Rafflesia_Green, min: 11, max: 14, tendency: TendencyType.Aggressive);
		AddSpawner("f_orchard_34_3.Id3", MonsterId.Siaulav_Bow_Orange, min: 40, max: 60);
		AddSpawner("f_orchard_34_3.Id4", MonsterId.Flying_Flog_White, min: 60, max: 80);
		AddSpawner("f_orchard_34_3.Id5", MonsterId.Rafflesia_Green, min: 19, max: 25, tendency: TendencyType.Aggressive);
		...
		// 'Siaulav_Orange_Bow' GenType 28 Spawn Points
		AddSpawnPoint("f_orchard_34_3.Id3", "f_orchard_34_3", Rectangle(-1420, 549, 30));
		AddSpawnPoint("f_orchard_34_3.Id3", "f_orchard_34_3", Rectangle(-1255, 608, 30));
		AddSpawnPoint("f_orchard_34_3.Id3", "f_orchard_34_3", Rectangle(-657, 608, 30));
		AddSpawnPoint("f_orchard_34_3.Id3", "f_orchard_34_3", Rectangle(-535, 479, 30));
		AddSpawnPoint("f_orchard_34_3.Id3", "f_orchard_34_3", Rectangle(-399, 643, 30));
		AddSpawnPoint("f_orchard_34_3.Id3", "f_orchard_34_3", Rectangle(-76, 503, 30));
		AddSpawnPoint("f_orchard_34_3.Id3", "f_orchard_34_3", Rectangle(89, 670, 30));
		AddSpawnPoint("f_orchard_34_3.Id3", "f_orchard_34_3", Rectangle(-137, 145, 30));
		AddSpawnPoint("f_orchard_34_3.Id3", "f_orchard_34_3", Rectangle(660, 610, 30));
		AddSpawnPoint("f_orchard_34_3.Id3", "f_orchard_34_3", Rectangle(1251, 575, 30));
		AddSpawnPoint("f_orchard_34_3.Id3", "f_orchard_34_3", Rectangle(1385, 736, 30));
		AddSpawnPoint("f_orchard_34_3.Id3", "f_orchard_34_3", Rectangle(1192, -112, 30));
		AddSpawnPoint("f_orchard_34_3.Id3", "f_orchard_34_3", Rectangle(1152, -325, 30));
		AddSpawnPoint("f_orchard_34_3.Id3", "f_orchard_34_3", Rectangle(912, -348, 30));
		AddSpawnPoint("f_orchard_34_3.Id3", "f_orchard_34_3", Rectangle(1617, -212, 30));
		AddSpawnPoint("f_orchard_34_3.Id3", "f_orchard_34_3", Rectangle(1784, -218, 30));
		AddSpawnPoint("f_orchard_34_3.Id3", "f_orchard_34_3", Rectangle(900, -998, 30));
		AddSpawnPoint("f_orchard_34_3.Id3", "f_orchard_34_3", Rectangle(1129, -867, 30));
		AddSpawnPoint("f_orchard_34_3.Id3", "f_orchard_34_3", Rectangle(403, -575, 30));
		AddSpawnPoint("f_orchard_34_3.Id3", "f_orchard_34_3", Rectangle(340, -749, 30));
		AddSpawnPoint("f_orchard_34_3.Id3", "f_orchard_34_3", Rectangle(-307, -1010, 30));
		AddSpawnPoint("f_orchard_34_3.Id3", "f_orchard_34_3", Rectangle(-274, -758, 30));
		AddSpawnPoint("f_orchard_34_3.Id3", "f_orchard_34_3", Rectangle(-264, -254, 30));
		AddSpawnPoint("f_orchard_34_3.Id3", "f_orchard_34_3", Rectangle(-615, -231, 30));
		AddSpawnPoint("f_orchard_34_3.Id3", "f_orchard_34_3", Rectangle(-1090, -300, 30));
		AddSpawnPoint("f_orchard_34_3.Id3", "f_orchard_34_3", Rectangle(-1185, -222, 30));
		AddSpawnPoint("f_orchard_34_3.Id3", "f_orchard_34_3", Rectangle(-1541, -785, 30));
		AddSpawnPoint("f_orchard_34_3.Id3", "f_orchard_34_3", Rectangle(-1469, -1044, 30));
		AddSpawnPoint("f_orchard_34_3.Id3", "f_orchard_34_3", Rectangle(-1557, -272, 30));
		AddSpawnPoint("f_orchard_34_3.Id3", "f_orchard_34_3", Rectangle(-1729, -266, 30));
		AddSpawnPoint("f_orchard_34_3.Id3", "f_orchard_34_3", Rectangle(-1699, -395, 30));
		AddSpawnPoint("f_orchard_34_3.Id3", "f_orchard_34_3", Rectangle(-635, 1189, 30));
		AddSpawnPoint("f_orchard_34_3.Id3", "f_orchard_34_3", Rectangle(-500, 1074, 30));
