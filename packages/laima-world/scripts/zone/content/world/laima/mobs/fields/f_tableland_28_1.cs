...
public class FTableland281MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("f_tableland_28_1.Id2", MonsterId.Repusbunny_Green, min: 113, max: 150);
		AddSpawner("f_tableland_28_1.Id3", MonsterId.Repusbunny_Bow_Green, min: 19, max: 25, tendency: TendencyType.Aggressive);
