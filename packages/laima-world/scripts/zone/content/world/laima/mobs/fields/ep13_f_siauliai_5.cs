...
public class Ep13FSiauliai5MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("ep13_f_siauliai_5.Id1", MonsterId.Rootcrystal_01, min: 19, max: 25, respawn: Seconds(20));
		AddSpawner("ep13_f_siauliai_5.Id2", MonsterId.Elgesys_Guard, min: 3, max: 4, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_5.Id3", MonsterId.Elgesys_Guard, min: 3, max: 4, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_5.Id4", MonsterId.Elgesys_Guard, min: 3, max: 4, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_5.Id5", MonsterId.Elgesys_Guard, min: 3, max: 4, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_5.Id6", MonsterId.Elgesys_Guard, min: 3, max: 4, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_5.Id7", MonsterId.Elgesys_Guard, min: 3, max: 4, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_5.Id8", MonsterId.Elgesys_Malkos, min: 8, max: 10, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_5.Id9", MonsterId.Elgesys_Malkos, min: 8, max: 10, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_5.Id10", MonsterId.Elgesys_Malkos, min: 4, max: 5, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_5.Id11", MonsterId.Elgesys_Malkos, min: 15, max: 20, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_5.Id12", MonsterId.Elgesys_Collecter, min: 38, max: 50, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_5.Id13", MonsterId.Darbas_Smuggler, min: 6, max: 7, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_5.Id14", MonsterId.Darbas_Smuggler, amount: 3, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_5.Id15", MonsterId.Darbas_Smuggler, min: 4, max: 5, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_5.Id16", MonsterId.Darbas_Smuggler, min: 4, max: 5, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_5.Id17", MonsterId.Darbas_Smuggler, amount: 3, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_5.Id18", MonsterId.Darbas_Smuggler, min: 3, max: 4, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_5.Id19", MonsterId.Darbas_Smuggler, min: 4, max: 5, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_5.Id20", MonsterId.Darbas_Smuggler, amount: 3, respawn: Minutes(1));
		AddSpawner("ep13_f_siauliai_5.Id21", MonsterId.Elgesys_Malkos, min: 3, max: 4, respawn: Minutes(1));
