...
public class FFlash291MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("f_flash_29_1.Id2", MonsterId.Minos_Orange, min: 57, max: 75, tendency: TendencyType.Aggressive);
		AddSpawner("f_flash_29_1.Id3", MonsterId.Infroholder_Bow_Red, min: 12, max: 15, tendency: TendencyType.Aggressive);
		AddSpawner("f_flash_29_1.Id4", MonsterId.Minos_Mage_Green, min: 9, max: 12, tendency: TendencyType.Aggressive);
