...
public class DLimestonecave523MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("d_limestonecave_52_3.Id1", MonsterId.Rubblem_Green, min: 12, max: 15, tendency: TendencyType.Aggressive);
		AddSpawner("d_limestonecave_52_3.Id2", MonsterId.Tala_Sorcerer, min: 15, max: 20, tendency: TendencyType.Aggressive);
		AddSpawner("d_limestonecave_52_3.Id3", MonsterId.Tala_Sorcerer, min: 23, max: 30, tendency: TendencyType.Aggressive);
		AddSpawner("d_limestonecave_52_3.Id4", MonsterId.Rocktanon, min: 15, max: 20, tendency: TendencyType.Aggressive);
		AddSpawner("d_limestonecave_52_3.Id5", MonsterId.Tala_Sorcerer, min: 12, max: 15, tendency: TendencyType.Aggressive);
		AddSpawner("d_limestonecave_52_3.Id6", MonsterId.Rubblem_Green, min: 15, max: 20, tendency: TendencyType.Aggressive);
		AddSpawner("d_limestonecave_52_3.Id7", MonsterId.Rootcrystal_04, min: 19, max: 25, respawn: Seconds(30), tendency: TendencyType.Peaceful);
