...
public class DFiretower43MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("d_firetower_43.Id1", MonsterId.InfroRocktor_Red, min: 24, max: 30, tendency: TendencyType.Aggressive);
		AddSpawner("d_firetower_43.Id2", MonsterId.Rootcrystal_01, min: 8, max: 10, respawn: Seconds(30), tendency: TendencyType.Peaceful);
		AddSpawner("d_firetower_43.Id3", MonsterId.Arma, min: 24, max: 30, tendency: TendencyType.Aggressive);
		AddSpawner("d_firetower_43.Id4", MonsterId.InfroRocktor_Red, min: 12, max: 18, tendency: TendencyType.Aggressive);
		AddSpawner("d_firetower_43.Id5", MonsterId.Arma, min: 24, max: 30, tendency: TendencyType.Aggressive);
		AddSpawner("d_firetower_43.Id6", MonsterId.Flask_Mage, min: 24, max: 30, tendency: TendencyType.Aggressive);
		AddSpawner("d_firetower_43.Id7", MonsterId.Flask_Mage, min: 16, max: 20, tendency: TendencyType.Aggressive);
		AddSpawner("d_firetower_43.Id8", MonsterId.TerraNymph_Mage, min: 9, max: 12, tendency: TendencyType.Aggressive);
		AddSpawner("d_firetower_43.Id9", MonsterId.Pyran, min: 12, max: 15, tendency: TendencyType.Aggressive);
		AddSpawner("d_firetower_43.Id10", MonsterId.Pyran, min: 40, max: 50, tendency: TendencyType.Aggressive);
		...
		// 'Pyran' Spawn Points
		AddSpawnPoint("d_firetower_43.Id10", "d_firetower_43", Rectangle(693, -738, 9999));

		// Boss Spawners ---------------------------------
		AddBossSpawner(MonsterId.Boss_Mineloader, "d_firetower_43", 1, Hours(2), Hours(4));
	}
}
