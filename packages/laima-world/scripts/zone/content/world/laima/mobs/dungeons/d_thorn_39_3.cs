...
public class DThorn393MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("d_thorn_39_3.Id2", MonsterId.Stonacorn, min: 23, max: 30, tendency: TendencyType.Aggressive);
		AddSpawner("d_thorn_39_3.Id3", MonsterId.Loftlem_Green, min: 23, max: 30, tendency: TendencyType.Aggressive);
		AddSpawner("d_thorn_39_3.Id4", MonsterId.Cire_Mage, amount: 3);
		AddSpawner("d_thorn_39_3.Id5", MonsterId.Hepatica_Green, min: 60, max: 80, tendency: TendencyType.Aggressive);
		...
		// Boss Spawners ---------------------------------
		AddBossSpawner(MonsterId.Boss_GiantWoodGoblin, "d_thorn_39_3", 1, Hours(2), Hours(4));
	}
}
