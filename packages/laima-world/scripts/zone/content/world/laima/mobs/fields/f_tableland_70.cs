...
public class FTableland70MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("f_tableland_70.Id1", MonsterId.Hohen_Mane_Purple, min: 8, max: 10, respawn: Seconds(25), tendency: TendencyType.Aggressive);
		AddSpawner("f_tableland_70.Id2", MonsterId.Hohen_Mage_Blue, min: 9, max: 12, respawn: Seconds(25), tendency: TendencyType.Aggressive);
		AddSpawner("f_tableland_70.Id3", MonsterId.Cronewt_Blue, min: 60, max: 80, respawn: Seconds(25));
		AddSpawner("f_tableland_70.Id4", MonsterId.Lapasape_Bow_Blue, min: 15, max: 20, respawn: Seconds(25), tendency: TendencyType.Aggressive);
		AddSpawner("f_tableland_70.Id5", MonsterId.Rootcrystal_03, min: 20, max: 26, respawn: Seconds(30));
		AddSpawner("f_tableland_70.Id6", MonsterId.Lapasape_Bow_Blue, min: 15, max: 20, respawn: Minutes(1), tendency: TendencyType.Aggressive);
