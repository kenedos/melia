...
public class FDcapital106MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("f_dcapital_106.Id1", MonsterId.Rootcrystal_01, min: 27, max: 35, respawn: Seconds(25));
		AddSpawner("f_dcapital_106.Id2", MonsterId.Wajak_Walker, min: 24, max: 31);
		AddSpawner("f_dcapital_106.Id3", MonsterId.Horong_Walker, min: 23, max: 30);
		AddSpawner("f_dcapital_106.Id4", MonsterId.Bishop_Hart, min: 8, max: 10);
		AddSpawner("f_dcapital_106.Id5", MonsterId.Bishop_Point, min: 27, max: 36);
		AddSpawner("f_dcapital_106.Id6", MonsterId.Bishop_Point, min: 3, max: 4, respawn: Seconds(10));
