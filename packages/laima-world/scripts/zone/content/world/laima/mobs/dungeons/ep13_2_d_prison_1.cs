...
public class Ep132DPrison1MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("ep13_2_d_prison_1.Id1", MonsterId.Episode13_2_Goblin_Brandingiron, min: 72, max: 96, Seconds(25));
		AddSpawner("ep13_2_d_prison_1.Id2", MonsterId.Episode13_2_Banshee, min: 51, max: 68, Seconds(25));
		AddSpawner("ep13_2_d_prison_1.Id3", MonsterId.Episode13_2_Goblin_Sweeper, min: 93, max: 123, Seconds(25));
		...
		// Boss Spawners ---------------------------------
		AddBossSpawner(MonsterId.Boss_Insane_Marnoks, "ep13_2_d_prison_1", 1, Hours(2), Hours(4));
	}
}
